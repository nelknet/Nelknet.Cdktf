...
namespace hcloud.ZoneRrset
{
    ...
    [JsiiByValue(fqn: "hcloud.zoneRrset.ZoneRrsetConfig")]
    public class ZoneRrsetConfig : hcloud.ZoneRrset.IZoneRrsetConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(hcloud.ZoneRrset.IZoneRrsetRecords).FullName}[]; received null", nameof(value));
                        default:
        ...
        private object? _changeProtection;
