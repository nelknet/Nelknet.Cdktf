...
namespace azurerm.AttestationProvider
{
    ...
    [JsiiByValue(fqn: "azurerm.attestationProvider.AttestationProviderConfig")]
    public class AttestationProviderConfig : azurerm.AttestationProvider.IAttestationProviderConfig
    {
