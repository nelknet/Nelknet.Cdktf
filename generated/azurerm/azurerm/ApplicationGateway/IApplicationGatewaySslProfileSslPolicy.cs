...
{
    [JsiiInterface(nativeType: typeof(IApplicationGatewaySslProfileSslPolicy), fullyQualifiedName: "azurerm.applicationGateway.ApplicationGatewaySslProfileSslPolicy")]
    public interface IApplicationGatewaySslProfileSslPolicy
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IApplicationGatewaySslProfileSslPolicy), fullyQualifiedName: "azurerm.applicationGateway.ApplicationGatewaySslProfileSslPolicy")]
        internal sealed class _Proxy : DeputyBase, azurerm.ApplicationGateway.IApplicationGatewaySslProfileSslPolicy
        {
