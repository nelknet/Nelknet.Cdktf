...
namespace azurerm.LinuxWebApp
{
    ...
    [JsiiByValue(fqn: "azurerm.linuxWebApp.LinuxWebAppAuthSettingsTwitter")]
    public class LinuxWebAppAuthSettingsTwitter : azurerm.LinuxWebApp.ILinuxWebAppAuthSettingsTwitter
    {
