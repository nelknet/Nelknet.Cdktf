...
namespace azurerm.LinuxWebApp
{
    ...
    [JsiiByValue(fqn: "azurerm.linuxWebApp.LinuxWebAppAuthSettingsGithub")]
    public class LinuxWebAppAuthSettingsGithub : azurerm.LinuxWebApp.ILinuxWebAppAuthSettingsGithub
    {
