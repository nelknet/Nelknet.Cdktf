...
namespace azurerm.LinuxWebApp
{
    ...
    [JsiiByValue(fqn: "azurerm.linuxWebApp.LinuxWebAppConnectionString")]
    public class LinuxWebAppConnectionString : azurerm.LinuxWebApp.ILinuxWebAppConnectionString
    {
