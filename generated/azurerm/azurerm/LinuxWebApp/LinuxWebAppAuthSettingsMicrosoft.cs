...
namespace azurerm.LinuxWebApp
{
    ...
    [JsiiByValue(fqn: "azurerm.linuxWebApp.LinuxWebAppAuthSettingsMicrosoft")]
    public class LinuxWebAppAuthSettingsMicrosoft : azurerm.LinuxWebApp.ILinuxWebAppAuthSettingsMicrosoft
    {
