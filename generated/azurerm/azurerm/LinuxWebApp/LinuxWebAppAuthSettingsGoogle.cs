...
namespace azurerm.LinuxWebApp
{
    ...
    [JsiiByValue(fqn: "azurerm.linuxWebApp.LinuxWebAppAuthSettingsGoogle")]
    public class LinuxWebAppAuthSettingsGoogle : azurerm.LinuxWebApp.ILinuxWebAppAuthSettingsGoogle
    {
