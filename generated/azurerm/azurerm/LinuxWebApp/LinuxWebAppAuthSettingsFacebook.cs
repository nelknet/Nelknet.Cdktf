...
namespace azurerm.LinuxWebApp
{
    ...
    [JsiiByValue(fqn: "azurerm.linuxWebApp.LinuxWebAppAuthSettingsFacebook")]
    public class LinuxWebAppAuthSettingsFacebook : azurerm.LinuxWebApp.ILinuxWebAppAuthSettingsFacebook
    {
