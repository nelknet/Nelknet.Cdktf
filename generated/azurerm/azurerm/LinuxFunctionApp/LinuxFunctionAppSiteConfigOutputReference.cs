...
{
    [JsiiClass(nativeType: typeof(azurerm.LinuxFunctionApp.LinuxFunctionAppSiteConfigOutputReference), fullyQualifiedName: "azurerm.linuxFunctionApp.LinuxFunctionAppSiteConfigOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class LinuxFunctionAppSiteConfigOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public LinuxFunctionAppSiteConfigOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected LinuxFunctionAppSiteConfigOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected LinuxFunctionAppSiteConfigOutputReference(DeputyProps props): base(props)
        {
        }

        [JsiiMethod(name: "putApplicationStack", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azurerm.linuxFunctionApp.LinuxFunctionAppSiteConfigApplicationStack\"}}]")]
        public virtual void PutApplicationStack(azurerm.LinuxFunctionApp.ILinuxFunctionAppSiteConfigApplicationStack @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azurerm.LinuxFunctionApp.ILinuxFunctionAppSiteConfigApplicationStack)}, new object[]{@value});
        }

        [JsiiMethod(name: "putAppServiceLogs", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azurerm.linuxFunctionApp.LinuxFunctionAppSiteConfigAppServiceLogs\"}}]")]
        public virtual void PutAppServiceLogs(azurerm.LinuxFunctionApp.ILinuxFunctionAppSiteConfigAppServiceLogs @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azurerm.LinuxFunctionApp.ILinuxFunctionAppSiteConfigAppServiceLogs)}, new object[]{@value});
        }

        [JsiiMethod(name: "putCors", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azurerm.linuxFunctionApp.LinuxFunctionAppSiteConfigCors\"}}]")]
        public virtual void PutCors(azurerm.LinuxFunctionApp.ILinuxFunctionAppSiteConfigCors @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azurerm.LinuxFunctionApp.ILinuxFunctionAppSiteConfigCors)}, new object[]{@value});
        }

        [JsiiMethod(name: "putIpRestriction", parametersJson: "[{\"name\":\"value\",\"type\":{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.linuxFunctionApp.LinuxFunctionAppSiteConfigIpRestriction\"},\"kind\":\"array\"}}]}}}]")]
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case HashiCorp.Cdktf.IResolvable cast_2ed7d7:
                        break;
                    case azurerm.LinuxFunctionApp.ILinuxFunctionAppSiteConfigIpRestriction[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.LinuxFunctionApp.ILinuxFunctionAppSiteConfigIpRestriction).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.LinuxFunctionApp.ILinuxFunctionAppSiteConfigIpRestriction).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }

        [JsiiMethod(name: "putScmIpRestriction", parametersJson: "[{\"name\":\"value\",\"type\":{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.linuxFunctionApp.LinuxFunctionAppSiteConfigScmIpRestriction\"},\"kind\":\"array\"}}]}}}]")]
        public virtual void PutScmIpRestriction(object @value)
        {
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case HashiCorp.Cdktf.IResolvable cast_2ed7d7:
                        break;
                    case azurerm.LinuxFunctionApp.ILinuxFunctionAppSiteConfigScmIpRestriction[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.LinuxFunctionApp.ILinuxFunctionAppSiteConfigScmIpRestriction).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.LinuxFunctionApp.ILinuxFunctionAppSiteConfigScmIpRestriction).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "applicationStack", typeJson: "{\"fqn\":\"azurerm.linuxFunctionApp.LinuxFunctionAppSiteConfigApplicationStackOutputReference\"}")]
        public virtual azurerm.LinuxFunctionApp.LinuxFunctionAppSiteConfigApplicationStackOutputReference ApplicationStack
        {
            get => GetInstanceProperty<azurerm.LinuxFunctionApp.LinuxFunctionAppSiteConfigApplicationStackOutputReference>()!;
        }

        [JsiiProperty(name: "appServiceLogs", typeJson: "{\"fqn\":\"azurerm.linuxFunctionApp.LinuxFunctionAppSiteConfigAppServiceLogsOutputReference\"}")]
        public virtual azurerm.LinuxFunctionApp.LinuxFunctionAppSiteConfigAppServiceLogsOutputReference AppServiceLogs
        {
            get => GetInstanceProperty<azurerm.LinuxFunctionApp.LinuxFunctionAppSiteConfigAppServiceLogsOutputReference>()!;
        }

        [JsiiProperty(name: "cors", typeJson: "{\"fqn\":\"azurerm.linuxFunctionApp.LinuxFunctionAppSiteConfigCorsOutputReference\"}")]
        public virtual azurerm.LinuxFunctionApp.LinuxFunctionAppSiteConfigCorsOutputReference Cors
        {
            get => GetInstanceProperty<azurerm.LinuxFunctionApp.LinuxFunctionAppSiteConfigCorsOutputReference>()!;
        }
        ...
        [JsiiProperty(name: "ipRestriction", typeJson: "{\"fqn\":\"azurerm.linuxFunctionApp.LinuxFunctionAppSiteConfigIpRestrictionList\"}")]
        public virtual azurerm.LinuxFunctionApp.LinuxFunctionAppSiteConfigIpRestrictionList IpRestriction
        {
            get => GetInstanceProperty<azurerm.LinuxFunctionApp.LinuxFunctionAppSiteConfigIpRestrictionList>()!;
        }
        ...
        [JsiiProperty(name: "scmIpRestriction", typeJson: "{\"fqn\":\"azurerm.linuxFunctionApp.LinuxFunctionAppSiteConfigScmIpRestrictionList\"}")]
        public virtual azurerm.LinuxFunctionApp.LinuxFunctionAppSiteConfigScmIpRestrictionList ScmIpRestriction
        {
            get => GetInstanceProperty<azurerm.LinuxFunctionApp.LinuxFunctionAppSiteConfigScmIpRestrictionList>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "applicationStackInput", typeJson: "{\"fqn\":\"azurerm.linuxFunctionApp.LinuxFunctionAppSiteConfigApplicationStack\"}", isOptional: true)]
        public virtual azurerm.LinuxFunctionApp.ILinuxFunctionAppSiteConfigApplicationStack? ApplicationStackInput
        {
            get => GetInstanceProperty<azurerm.LinuxFunctionApp.ILinuxFunctionAppSiteConfigApplicationStack?>();
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "appServiceLogsInput", typeJson: "{\"fqn\":\"azurerm.linuxFunctionApp.LinuxFunctionAppSiteConfigAppServiceLogs\"}", isOptional: true)]
        public virtual azurerm.LinuxFunctionApp.ILinuxFunctionAppSiteConfigAppServiceLogs? AppServiceLogsInput
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "corsInput", typeJson: "{\"fqn\":\"azurerm.linuxFunctionApp.LinuxFunctionAppSiteConfigCors\"}", isOptional: true)]
        public virtual azurerm.LinuxFunctionApp.ILinuxFunctionAppSiteConfigCors? CorsInput
        {
            get => GetInstanceProperty<azurerm.LinuxFunctionApp.ILinuxFunctionAppSiteConfigCors?>();
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ipRestrictionInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.linuxFunctionApp.LinuxFunctionAppSiteConfigIpRestriction\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "scmIpRestrictionInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.linuxFunctionApp.LinuxFunctionAppSiteConfigScmIpRestriction\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"azurerm.linuxFunctionApp.LinuxFunctionAppSiteConfig\"}", isOptional: true)]
        public virtual azurerm.LinuxFunctionApp.ILinuxFunctionAppSiteConfig? InternalValue
        {
