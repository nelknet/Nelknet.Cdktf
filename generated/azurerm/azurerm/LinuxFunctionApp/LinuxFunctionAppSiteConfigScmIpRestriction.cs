...
{
    [JsiiByValue(fqn: "azurerm.linuxFunctionApp.LinuxFunctionAppSiteConfigScmIpRestriction")]
    public class LinuxFunctionAppSiteConfigScmIpRestriction : azurerm.LinuxFunctionApp.ILinuxFunctionAppSiteConfigScmIpRestriction
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "headers", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.linuxFunctionApp.LinuxFunctionAppSiteConfigScmIpRestrictionHeaders\"},\"kind\":\"array\"}}]}}", isOptional: true)]
