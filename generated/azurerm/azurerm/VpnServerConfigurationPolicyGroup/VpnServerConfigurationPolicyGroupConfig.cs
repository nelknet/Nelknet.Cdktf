...
namespace azurerm.VpnServerConfigurationPolicyGroup
{
    ...
    [JsiiByValue(fqn: "azurerm.vpnServerConfigurationPolicyGroup.VpnServerConfigurationPolicyGroupConfig")]
    public class VpnServerConfigurationPolicyGroupConfig : azurerm.VpnServerConfigurationPolicyGroup.IVpnServerConfigurationPolicyGroupConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.VpnServerConfigurationPolicyGroup.IVpnServerConfigurationPolicyGroupPolicy).FullName}[]; received null", nameof(value));
                        default:
