...
namespace azurerm.ContainerGroup
{
    ...
    [JsiiByValue(fqn: "azurerm.containerGroup.ContainerGroupContainerVolume")]
    public class ContainerGroupContainerVolume : azurerm.ContainerGroup.IContainerGroupContainerVolume
    {
