...
{
    [JsiiInterface(nativeType: typeof(IContainerGroupContainerVolume), fullyQualifiedName: "azurerm.containerGroup.ContainerGroupContainerVolume")]
    public interface IContainerGroupContainerVolume
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "gitRepo", typeJson: "{\"fqn\":\"azurerm.containerGroup.ContainerGroupContainerVolumeGitRepo\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azurerm.ContainerGroup.IContainerGroupContainerVolumeGitRepo? GitRepo
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IContainerGroupContainerVolume), fullyQualifiedName: "azurerm.containerGroup.ContainerGroupContainerVolume")]
        internal sealed class _Proxy : DeputyBase, azurerm.ContainerGroup.IContainerGroupContainerVolume
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "gitRepo", typeJson: "{\"fqn\":\"azurerm.containerGroup.ContainerGroupContainerVolumeGitRepo\"}", isOptional: true)]
            public azurerm.ContainerGroup.IContainerGroupContainerVolumeGitRepo? GitRepo
            {
