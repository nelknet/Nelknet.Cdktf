...
namespace azurerm.ContainerGroup
{
    ...
    [JsiiByValue(fqn: "azurerm.containerGroup.ContainerGroupConfig")]
    public class ContainerGroupConfig : azurerm.ContainerGroup.IContainerGroupConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.ContainerGroup.IContainerGroupContainer).FullName}[]; received null", nameof(value));
                        default:
