...
namespace azurerm.ContainerGroup
{
    ...
    [JsiiByValue(fqn: "azurerm.containerGroup.ContainerGroupContainerSecurity")]
    public class ContainerGroupContainerSecurity : azurerm.ContainerGroup.IContainerGroupContainerSecurity
    {
