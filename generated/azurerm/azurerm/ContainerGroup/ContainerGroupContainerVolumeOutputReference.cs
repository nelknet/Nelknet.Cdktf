...
{
    [JsiiClass(nativeType: typeof(azurerm.ContainerGroup.ContainerGroupContainerVolumeOutputReference), fullyQualifiedName: "azurerm.containerGroup.ContainerGroupContainerVolumeOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"the index of this item in the list.\"},\"name\":\"complexObjectIndex\",\"type\":{\"primitive\":\"number\"}},{\"docs\":{\"summary\":\"whether the list is wrapping a set (will add tolist() to be able to access an item via an index).\"},\"name\":\"complexObjectIsFromSet\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class ContainerGroupContainerVolumeOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        /// <param name="complexObjectIndex">the index of this item in the list.</param>
        /// <param name="complexObjectIsFromSet">whether the list is wrapping a set (will add tolist() to be able to access an item via an index).</param>
        public ContainerGroupContainerVolumeOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute, double complexObjectIndex, bool complexObjectIsFromSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet))
        {
        }
        ...
        protected ContainerGroupContainerVolumeOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected ContainerGroupContainerVolumeOutputReference(DeputyProps props): base(props)
        {
        }

        [JsiiMethod(name: "putGitRepo", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azurerm.containerGroup.ContainerGroupContainerVolumeGitRepo\"}}]")]
        public virtual void PutGitRepo(azurerm.ContainerGroup.IContainerGroupContainerVolumeGitRepo @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azurerm.ContainerGroup.IContainerGroupContainerVolumeGitRepo)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "gitRepo", typeJson: "{\"fqn\":\"azurerm.containerGroup.ContainerGroupContainerVolumeGitRepoOutputReference\"}")]
        public virtual azurerm.ContainerGroup.ContainerGroupContainerVolumeGitRepoOutputReference GitRepo
        {
            get => GetInstanceProperty<azurerm.ContainerGroup.ContainerGroupContainerVolumeGitRepoOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "gitRepoInput", typeJson: "{\"fqn\":\"azurerm.containerGroup.ContainerGroupContainerVolumeGitRepo\"}", isOptional: true)]
        public virtual azurerm.ContainerGroup.IContainerGroupContainerVolumeGitRepo? GitRepoInput
        {
            get => GetInstanceProperty<azurerm.ContainerGroup.IContainerGroupContainerVolumeGitRepo?>();
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"fqn\":\"azurerm.containerGroup.ContainerGroupContainerVolume\"}]}}", isOptional: true)]
