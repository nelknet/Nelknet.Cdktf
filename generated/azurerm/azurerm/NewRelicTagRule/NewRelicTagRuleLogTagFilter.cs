...
namespace azurerm.NewRelicTagRule
{
    ...
    [JsiiByValue(fqn: "azurerm.newRelicTagRule.NewRelicTagRuleLogTagFilter")]
    public class NewRelicTagRuleLogTagFilter : azurerm.NewRelicTagRule.INewRelicTagRuleLogTagFilter
    {
