...
namespace azurerm.DataAzurermDataboxEdgeDevice
{
    ...
    public class DataAzurermDataboxEdgeDeviceDevicePropertiesOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        /// <param name="complexObjectIndex">the index of this item in the list.</param>
        /// <param name="complexObjectIsFromSet">whether the list is wrapping a set (will add tolist() to be able to access an item via an index).</param>
        public DataAzurermDataboxEdgeDeviceDevicePropertiesOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute, double complexObjectIndex, bool complexObjectIsFromSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet))
        {
        }
        ...
        protected DataAzurermDataboxEdgeDeviceDevicePropertiesOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataAzurermDataboxEdgeDeviceDevicePropertiesOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"azurerm.dataAzurermDataboxEdgeDevice.DataAzurermDataboxEdgeDeviceDeviceProperties\"}", isOptional: true)]
        public virtual azurerm.DataAzurermDataboxEdgeDevice.IDataAzurermDataboxEdgeDeviceDeviceProperties? InternalValue
        {
            get => GetInstanceProperty<azurerm.DataAzurermDataboxEdgeDevice.IDataAzurermDataboxEdgeDeviceDeviceProperties?>();
