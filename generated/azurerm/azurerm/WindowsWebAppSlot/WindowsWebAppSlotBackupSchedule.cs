...
namespace azurerm.WindowsWebAppSlot
{
    ...
    [JsiiByValue(fqn: "azurerm.windowsWebAppSlot.WindowsWebAppSlotBackupSchedule")]
    public class WindowsWebAppSlotBackupSchedule : azurerm.WindowsWebAppSlot.IWindowsWebAppSlotBackupSchedule
    {
