...
namespace azurerm.WindowsWebAppSlot
{
    ...
    {
        /// <summary>Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.1.0/docs/resources/windows_web_app_slot#level WindowsWebAppSlot#level}.</summary>
        ...
        [JsiiTypeProxy(nativeType: typeof(IWindowsWebAppSlotLogsApplicationLogsAzureBlobStorage), fullyQualifiedName: "azurerm.windowsWebAppSlot.WindowsWebAppSlotLogsApplicationLogsAzureBlobStorage")]
        internal sealed class _Proxy : DeputyBase, azurerm.WindowsWebAppSlot.IWindowsWebAppSlotLogsApplicationLogsAzureBlobStorage
        {
