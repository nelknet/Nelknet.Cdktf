...
namespace azurerm.DevCenterCatalog
{
    ...
    [JsiiByValue(fqn: "azurerm.devCenterCatalog.DevCenterCatalogCatalogAdogit")]
    public class DevCenterCatalogCatalogAdogit : azurerm.DevCenterCatalog.IDevCenterCatalogCatalogAdogit
    {
