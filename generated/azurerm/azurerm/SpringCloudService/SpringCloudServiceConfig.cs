...
namespace azurerm.SpringCloudService
{
    ...
    public class SpringCloudServiceConfig : azurerm.SpringCloudService.ISpringCloudServiceConfig
    {
        ...
        private object? _containerRegistry;
        ...
        {
            get => _logStreamPublicEndpointEnabled;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _logStreamPublicEndpointEnabled = value;
            }
        }
