...
{
    [JsiiClass(nativeType: typeof(azurerm.DataFactoryDatasetBinary.DataFactoryDatasetBinaryHttpServerLocationOutputReference), fullyQualifiedName: "azurerm.dataFactoryDatasetBinary.DataFactoryDatasetBinaryHttpServerLocationOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class DataFactoryDatasetBinaryHttpServerLocationOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public DataFactoryDatasetBinaryHttpServerLocationOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected DataFactoryDatasetBinaryHttpServerLocationOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataFactoryDatasetBinaryHttpServerLocationOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"azurerm.dataFactoryDatasetBinary.DataFactoryDatasetBinaryHttpServerLocation\"}", isOptional: true)]
        public virtual azurerm.DataFactoryDatasetBinary.IDataFactoryDatasetBinaryHttpServerLocation? InternalValue
        {
