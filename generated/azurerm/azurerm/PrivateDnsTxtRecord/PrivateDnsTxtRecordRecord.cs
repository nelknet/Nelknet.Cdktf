...
namespace azurerm.PrivateDnsTxtRecord
{
    ...
    [JsiiByValue(fqn: "azurerm.privateDnsTxtRecord.PrivateDnsTxtRecordRecord")]
    public class PrivateDnsTxtRecordRecord : azurerm.PrivateDnsTxtRecord.IPrivateDnsTxtRecordRecord
    {
