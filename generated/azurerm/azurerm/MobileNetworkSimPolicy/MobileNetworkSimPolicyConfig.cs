...
namespace azurerm.MobileNetworkSimPolicy
{
    ...
    [JsiiByValue(fqn: "azurerm.mobileNetworkSimPolicy.MobileNetworkSimPolicyConfig")]
    public class MobileNetworkSimPolicyConfig : azurerm.MobileNetworkSimPolicy.IMobileNetworkSimPolicyConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.MobileNetworkSimPolicy.IMobileNetworkSimPolicySlice).FullName}[]; received null", nameof(value));
                        default:
