...
namespace azurerm.FunctionAppConnection
{
    ...
    [JsiiByValue(fqn: "azurerm.functionAppConnection.FunctionAppConnectionConfig")]
    public class FunctionAppConnectionConfig : azurerm.FunctionAppConnection.IFunctionAppConnectionConfig
    {
