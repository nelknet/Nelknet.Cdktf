...
{
    [JsiiInterface(nativeType: typeof(IFunctionAppSlotAuthSettingsActiveDirectory), fullyQualifiedName: "azurerm.functionAppSlot.FunctionAppSlotAuthSettingsActiveDirectory")]
    public interface IFunctionAppSlotAuthSettingsActiveDirectory
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IFunctionAppSlotAuthSettingsActiveDirectory), fullyQualifiedName: "azurerm.functionAppSlot.FunctionAppSlotAuthSettingsActiveDirectory")]
        internal sealed class _Proxy : DeputyBase, azurerm.FunctionAppSlot.IFunctionAppSlotAuthSettingsActiveDirectory
        {
