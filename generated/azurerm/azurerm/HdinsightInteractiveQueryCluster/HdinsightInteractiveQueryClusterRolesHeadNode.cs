...
namespace azurerm.HdinsightInteractiveQueryCluster
{
    ...
    [JsiiByValue(fqn: "azurerm.hdinsightInteractiveQueryCluster.HdinsightInteractiveQueryClusterRolesHeadNode")]
    public class HdinsightInteractiveQueryClusterRolesHeadNode : azurerm.HdinsightInteractiveQueryCluster.IHdinsightInteractiveQueryClusterRolesHeadNode
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "scriptActions", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.hdinsightInteractiveQueryCluster.HdinsightInteractiveQueryClusterRolesHeadNodeScriptActions\"},\"kind\":\"array\"}}]}}", isOptional: true)]
