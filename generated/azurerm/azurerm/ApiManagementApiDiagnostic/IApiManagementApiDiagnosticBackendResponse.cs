...
{
    [JsiiInterface(nativeType: typeof(IApiManagementApiDiagnosticBackendResponse), fullyQualifiedName: "azurerm.apiManagementApiDiagnostic.ApiManagementApiDiagnosticBackendResponse")]
    public interface IApiManagementApiDiagnosticBackendResponse
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azurerm.ApiManagementApiDiagnostic.IApiManagementApiDiagnosticBackendResponseDataMasking? DataMasking
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IApiManagementApiDiagnosticBackendResponse), fullyQualifiedName: "azurerm.apiManagementApiDiagnostic.ApiManagementApiDiagnosticBackendResponse")]
        internal sealed class _Proxy : DeputyBase, azurerm.ApiManagementApiDiagnostic.IApiManagementApiDiagnosticBackendResponse
        {
