...
namespace azurerm.ApiManagementApiDiagnostic
{
    ...
    public class ApiManagementApiDiagnosticBackendRequestDataMaskingQueryParamsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"fqn\":\"azurerm.apiManagementApiDiagnostic.ApiManagementApiDiagnosticBackendRequestDataMaskingQueryParams\"}]}}", isOptional: true)]
