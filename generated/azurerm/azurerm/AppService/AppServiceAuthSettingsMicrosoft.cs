...
namespace azurerm.AppService
{
    ...
    [JsiiByValue(fqn: "azurerm.appService.AppServiceAuthSettingsMicrosoft")]
    public class AppServiceAuthSettingsMicrosoft : azurerm.AppService.IAppServiceAuthSettingsMicrosoft
    {
