...
namespace azurerm.EventgridEventSubscription
{
    ...
    public class EventgridEventSubscriptionAdvancedFilterNumberInRangeOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"fqn\":\"azurerm.eventgridEventSubscription.EventgridEventSubscriptionAdvancedFilterNumberInRange\"}]}}", isOptional: true)]
