...
namespace azurerm.ConsumptionBudgetSubscription
{
    ...
    [JsiiByValue(fqn: "azurerm.consumptionBudgetSubscription.ConsumptionBudgetSubscriptionConfig")]
    public class ConsumptionBudgetSubscriptionConfig : azurerm.ConsumptionBudgetSubscription.IConsumptionBudgetSubscriptionConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.ConsumptionBudgetSubscription.IConsumptionBudgetSubscriptionNotification).FullName}[]; received null", nameof(value));
                        default:
