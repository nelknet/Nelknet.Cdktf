...
namespace azurerm.DataAzurermApplicationGateway
{
    ...
    public class DataAzurermApplicationGatewayRedirectConfigurationOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        [JsiiProperty(name: "includePath", typeJson: "{\"fqn\":\"cdktf.IResolvable\"}")]
        public virtual HashiCorp.Cdktf.IResolvable IncludePath
        {
            get => GetInstanceProperty<HashiCorp.Cdktf.IResolvable>()!;
        }

        [JsiiProperty(name: "includeQueryString", typeJson: "{\"fqn\":\"cdktf.IResolvable\"}")]
        public virtual HashiCorp.Cdktf.IResolvable IncludeQueryString
        {
            get => GetInstanceProperty<HashiCorp.Cdktf.IResolvable>()!;
        }
