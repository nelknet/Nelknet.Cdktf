...
{
    [JsiiInterface(nativeType: typeof(IApiManagementCustomDomainPortal), fullyQualifiedName: "azurerm.apiManagementCustomDomain.ApiManagementCustomDomainPortal")]
    public interface IApiManagementCustomDomainPortal
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IApiManagementCustomDomainPortal), fullyQualifiedName: "azurerm.apiManagementCustomDomain.ApiManagementCustomDomainPortal")]
        internal sealed class _Proxy : DeputyBase, azurerm.ApiManagementCustomDomain.IApiManagementCustomDomainPortal
        {
