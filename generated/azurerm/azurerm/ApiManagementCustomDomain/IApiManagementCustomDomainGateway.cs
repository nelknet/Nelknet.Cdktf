...
{
    [JsiiInterface(nativeType: typeof(IApiManagementCustomDomainGateway), fullyQualifiedName: "azurerm.apiManagementCustomDomain.ApiManagementCustomDomainGateway")]
    public interface IApiManagementCustomDomainGateway
    {
        ...
        /// <summary>Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.1.0/docs/resources/api_management_custom_domain#default_ssl_binding ApiManagementCustomDomain#default_ssl_binding}.</summary>
        [JsiiProperty(name: "defaultSslBinding", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktf.IResolvable\"}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? DefaultSslBinding
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IApiManagementCustomDomainGateway), fullyQualifiedName: "azurerm.apiManagementCustomDomain.ApiManagementCustomDomainGateway")]
        internal sealed class _Proxy : DeputyBase, azurerm.ApiManagementCustomDomain.IApiManagementCustomDomainGateway
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "defaultSslBinding", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktf.IResolvable\"}]}}", isOptional: true)]
            public object? DefaultSslBinding
            {
