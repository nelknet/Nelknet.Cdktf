...
namespace azurerm.ApiManagementDiagnostic
{
    ...
    public interface IApiManagementDiagnosticFrontendResponseDataMaskingQueryParams
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IApiManagementDiagnosticFrontendResponseDataMaskingQueryParams), fullyQualifiedName: "azurerm.apiManagementDiagnostic.ApiManagementDiagnosticFrontendResponseDataMaskingQueryParams")]
        internal sealed class _Proxy : DeputyBase, azurerm.ApiManagementDiagnostic.IApiManagementDiagnosticFrontendResponseDataMaskingQueryParams
        {
