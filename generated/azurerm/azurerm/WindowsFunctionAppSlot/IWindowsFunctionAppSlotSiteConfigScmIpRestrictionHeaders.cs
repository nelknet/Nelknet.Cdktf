...
{
    [JsiiInterface(nativeType: typeof(IWindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders), fullyQualifiedName: "azurerm.windowsFunctionAppSlot.WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders")]
    public interface IWindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IWindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders), fullyQualifiedName: "azurerm.windowsFunctionAppSlot.WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders")]
        internal sealed class _Proxy : DeputyBase, azurerm.WindowsFunctionAppSlot.IWindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders
        {
