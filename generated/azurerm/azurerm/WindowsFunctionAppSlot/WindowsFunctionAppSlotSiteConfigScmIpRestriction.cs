...
{
    [JsiiByValue(fqn: "azurerm.windowsFunctionAppSlot.WindowsFunctionAppSlotSiteConfigScmIpRestriction")]
    public class WindowsFunctionAppSlotSiteConfigScmIpRestriction : azurerm.WindowsFunctionAppSlot.IWindowsFunctionAppSlotSiteConfigScmIpRestriction
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "headers", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.windowsFunctionAppSlot.WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders\"},\"kind\":\"array\"}}]}}", isOptional: true)]
