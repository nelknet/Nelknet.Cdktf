...
namespace azurerm.WindowsFunctionAppSlot
{
    ...
    [JsiiByValue(fqn: "azurerm.windowsFunctionAppSlot.WindowsFunctionAppSlotAuthSettingsV2FacebookV2")]
    public class WindowsFunctionAppSlotAuthSettingsV2FacebookV2 : azurerm.WindowsFunctionAppSlot.IWindowsFunctionAppSlotAuthSettingsV2FacebookV2
    {
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.1.0/docs/resources/windows_function_app_slot#graph_api_version WindowsFunctionAppSlot#graph_api_version}
        /// </remarks>
        [JsiiOptional]
