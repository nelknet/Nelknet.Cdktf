...
{
    [JsiiInterface(nativeType: typeof(IWindowsFunctionAppSlotAuthSettingsGoogle), fullyQualifiedName: "azurerm.windowsFunctionAppSlot.WindowsFunctionAppSlotAuthSettingsGoogle")]
    public interface IWindowsFunctionAppSlotAuthSettingsGoogle
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IWindowsFunctionAppSlotAuthSettingsGoogle), fullyQualifiedName: "azurerm.windowsFunctionAppSlot.WindowsFunctionAppSlotAuthSettingsGoogle")]
        internal sealed class _Proxy : DeputyBase, azurerm.WindowsFunctionAppSlot.IWindowsFunctionAppSlotAuthSettingsGoogle
        {
