...
{
    [JsiiInterface(nativeType: typeof(ICdnEndpointDeliveryRuleRemoteAddressCondition), fullyQualifiedName: "azurerm.cdnEndpoint.CdnEndpointDeliveryRuleRemoteAddressCondition")]
    public interface ICdnEndpointDeliveryRuleRemoteAddressCondition
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ICdnEndpointDeliveryRuleRemoteAddressCondition), fullyQualifiedName: "azurerm.cdnEndpoint.CdnEndpointDeliveryRuleRemoteAddressCondition")]
        internal sealed class _Proxy : DeputyBase, azurerm.CdnEndpoint.ICdnEndpointDeliveryRuleRemoteAddressCondition
        {
