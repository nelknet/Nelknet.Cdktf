...
namespace azurerm.CdnEndpoint
{
    ...
    public class CdnEndpointDeliveryRuleRequestBodyConditionOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        protected CdnEndpointDeliveryRuleRequestBodyConditionOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected CdnEndpointDeliveryRuleRequestBodyConditionOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"fqn\":\"azurerm.cdnEndpoint.CdnEndpointDeliveryRuleRequestBodyCondition\"}]}}", isOptional: true)]
