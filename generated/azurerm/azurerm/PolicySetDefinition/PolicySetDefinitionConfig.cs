...
namespace azurerm.PolicySetDefinition
{
    ...
    [JsiiByValue(fqn: "azurerm.policySetDefinition.PolicySetDefinitionConfig")]
    public class PolicySetDefinitionConfig : azurerm.PolicySetDefinition.IPolicySetDefinitionConfig
    {
        ...
        private object _policyDefinitionReference;
        ...
        {
            get => _policyDefinitionReference;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.PolicySetDefinition.IPolicySetDefinitionPolicyDefinitionReference).FullName}[]; received null", nameof(value));
                        default:
                ...
                _policyDefinitionReference = value;
            }
        }
        ...
        private object? _policyDefinitionGroup;
