...
namespace azurerm.DataFactoryTriggerCustomEvent
{
    ...
    [JsiiByValue(fqn: "azurerm.dataFactoryTriggerCustomEvent.DataFactoryTriggerCustomEventConfig")]
    public class DataFactoryTriggerCustomEventConfig : azurerm.DataFactoryTriggerCustomEvent.IDataFactoryTriggerCustomEventConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.DataFactoryTriggerCustomEvent.IDataFactoryTriggerCustomEventPipeline).FullName}[]; received null", nameof(value));
                        default:
