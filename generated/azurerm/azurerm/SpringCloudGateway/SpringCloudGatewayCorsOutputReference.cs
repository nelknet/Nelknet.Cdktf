...
{
    [JsiiClass(nativeType: typeof(azurerm.SpringCloudGateway.SpringCloudGatewayCorsOutputReference), fullyQualifiedName: "azurerm.springCloudGateway.SpringCloudGatewayCorsOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class SpringCloudGatewayCorsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public SpringCloudGatewayCorsOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected SpringCloudGatewayCorsOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected SpringCloudGatewayCorsOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiMethod(name: "resetAllowedOriginPatterns")]
        public virtual void ResetAllowedOriginPatterns()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "allowedOriginPatternsInput", typeJson: "{\"collection\":{\"elementtype\":{\"primitive\":\"string\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual string[]? AllowedOriginPatternsInput
        {
            get => GetInstanceProperty<string[]?>();
        }
        ...
        [JsiiProperty(name: "allowedOriginPatterns", typeJson: "{\"collection\":{\"elementtype\":{\"primitive\":\"string\"},\"kind\":\"array\"}}")]
        public virtual string[] AllowedOriginPatterns
        {
            get => GetInstanceProperty<string[]>()!;
            set => SetInstanceProperty(value);
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"azurerm.springCloudGateway.SpringCloudGatewayCors\"}", isOptional: true)]
        public virtual azurerm.SpringCloudGateway.ISpringCloudGatewayCors? InternalValue
        {
