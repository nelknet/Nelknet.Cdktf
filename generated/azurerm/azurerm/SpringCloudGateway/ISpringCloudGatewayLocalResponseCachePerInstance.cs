...
{
    [JsiiInterface(nativeType: typeof(ISpringCloudGatewayLocalResponseCachePerInstance), fullyQualifiedName: "azurerm.springCloudGateway.SpringCloudGatewayLocalResponseCachePerInstance")]
    public interface ISpringCloudGatewayLocalResponseCachePerInstance
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISpringCloudGatewayLocalResponseCachePerInstance), fullyQualifiedName: "azurerm.springCloudGateway.SpringCloudGatewayLocalResponseCachePerInstance")]
        internal sealed class _Proxy : DeputyBase, azurerm.SpringCloudGateway.ISpringCloudGatewayLocalResponseCachePerInstance
        {
