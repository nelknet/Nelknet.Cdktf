...
{
    [JsiiInterface(nativeType: typeof(ILinuxVirtualMachineAdditionalCapabilities), fullyQualifiedName: "azurerm.linuxVirtualMachine.LinuxVirtualMachineAdditionalCapabilities")]
    public interface ILinuxVirtualMachineAdditionalCapabilities
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILinuxVirtualMachineAdditionalCapabilities), fullyQualifiedName: "azurerm.linuxVirtualMachine.LinuxVirtualMachineAdditionalCapabilities")]
        internal sealed class _Proxy : DeputyBase, azurerm.LinuxVirtualMachine.ILinuxVirtualMachineAdditionalCapabilities
        {
