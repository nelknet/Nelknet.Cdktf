...
namespace azurerm.HdinsightHbaseCluster
{
    ...
    [JsiiByValue(fqn: "azurerm.hdinsightHbaseCluster.HdinsightHbaseClusterMonitor")]
    public class HdinsightHbaseClusterMonitor : azurerm.HdinsightHbaseCluster.IHdinsightHbaseClusterMonitor
    {
