...
namespace azurerm.HdinsightHbaseCluster
{
    ...
    [JsiiByValue(fqn: "azurerm.hdinsightHbaseCluster.HdinsightHbaseClusterRolesHeadNode")]
    public class HdinsightHbaseClusterRolesHeadNode : azurerm.HdinsightHbaseCluster.IHdinsightHbaseClusterRolesHeadNode
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "scriptActions", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.hdinsightHbaseCluster.HdinsightHbaseClusterRolesHeadNodeScriptActions\"},\"kind\":\"array\"}}]}}", isOptional: true)]
