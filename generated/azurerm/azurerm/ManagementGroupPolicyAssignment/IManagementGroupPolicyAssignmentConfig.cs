...
{
    [JsiiInterface(nativeType: typeof(IManagementGroupPolicyAssignmentConfig), fullyQualifiedName: "azurerm.managementGroupPolicyAssignment.ManagementGroupPolicyAssignmentConfig")]
    public interface IManagementGroupPolicyAssignmentConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azurerm.ManagementGroupPolicyAssignment.IManagementGroupPolicyAssignmentIdentity? Identity
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azurerm.ManagementGroupPolicyAssignment.IManagementGroupPolicyAssignmentTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IManagementGroupPolicyAssignmentConfig), fullyQualifiedName: "azurerm.managementGroupPolicyAssignment.ManagementGroupPolicyAssignmentConfig")]
        internal sealed class _Proxy : DeputyBase, azurerm.ManagementGroupPolicyAssignment.IManagementGroupPolicyAssignmentConfig
        {
            ...
            {
                get => GetInstanceProperty<azurerm.ManagementGroupPolicyAssignment.IManagementGroupPolicyAssignmentTimeouts?>();
            }
