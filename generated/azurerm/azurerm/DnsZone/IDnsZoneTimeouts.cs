...
{
    [JsiiInterface(nativeType: typeof(IDnsZoneTimeouts), fullyQualifiedName: "azurerm.dnsZone.DnsZoneTimeouts")]
    public interface IDnsZoneTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDnsZoneTimeouts), fullyQualifiedName: "azurerm.dnsZone.DnsZoneTimeouts")]
        internal sealed class _Proxy : DeputyBase, azurerm.DnsZone.IDnsZoneTimeouts
        {
