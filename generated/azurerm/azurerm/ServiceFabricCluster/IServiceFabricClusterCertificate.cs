...
{
    [JsiiInterface(nativeType: typeof(IServiceFabricClusterCertificate), fullyQualifiedName: "azurerm.serviceFabricCluster.ServiceFabricClusterCertificate")]
    public interface IServiceFabricClusterCertificate
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IServiceFabricClusterCertificate), fullyQualifiedName: "azurerm.serviceFabricCluster.ServiceFabricClusterCertificate")]
        internal sealed class _Proxy : DeputyBase, azurerm.ServiceFabricCluster.IServiceFabricClusterCertificate
        {
