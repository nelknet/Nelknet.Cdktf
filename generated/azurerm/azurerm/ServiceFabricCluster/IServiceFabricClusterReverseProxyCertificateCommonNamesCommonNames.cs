...
{
    [JsiiInterface(nativeType: typeof(IServiceFabricClusterReverseProxyCertificateCommonNamesCommonNames), fullyQualifiedName: "azurerm.serviceFabricCluster.ServiceFabricClusterReverseProxyCertificateCommonNamesCommonNames")]
    public interface IServiceFabricClusterReverseProxyCertificateCommonNamesCommonNames
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IServiceFabricClusterReverseProxyCertificateCommonNamesCommonNames), fullyQualifiedName: "azurerm.serviceFabricCluster.ServiceFabricClusterReverseProxyCertificateCommonNamesCommonNames")]
        internal sealed class _Proxy : DeputyBase, azurerm.ServiceFabricCluster.IServiceFabricClusterReverseProxyCertificateCommonNamesCommonNames
        {
