...
{
    [JsiiClass(nativeType: typeof(azurerm.WindowsVirtualMachine.WindowsVirtualMachineOsDiskOutputReference), fullyQualifiedName: "azurerm.windowsVirtualMachine.WindowsVirtualMachineOsDiskOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class WindowsVirtualMachineOsDiskOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public WindowsVirtualMachineOsDiskOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected WindowsVirtualMachineOsDiskOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected WindowsVirtualMachineOsDiskOutputReference(DeputyProps props): base(props)
        {
        }

        [JsiiMethod(name: "putDiffDiskSettings", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azurerm.windowsVirtualMachine.WindowsVirtualMachineOsDiskDiffDiskSettings\"}}]")]
        public virtual void PutDiffDiskSettings(azurerm.WindowsVirtualMachine.IWindowsVirtualMachineOsDiskDiffDiskSettings @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azurerm.WindowsVirtualMachine.IWindowsVirtualMachineOsDiskDiffDiskSettings)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "diffDiskSettings", typeJson: "{\"fqn\":\"azurerm.windowsVirtualMachine.WindowsVirtualMachineOsDiskDiffDiskSettingsOutputReference\"}")]
        public virtual azurerm.WindowsVirtualMachine.WindowsVirtualMachineOsDiskDiffDiskSettingsOutputReference DiffDiskSettings
        {
            get => GetInstanceProperty<azurerm.WindowsVirtualMachine.WindowsVirtualMachineOsDiskDiffDiskSettingsOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "diffDiskSettingsInput", typeJson: "{\"fqn\":\"azurerm.windowsVirtualMachine.WindowsVirtualMachineOsDiskDiffDiskSettings\"}", isOptional: true)]
        public virtual azurerm.WindowsVirtualMachine.IWindowsVirtualMachineOsDiskDiffDiskSettings? DiffDiskSettingsInput
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"azurerm.windowsVirtualMachine.WindowsVirtualMachineOsDisk\"}", isOptional: true)]
        public virtual azurerm.WindowsVirtualMachine.IWindowsVirtualMachineOsDisk? InternalValue
        {
