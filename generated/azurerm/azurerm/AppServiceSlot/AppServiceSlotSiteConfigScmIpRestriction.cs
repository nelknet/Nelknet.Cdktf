...
{
    [JsiiByValue(fqn: "azurerm.appServiceSlot.AppServiceSlotSiteConfigScmIpRestriction")]
    public class AppServiceSlotSiteConfigScmIpRestriction : azurerm.AppServiceSlot.IAppServiceSlotSiteConfigScmIpRestriction
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "headers", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.appServiceSlot.AppServiceSlotSiteConfigScmIpRestrictionHeaders\"},\"kind\":\"array\"}}]}}", isOptional: true)]
