...
namespace azurerm.AppServiceSlot
{
    ...
    [JsiiByValue(fqn: "azurerm.appServiceSlot.AppServiceSlotAuthSettingsMicrosoft")]
    public class AppServiceSlotAuthSettingsMicrosoft : azurerm.AppServiceSlot.IAppServiceSlotAuthSettingsMicrosoft
    {
