...
namespace azurerm.MysqlFlexibleServer
{
    ...
    [JsiiByValue(fqn: "azurerm.mysqlFlexibleServer.MysqlFlexibleServerConfig")]
    public class MysqlFlexibleServerConfig : azurerm.MysqlFlexibleServer.IMysqlFlexibleServerConfig
    {
