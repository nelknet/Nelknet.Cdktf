...
namespace azurerm.StorageObjectReplication
{
    ...
    [JsiiByValue(fqn: "azurerm.storageObjectReplication.StorageObjectReplicationConfig")]
    public class StorageObjectReplicationConfig : azurerm.StorageObjectReplication.IStorageObjectReplicationConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.StorageObjectReplication.IStorageObjectReplicationRules).FullName}[]; received null", nameof(value));
                        default:
