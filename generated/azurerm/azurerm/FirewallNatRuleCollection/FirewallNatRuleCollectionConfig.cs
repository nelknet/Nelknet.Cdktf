...
namespace azurerm.FirewallNatRuleCollection
{
    ...
    [JsiiByValue(fqn: "azurerm.firewallNatRuleCollection.FirewallNatRuleCollectionConfig")]
    public class FirewallNatRuleCollectionConfig : azurerm.FirewallNatRuleCollection.IFirewallNatRuleCollectionConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.FirewallNatRuleCollection.IFirewallNatRuleCollectionRule).FullName}[]; received null", nameof(value));
                        default:
