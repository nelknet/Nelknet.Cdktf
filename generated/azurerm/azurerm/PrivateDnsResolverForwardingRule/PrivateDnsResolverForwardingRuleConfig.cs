...
namespace azurerm.PrivateDnsResolverForwardingRule
{
    ...
    [JsiiByValue(fqn: "azurerm.privateDnsResolverForwardingRule.PrivateDnsResolverForwardingRuleConfig")]
    public class PrivateDnsResolverForwardingRuleConfig : azurerm.PrivateDnsResolverForwardingRule.IPrivateDnsResolverForwardingRuleConfig
    {
        ...
        private object _targetDnsServers;
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.PrivateDnsResolverForwardingRule.IPrivateDnsResolverForwardingRuleTargetDnsServers).FullName}[]; received null", nameof(value));
                        default:
