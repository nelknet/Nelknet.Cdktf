...
namespace azurerm.SentinelAlertRuleAnomalyDuplicate
{
    ...
    public class SentinelAlertRuleAnomalyDuplicatePrioritizedExcludeObservationOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        /// <param name="complexObjectIndex">the index of this item in the list.</param>
        /// <param name="complexObjectIsFromSet">whether the list is wrapping a set (will add tolist() to be able to access an item via an index).</param>
        public SentinelAlertRuleAnomalyDuplicatePrioritizedExcludeObservationOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute, double complexObjectIndex, bool complexObjectIsFromSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet))
        {
        }
        ...
        protected SentinelAlertRuleAnomalyDuplicatePrioritizedExcludeObservationOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected SentinelAlertRuleAnomalyDuplicatePrioritizedExcludeObservationOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiMethod(name: "resetPrioritize")]
        public virtual void ResetPrioritize()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "prioritizeInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? PrioritizeInput
        {
            get => GetInstanceProperty<string?>();
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"fqn\":\"azurerm.sentinelAlertRuleAnomalyDuplicate.SentinelAlertRuleAnomalyDuplicatePrioritizedExcludeObservation\"}]}}", isOptional: true)]
