...
namespace azurerm.ContainerAppJob
{
    ...
    [JsiiByValue(fqn: "azurerm.containerAppJob.ContainerAppJobTemplateContainerReadinessProbe")]
    public class ContainerAppJobTemplateContainerReadinessProbe : azurerm.ContainerAppJob.IContainerAppJobTemplateContainerReadinessProbe
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "header", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.containerAppJob.ContainerAppJobTemplateContainerReadinessProbeHeader\"},\"kind\":\"array\"}}]}}", isOptional: true)]
