...
namespace azurerm.LighthouseDefinition
{
    ...
    [JsiiByValue(fqn: "azurerm.lighthouseDefinition.LighthouseDefinitionConfig")]
    public class LighthouseDefinitionConfig : azurerm.LighthouseDefinition.ILighthouseDefinitionConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.LighthouseDefinition.ILighthouseDefinitionAuthorization).FullName}[]; received null", nameof(value));
                        default:
        ...
        private object? _eligibleAuthorization;
