...
namespace azurerm.KubernetesFleetUpdateStrategy
{
    ...
    [JsiiByValue(fqn: "azurerm.kubernetesFleetUpdateStrategy.KubernetesFleetUpdateStrategyConfig")]
    public class KubernetesFleetUpdateStrategyConfig : azurerm.KubernetesFleetUpdateStrategy.IKubernetesFleetUpdateStrategyConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.KubernetesFleetUpdateStrategy.IKubernetesFleetUpdateStrategyStage).FullName}[]; received null", nameof(value));
                        default:
