...
{
    [JsiiInterface(nativeType: typeof(IKubernetesFleetUpdateStrategyTimeouts), fullyQualifiedName: "azurerm.kubernetesFleetUpdateStrategy.KubernetesFleetUpdateStrategyTimeouts")]
    public interface IKubernetesFleetUpdateStrategyTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IKubernetesFleetUpdateStrategyTimeouts), fullyQualifiedName: "azurerm.kubernetesFleetUpdateStrategy.KubernetesFleetUpdateStrategyTimeouts")]
        internal sealed class _Proxy : DeputyBase, azurerm.KubernetesFleetUpdateStrategy.IKubernetesFleetUpdateStrategyTimeouts
        {
