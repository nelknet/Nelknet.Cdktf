...
namespace azurerm.ConsumptionBudgetResourceGroup
{
    ...
    [JsiiByValue(fqn: "azurerm.consumptionBudgetResourceGroup.ConsumptionBudgetResourceGroupConfig")]
    public class ConsumptionBudgetResourceGroupConfig : azurerm.ConsumptionBudgetResourceGroup.IConsumptionBudgetResourceGroupConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.ConsumptionBudgetResourceGroup.IConsumptionBudgetResourceGroupNotification).FullName}[]; received null", nameof(value));
                        default:
