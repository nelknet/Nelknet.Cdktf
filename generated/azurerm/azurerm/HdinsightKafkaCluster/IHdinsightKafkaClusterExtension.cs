...
{
    [JsiiInterface(nativeType: typeof(IHdinsightKafkaClusterExtension), fullyQualifiedName: "azurerm.hdinsightKafkaCluster.HdinsightKafkaClusterExtension")]
    public interface IHdinsightKafkaClusterExtension
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IHdinsightKafkaClusterExtension), fullyQualifiedName: "azurerm.hdinsightKafkaCluster.HdinsightKafkaClusterExtension")]
        internal sealed class _Proxy : DeputyBase, azurerm.HdinsightKafkaCluster.IHdinsightKafkaClusterExtension
        {
