...
namespace azurerm.HdinsightKafkaCluster
{
    ...
    [JsiiByValue(fqn: "azurerm.hdinsightKafkaCluster.HdinsightKafkaClusterMonitor")]
    public class HdinsightKafkaClusterMonitor : azurerm.HdinsightKafkaCluster.IHdinsightKafkaClusterMonitor
    {
