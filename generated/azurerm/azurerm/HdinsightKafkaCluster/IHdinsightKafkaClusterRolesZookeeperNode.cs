...
{
    [JsiiInterface(nativeType: typeof(IHdinsightKafkaClusterRolesZookeeperNode), fullyQualifiedName: "azurerm.hdinsightKafkaCluster.HdinsightKafkaClusterRolesZookeeperNode")]
    public interface IHdinsightKafkaClusterRolesZookeeperNode
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "scriptActions", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.hdinsightKafkaCluster.HdinsightKafkaClusterRolesZookeeperNodeScriptActions\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        ...
        [JsiiTypeProxy(nativeType: typeof(IHdinsightKafkaClusterRolesZookeeperNode), fullyQualifiedName: "azurerm.hdinsightKafkaCluster.HdinsightKafkaClusterRolesZookeeperNode")]
        internal sealed class _Proxy : DeputyBase, azurerm.HdinsightKafkaCluster.IHdinsightKafkaClusterRolesZookeeperNode
        {
