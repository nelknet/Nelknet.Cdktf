...
{
    [JsiiByValue(fqn: "azurerm.provider.AzurermProviderFeaturesLogAnalyticsWorkspace")]
    public class AzurermProviderFeaturesLogAnalyticsWorkspace : azurerm.Provider.IAzurermProviderFeaturesLogAnalyticsWorkspace
    {
        ...
        {
            get => _permanentlyDeleteOnDestroy;
            set
            {
                ...
                _permanentlyDeleteOnDestroy = value;
            }
        }
    }
}
