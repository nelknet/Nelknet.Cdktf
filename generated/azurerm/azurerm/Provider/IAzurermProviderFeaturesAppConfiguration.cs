...
{
    [JsiiInterface(nativeType: typeof(IAzurermProviderFeaturesAppConfiguration), fullyQualifiedName: "azurerm.provider.AzurermProviderFeaturesAppConfiguration")]
    public interface IAzurermProviderFeaturesAppConfiguration
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAzurermProviderFeaturesAppConfiguration), fullyQualifiedName: "azurerm.provider.AzurermProviderFeaturesAppConfiguration")]
        internal sealed class _Proxy : DeputyBase, azurerm.Provider.IAzurermProviderFeaturesAppConfiguration
        {
