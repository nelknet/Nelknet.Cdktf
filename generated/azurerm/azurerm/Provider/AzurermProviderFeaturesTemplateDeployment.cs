...
namespace azurerm.Provider
{
    ...
    [JsiiByValue(fqn: "azurerm.provider.AzurermProviderFeaturesTemplateDeployment")]
    public class AzurermProviderFeaturesTemplateDeployment : azurerm.Provider.IAzurermProviderFeaturesTemplateDeployment
    {
        ...
        {
            get => _deleteNestedItemsDuringDeletion;
            set
            {
                ...
                _deleteNestedItemsDuringDeletion = value;
            }
        }
    }
}
