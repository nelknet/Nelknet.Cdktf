...
{
    [JsiiInterface(nativeType: typeof(ILoadTestIdentity), fullyQualifiedName: "azurerm.loadTest.LoadTestIdentity")]
    public interface ILoadTestIdentity
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILoadTestIdentity), fullyQualifiedName: "azurerm.loadTest.LoadTestIdentity")]
        internal sealed class _Proxy : DeputyBase, azurerm.LoadTest.ILoadTestIdentity
        {
