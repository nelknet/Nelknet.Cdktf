...
namespace azurerm.ConfidentialLedger
{
    ...
    [JsiiByValue(fqn: "azurerm.confidentialLedger.ConfidentialLedgerConfig")]
    public class ConfidentialLedgerConfig : azurerm.ConfidentialLedger.IConfidentialLedgerConfig
    {
        private object _azureadBasedServicePrincipal;
        ...
        {
            get => _azureadBasedServicePrincipal;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.ConfidentialLedger.IConfidentialLedgerAzureadBasedServicePrincipal).FullName}[]; received null", nameof(value));
                        default:
                ...
                _azureadBasedServicePrincipal = value;
            }
        }
        ...
        private object? _certificateBasedSecurityPrincipal;
        ...
        {
            get => _certificateBasedSecurityPrincipal;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _certificateBasedSecurityPrincipal = value;
            }
        }
