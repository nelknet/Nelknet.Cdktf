...
namespace azurerm.ContainerApp
{
    ...
    [JsiiByValue(fqn: "azurerm.containerApp.ContainerAppTemplateContainerEnv")]
    public class ContainerAppTemplateContainerEnv : azurerm.ContainerApp.IContainerAppTemplateContainerEnv
    {
