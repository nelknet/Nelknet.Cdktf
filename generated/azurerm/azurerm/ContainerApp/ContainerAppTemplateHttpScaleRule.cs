...
namespace azurerm.ContainerApp
{
    ...
    public class ContainerAppTemplateHttpScaleRule : azurerm.ContainerApp.IContainerAppTemplateHttpScaleRule
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "authentication", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.containerApp.ContainerAppTemplateHttpScaleRuleAuthentication\"},\"kind\":\"array\"}}]}}", isOptional: true)]
