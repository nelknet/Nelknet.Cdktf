...
namespace azurerm.ContainerApp
{
    ...
    [JsiiByValue(fqn: "azurerm.containerApp.ContainerAppTemplateContainerLivenessProbe")]
    public class ContainerAppTemplateContainerLivenessProbe : azurerm.ContainerApp.IContainerAppTemplateContainerLivenessProbe
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "header", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.containerApp.ContainerAppTemplateContainerLivenessProbeHeader\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        /// <summary>The time in seconds to wait after the container has started before the probe is started.</summary>
        /// <remarks>
