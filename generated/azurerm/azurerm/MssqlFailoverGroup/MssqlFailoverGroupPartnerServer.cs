...
namespace azurerm.MssqlFailoverGroup
{
    ...
    [JsiiByValue(fqn: "azurerm.mssqlFailoverGroup.MssqlFailoverGroupPartnerServer")]
    public class MssqlFailoverGroupPartnerServer : azurerm.MssqlFailoverGroup.IMssqlFailoverGroupPartnerServer
    {
