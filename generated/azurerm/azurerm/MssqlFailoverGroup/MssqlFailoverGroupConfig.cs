...
namespace azurerm.MssqlFailoverGroup
{
    ...
    [JsiiByValue(fqn: "azurerm.mssqlFailoverGroup.MssqlFailoverGroupConfig")]
    public class MssqlFailoverGroupConfig : azurerm.MssqlFailoverGroup.IMssqlFailoverGroupConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.MssqlFailoverGroup.IMssqlFailoverGroupPartnerServer).FullName}[]; received null", nameof(value));
                        default:
