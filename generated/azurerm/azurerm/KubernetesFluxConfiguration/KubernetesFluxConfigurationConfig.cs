...
namespace azurerm.KubernetesFluxConfiguration
{
    ...
    [JsiiByValue(fqn: "azurerm.kubernetesFluxConfiguration.KubernetesFluxConfigurationConfig")]
    public class KubernetesFluxConfigurationConfig : azurerm.KubernetesFluxConfiguration.IKubernetesFluxConfigurationConfig
    {
        ...
        private object _kustomizations;
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.KubernetesFluxConfiguration.IKubernetesFluxConfigurationKustomizations).FullName}[]; received null", nameof(value));
                        default:
        ...
        private object? _continuousReconciliationEnabled;
        ...
        {
            get => _continuousReconciliationEnabled;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _continuousReconciliationEnabled = value;
            }
        }
