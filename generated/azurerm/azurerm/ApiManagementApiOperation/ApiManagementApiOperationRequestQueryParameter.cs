...
namespace azurerm.ApiManagementApiOperation
{
    ...
    [JsiiByValue(fqn: "azurerm.apiManagementApiOperation.ApiManagementApiOperationRequestQueryParameter")]
    public class ApiManagementApiOperationRequestQueryParameter : azurerm.ApiManagementApiOperation.IApiManagementApiOperationRequestQueryParameter
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "example", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.apiManagementApiOperation.ApiManagementApiOperationRequestQueryParameterExample\"},\"kind\":\"array\"}}]}}", isOptional: true)]
