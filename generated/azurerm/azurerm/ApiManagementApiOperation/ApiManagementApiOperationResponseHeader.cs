...
namespace azurerm.ApiManagementApiOperation
{
    ...
    [JsiiByValue(fqn: "azurerm.apiManagementApiOperation.ApiManagementApiOperationResponseHeader")]
    public class ApiManagementApiOperationResponseHeader : azurerm.ApiManagementApiOperation.IApiManagementApiOperationResponseHeader
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "example", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.apiManagementApiOperation.ApiManagementApiOperationResponseHeaderExample\"},\"kind\":\"array\"}}]}}", isOptional: true)]
