...
{
    [JsiiInterface(nativeType: typeof(IApiManagementApiOperationRequestHeader), fullyQualifiedName: "azurerm.apiManagementApiOperation.ApiManagementApiOperationRequestHeader")]
    public interface IApiManagementApiOperationRequestHeader
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "example", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.apiManagementApiOperation.ApiManagementApiOperationRequestHeaderExample\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? Example
        {
            get
        ...
        [JsiiTypeProxy(nativeType: typeof(IApiManagementApiOperationRequestHeader), fullyQualifiedName: "azurerm.apiManagementApiOperation.ApiManagementApiOperationRequestHeader")]
        internal sealed class _Proxy : DeputyBase, azurerm.ApiManagementApiOperation.IApiManagementApiOperationRequestHeader
        {
