...
namespace azurerm.ApiManagementApiOperation
{
    ...
    [JsiiByValue(fqn: "azurerm.apiManagementApiOperation.ApiManagementApiOperationRequestRepresentationFormParameter")]
    public class ApiManagementApiOperationRequestRepresentationFormParameter : azurerm.ApiManagementApiOperation.IApiManagementApiOperationRequestRepresentationFormParameter
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "example", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.apiManagementApiOperation.ApiManagementApiOperationRequestRepresentationFormParameterExample\"},\"kind\":\"array\"}}]}}", isOptional: true)]
