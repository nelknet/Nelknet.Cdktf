...
namespace azurerm.AppConfiguration
{
    ...
    [JsiiByValue(fqn: "azurerm.appConfiguration.AppConfigurationReplica")]
    public class AppConfigurationReplica : azurerm.AppConfiguration.IAppConfigurationReplica
    {
