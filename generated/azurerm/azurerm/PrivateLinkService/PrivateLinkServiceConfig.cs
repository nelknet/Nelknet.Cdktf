...
namespace azurerm.PrivateLinkService
{
    ...
    [JsiiByValue(fqn: "azurerm.privateLinkService.PrivateLinkServiceConfig")]
    public class PrivateLinkServiceConfig : azurerm.PrivateLinkService.IPrivateLinkServiceConfig
    {
        ...
        private object _natIpConfiguration;
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.PrivateLinkService.IPrivateLinkServiceNatIpConfiguration).FullName}[]; received null", nameof(value));
                        default:
