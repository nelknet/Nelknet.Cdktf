...
{
    [JsiiInterface(nativeType: typeof(IDedicatedHardwareSecurityModuleManagementNetworkProfile), fullyQualifiedName: "azurerm.dedicatedHardwareSecurityModule.DedicatedHardwareSecurityModuleManagementNetworkProfile")]
    public interface IDedicatedHardwareSecurityModuleManagementNetworkProfile
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDedicatedHardwareSecurityModuleManagementNetworkProfile), fullyQualifiedName: "azurerm.dedicatedHardwareSecurityModule.DedicatedHardwareSecurityModuleManagementNetworkProfile")]
        internal sealed class _Proxy : DeputyBase, azurerm.DedicatedHardwareSecurityModule.IDedicatedHardwareSecurityModuleManagementNetworkProfile
        {
