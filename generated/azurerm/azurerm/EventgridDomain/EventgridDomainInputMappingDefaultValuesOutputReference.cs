...
namespace azurerm.EventgridDomain
{
    ...
    public class EventgridDomainInputMappingDefaultValuesOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public EventgridDomainInputMappingDefaultValuesOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected EventgridDomainInputMappingDefaultValuesOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected EventgridDomainInputMappingDefaultValuesOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"azurerm.eventgridDomain.EventgridDomainInputMappingDefaultValues\"}", isOptional: true)]
        public virtual azurerm.EventgridDomain.IEventgridDomainInputMappingDefaultValues? InternalValue
        {
