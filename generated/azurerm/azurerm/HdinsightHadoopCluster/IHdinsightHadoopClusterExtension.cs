...
{
    [JsiiInterface(nativeType: typeof(IHdinsightHadoopClusterExtension), fullyQualifiedName: "azurerm.hdinsightHadoopCluster.HdinsightHadoopClusterExtension")]
    public interface IHdinsightHadoopClusterExtension
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IHdinsightHadoopClusterExtension), fullyQualifiedName: "azurerm.hdinsightHadoopCluster.HdinsightHadoopClusterExtension")]
        internal sealed class _Proxy : DeputyBase, azurerm.HdinsightHadoopCluster.IHdinsightHadoopClusterExtension
        {
