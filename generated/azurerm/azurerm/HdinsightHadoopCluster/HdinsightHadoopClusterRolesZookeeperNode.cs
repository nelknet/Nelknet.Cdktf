...
namespace azurerm.HdinsightHadoopCluster
{
    ...
    [JsiiByValue(fqn: "azurerm.hdinsightHadoopCluster.HdinsightHadoopClusterRolesZookeeperNode")]
    public class HdinsightHadoopClusterRolesZookeeperNode : azurerm.HdinsightHadoopCluster.IHdinsightHadoopClusterRolesZookeeperNode
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "scriptActions", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.hdinsightHadoopCluster.HdinsightHadoopClusterRolesZookeeperNodeScriptActions\"},\"kind\":\"array\"}}]}}", isOptional: true)]
