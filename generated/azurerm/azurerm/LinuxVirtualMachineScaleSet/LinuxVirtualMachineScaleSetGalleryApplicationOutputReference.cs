...
namespace azurerm.LinuxVirtualMachineScaleSet
{
    ...
    public class LinuxVirtualMachineScaleSetGalleryApplicationOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        protected LinuxVirtualMachineScaleSetGalleryApplicationOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected LinuxVirtualMachineScaleSetGalleryApplicationOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"fqn\":\"azurerm.linuxVirtualMachineScaleSet.LinuxVirtualMachineScaleSetGalleryApplication\"}]}}", isOptional: true)]
