...
{
    [JsiiInterface(nativeType: typeof(ILinuxVirtualMachineScaleSetAdminSshKey), fullyQualifiedName: "azurerm.linuxVirtualMachineScaleSet.LinuxVirtualMachineScaleSetAdminSshKey")]
    public interface ILinuxVirtualMachineScaleSetAdminSshKey
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILinuxVirtualMachineScaleSetAdminSshKey), fullyQualifiedName: "azurerm.linuxVirtualMachineScaleSet.LinuxVirtualMachineScaleSetAdminSshKey")]
        internal sealed class _Proxy : DeputyBase, azurerm.LinuxVirtualMachineScaleSet.ILinuxVirtualMachineScaleSetAdminSshKey
        {
