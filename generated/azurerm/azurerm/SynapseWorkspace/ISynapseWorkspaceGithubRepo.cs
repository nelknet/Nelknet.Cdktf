...
namespace azurerm.SynapseWorkspace
{
    ...
    public interface ISynapseWorkspaceGithubRepo
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISynapseWorkspaceGithubRepo), fullyQualifiedName: "azurerm.synapseWorkspace.SynapseWorkspaceGithubRepo")]
        internal sealed class _Proxy : DeputyBase, azurerm.SynapseWorkspace.ISynapseWorkspaceGithubRepo
        {
