...
namespace azurerm.MonitorAlertPrometheusRuleGroup
{
    ...
    [JsiiByValue(fqn: "azurerm.monitorAlertPrometheusRuleGroup.MonitorAlertPrometheusRuleGroupConfig")]
    public class MonitorAlertPrometheusRuleGroupConfig : azurerm.MonitorAlertPrometheusRuleGroup.IMonitorAlertPrometheusRuleGroupConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.MonitorAlertPrometheusRuleGroup.IMonitorAlertPrometheusRuleGroupRule).FullName}[]; received null", nameof(value));
                        default:
        ...
        private object? _ruleGroupEnabled;
