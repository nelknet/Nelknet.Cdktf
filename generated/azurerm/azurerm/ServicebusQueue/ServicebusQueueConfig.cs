...
namespace azurerm.ServicebusQueue
{
    ...
    [JsiiByValue(fqn: "azurerm.servicebusQueue.ServicebusQueueConfig")]
    public class ServicebusQueueConfig : azurerm.ServicebusQueue.IServicebusQueueConfig
    {
        ...
        private object? _expressEnabled;
        ...
        private object? _partitioningEnabled;
        ...
        public object? PartitioningEnabled
        {
            ...
            set
            {
                ...
                _partitioningEnabled = value;
            }
        }

        private object? _requiresDuplicateDetection;
