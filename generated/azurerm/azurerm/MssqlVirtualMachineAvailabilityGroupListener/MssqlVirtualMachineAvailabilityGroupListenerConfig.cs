...
namespace azurerm.MssqlVirtualMachineAvailabilityGroupListener
{
    ...
    [JsiiByValue(fqn: "azurerm.mssqlVirtualMachineAvailabilityGroupListener.MssqlVirtualMachineAvailabilityGroupListenerConfig")]
    public class MssqlVirtualMachineAvailabilityGroupListenerConfig : azurerm.MssqlVirtualMachineAvailabilityGroupListener.IMssqlVirtualMachineAvailabilityGroupListenerConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.MssqlVirtualMachineAvailabilityGroupListener.IMssqlVirtualMachineAvailabilityGroupListenerReplica).FullName}[]; received null", nameof(value));
                        default:
        ...
        private object? _multiSubnetIpConfiguration;
        ...
        {
            get => _multiSubnetIpConfiguration;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _multiSubnetIpConfiguration = value;
            }
        }
