...
namespace azurerm.RecoveryServicesVault
{
    ...
    public class RecoveryServicesVaultConfig : azurerm.RecoveryServicesVault.IRecoveryServicesVaultConfig
    {
        ...
        {
            get => _classicVmwareReplicationEnabled;
            set
            {
                ...
                _classicVmwareReplicationEnabled = value;
            }
        }
        ...
        {
            get => _crossRegionRestoreEnabled;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _crossRegionRestoreEnabled = value;
            }
        }
        ...
        private object? _softDeleteEnabled;
