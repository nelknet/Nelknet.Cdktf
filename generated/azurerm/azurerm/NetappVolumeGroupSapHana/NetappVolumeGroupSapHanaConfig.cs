...
namespace azurerm.NetappVolumeGroupSapHana
{
    ...
    [JsiiByValue(fqn: "azurerm.netappVolumeGroupSapHana.NetappVolumeGroupSapHanaConfig")]
    public class NetappVolumeGroupSapHanaConfig : azurerm.NetappVolumeGroupSapHana.INetappVolumeGroupSapHanaConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.NetappVolumeGroupSapHana.INetappVolumeGroupSapHanaVolume).FullName}[]; received null", nameof(value));
                        default:
