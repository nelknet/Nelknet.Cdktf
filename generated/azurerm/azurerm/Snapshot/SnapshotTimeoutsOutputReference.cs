...
namespace azurerm.Snapshot
{
    ...
    public class SnapshotTimeoutsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"fqn\":\"azurerm.snapshot.SnapshotTimeouts\"}]}}", isOptional: true)]
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case HashiCorp.Cdktf.IResolvable cast_cd4240:
                            break;
                        case azurerm.Snapshot.ISnapshotTimeouts cast_cd4240:
                            break;
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.Snapshot.ISnapshotTimeouts).FullName}; received {value.GetType().FullName}", nameof(value));
                    }
                }
