...
namespace azurerm.MonitorActionGroup
{
    ...
    [JsiiByValue(fqn: "azurerm.monitorActionGroup.MonitorActionGroupSmsReceiver")]
    public class MonitorActionGroupSmsReceiver : azurerm.MonitorActionGroup.IMonitorActionGroupSmsReceiver
    {
