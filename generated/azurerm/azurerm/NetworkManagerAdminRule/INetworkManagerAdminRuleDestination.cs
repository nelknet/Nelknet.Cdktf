...
namespace azurerm.NetworkManagerAdminRule
{
    ...
    public interface INetworkManagerAdminRuleDestination
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(INetworkManagerAdminRuleDestination), fullyQualifiedName: "azurerm.networkManagerAdminRule.NetworkManagerAdminRuleDestination")]
        internal sealed class _Proxy : DeputyBase, azurerm.NetworkManagerAdminRule.INetworkManagerAdminRuleDestination
        {
