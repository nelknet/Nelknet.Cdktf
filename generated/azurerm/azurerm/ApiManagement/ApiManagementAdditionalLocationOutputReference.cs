...
{
    [JsiiClass(nativeType: typeof(azurerm.ApiManagement.ApiManagementAdditionalLocationOutputReference), fullyQualifiedName: "azurerm.apiManagement.ApiManagementAdditionalLocationOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"the index of this item in the list.\"},\"name\":\"complexObjectIndex\",\"type\":{\"primitive\":\"number\"}},{\"docs\":{\"summary\":\"whether the list is wrapping a set (will add tolist() to be able to access an item via an index).\"},\"name\":\"complexObjectIsFromSet\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class ApiManagementAdditionalLocationOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        /// <param name="complexObjectIndex">the index of this item in the list.</param>
        /// <param name="complexObjectIsFromSet">whether the list is wrapping a set (will add tolist() to be able to access an item via an index).</param>
        public ApiManagementAdditionalLocationOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute, double complexObjectIndex, bool complexObjectIsFromSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet))
        {
        }
        ...
        protected ApiManagementAdditionalLocationOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected ApiManagementAdditionalLocationOutputReference(DeputyProps props): base(props)
        {
        }

        [JsiiMethod(name: "putVirtualNetworkConfiguration", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azurerm.apiManagement.ApiManagementAdditionalLocationVirtualNetworkConfiguration\"}}]")]
        public virtual void PutVirtualNetworkConfiguration(azurerm.ApiManagement.IApiManagementAdditionalLocationVirtualNetworkConfiguration @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azurerm.ApiManagement.IApiManagementAdditionalLocationVirtualNetworkConfiguration)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "virtualNetworkConfiguration", typeJson: "{\"fqn\":\"azurerm.apiManagement.ApiManagementAdditionalLocationVirtualNetworkConfigurationOutputReference\"}")]
        public virtual azurerm.ApiManagement.ApiManagementAdditionalLocationVirtualNetworkConfigurationOutputReference VirtualNetworkConfiguration
        {
            get => GetInstanceProperty<azurerm.ApiManagement.ApiManagementAdditionalLocationVirtualNetworkConfigurationOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "virtualNetworkConfigurationInput", typeJson: "{\"fqn\":\"azurerm.apiManagement.ApiManagementAdditionalLocationVirtualNetworkConfiguration\"}", isOptional: true)]
        public virtual azurerm.ApiManagement.IApiManagementAdditionalLocationVirtualNetworkConfiguration? VirtualNetworkConfigurationInput
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"fqn\":\"azurerm.apiManagement.ApiManagementAdditionalLocation\"}]}}", isOptional: true)]
