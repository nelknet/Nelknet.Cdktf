...
namespace azurerm.ArcKubernetesFluxConfiguration
{
    ...
    [JsiiByValue(fqn: "azurerm.arcKubernetesFluxConfiguration.ArcKubernetesFluxConfigurationConfig")]
    public class ArcKubernetesFluxConfigurationConfig : azurerm.ArcKubernetesFluxConfiguration.IArcKubernetesFluxConfigurationConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.ArcKubernetesFluxConfiguration.IArcKubernetesFluxConfigurationKustomizations).FullName}[]; received null", nameof(value));
                        default:
