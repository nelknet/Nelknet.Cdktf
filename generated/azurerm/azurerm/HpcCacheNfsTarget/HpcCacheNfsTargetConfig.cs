...
namespace azurerm.HpcCacheNfsTarget
{
    ...
    [JsiiByValue(fqn: "azurerm.hpcCacheNfsTarget.HpcCacheNfsTargetConfig")]
    public class HpcCacheNfsTargetConfig : azurerm.HpcCacheNfsTarget.IHpcCacheNfsTargetConfig
    {
        ...
        private object _namespaceJunction;
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.HpcCacheNfsTarget.IHpcCacheNfsTargetNamespaceJunction).FullName}[]; received null", nameof(value));
                        default:
