...
namespace azurerm.ConsumptionBudgetManagementGroup
{
    ...
    [JsiiByValue(fqn: "azurerm.consumptionBudgetManagementGroup.ConsumptionBudgetManagementGroupConfig")]
    public class ConsumptionBudgetManagementGroupConfig : azurerm.ConsumptionBudgetManagementGroup.IConsumptionBudgetManagementGroupConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.ConsumptionBudgetManagementGroup.IConsumptionBudgetManagementGroupNotification).FullName}[]; received null", nameof(value));
                        default:
