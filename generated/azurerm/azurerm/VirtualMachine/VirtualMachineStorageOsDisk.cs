...
namespace azurerm.VirtualMachine
{
    ...
    [JsiiByValue(fqn: "azurerm.virtualMachine.VirtualMachineStorageOsDisk")]
    public class VirtualMachineStorageOsDisk : azurerm.VirtualMachine.IVirtualMachineStorageOsDisk
    {
