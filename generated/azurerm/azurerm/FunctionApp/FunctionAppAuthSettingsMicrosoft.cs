...
namespace azurerm.FunctionApp
{
    ...
    [JsiiByValue(fqn: "azurerm.functionApp.FunctionAppAuthSettingsMicrosoft")]
    public class FunctionAppAuthSettingsMicrosoft : azurerm.FunctionApp.IFunctionAppAuthSettingsMicrosoft
    {
