...
namespace azurerm.NetworkSecurityRule
{
    ...
    [JsiiByValue(fqn: "azurerm.networkSecurityRule.NetworkSecurityRuleConfig")]
    public class NetworkSecurityRuleConfig : azurerm.NetworkSecurityRule.INetworkSecurityRuleConfig
    {
