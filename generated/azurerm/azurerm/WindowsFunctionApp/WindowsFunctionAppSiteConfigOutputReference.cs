...
{
    [JsiiClass(nativeType: typeof(azurerm.WindowsFunctionApp.WindowsFunctionAppSiteConfigOutputReference), fullyQualifiedName: "azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class WindowsFunctionAppSiteConfigOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public WindowsFunctionAppSiteConfigOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected WindowsFunctionAppSiteConfigOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected WindowsFunctionAppSiteConfigOutputReference(DeputyProps props): base(props)
        {
        }

        [JsiiMethod(name: "putApplicationStack", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigApplicationStack\"}}]")]
        public virtual void PutApplicationStack(azurerm.WindowsFunctionApp.IWindowsFunctionAppSiteConfigApplicationStack @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azurerm.WindowsFunctionApp.IWindowsFunctionAppSiteConfigApplicationStack)}, new object[]{@value});
        }

        [JsiiMethod(name: "putAppServiceLogs", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigAppServiceLogs\"}}]")]
        public virtual void PutAppServiceLogs(azurerm.WindowsFunctionApp.IWindowsFunctionAppSiteConfigAppServiceLogs @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azurerm.WindowsFunctionApp.IWindowsFunctionAppSiteConfigAppServiceLogs)}, new object[]{@value});
        }

        [JsiiMethod(name: "putCors", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigCors\"}}]")]
        public virtual void PutCors(azurerm.WindowsFunctionApp.IWindowsFunctionAppSiteConfigCors @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azurerm.WindowsFunctionApp.IWindowsFunctionAppSiteConfigCors)}, new object[]{@value});
        }

        [JsiiMethod(name: "putIpRestriction", parametersJson: "[{\"name\":\"value\",\"type\":{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigIpRestriction\"},\"kind\":\"array\"}}]}}}]")]
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case HashiCorp.Cdktf.IResolvable cast_2ed7d7:
                        break;
                    case azurerm.WindowsFunctionApp.IWindowsFunctionAppSiteConfigIpRestriction[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.WindowsFunctionApp.IWindowsFunctionAppSiteConfigIpRestriction).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.WindowsFunctionApp.IWindowsFunctionAppSiteConfigIpRestriction).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }

        [JsiiMethod(name: "putScmIpRestriction", parametersJson: "[{\"name\":\"value\",\"type\":{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigScmIpRestriction\"},\"kind\":\"array\"}}]}}}]")]
        public virtual void PutScmIpRestriction(object @value)
        {
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case HashiCorp.Cdktf.IResolvable cast_2ed7d7:
                        break;
                    case azurerm.WindowsFunctionApp.IWindowsFunctionAppSiteConfigScmIpRestriction[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.WindowsFunctionApp.IWindowsFunctionAppSiteConfigScmIpRestriction).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(azurerm.WindowsFunctionApp.IWindowsFunctionAppSiteConfigScmIpRestriction).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "applicationStack", typeJson: "{\"fqn\":\"azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigApplicationStackOutputReference\"}")]
        public virtual azurerm.WindowsFunctionApp.WindowsFunctionAppSiteConfigApplicationStackOutputReference ApplicationStack
        {
            get => GetInstanceProperty<azurerm.WindowsFunctionApp.WindowsFunctionAppSiteConfigApplicationStackOutputReference>()!;
        }

        [JsiiProperty(name: "appServiceLogs", typeJson: "{\"fqn\":\"azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigAppServiceLogsOutputReference\"}")]
        public virtual azurerm.WindowsFunctionApp.WindowsFunctionAppSiteConfigAppServiceLogsOutputReference AppServiceLogs
        {
            get => GetInstanceProperty<azurerm.WindowsFunctionApp.WindowsFunctionAppSiteConfigAppServiceLogsOutputReference>()!;
        }

        [JsiiProperty(name: "cors", typeJson: "{\"fqn\":\"azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigCorsOutputReference\"}")]
        public virtual azurerm.WindowsFunctionApp.WindowsFunctionAppSiteConfigCorsOutputReference Cors
        {
            get => GetInstanceProperty<azurerm.WindowsFunctionApp.WindowsFunctionAppSiteConfigCorsOutputReference>()!;
        }
        ...
        [JsiiProperty(name: "ipRestriction", typeJson: "{\"fqn\":\"azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigIpRestrictionList\"}")]
        public virtual azurerm.WindowsFunctionApp.WindowsFunctionAppSiteConfigIpRestrictionList IpRestriction
        {
            get => GetInstanceProperty<azurerm.WindowsFunctionApp.WindowsFunctionAppSiteConfigIpRestrictionList>()!;
        }

        [JsiiProperty(name: "scmIpRestriction", typeJson: "{\"fqn\":\"azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigScmIpRestrictionList\"}")]
        public virtual azurerm.WindowsFunctionApp.WindowsFunctionAppSiteConfigScmIpRestrictionList ScmIpRestriction
        {
            get => GetInstanceProperty<azurerm.WindowsFunctionApp.WindowsFunctionAppSiteConfigScmIpRestrictionList>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "applicationStackInput", typeJson: "{\"fqn\":\"azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigApplicationStack\"}", isOptional: true)]
        public virtual azurerm.WindowsFunctionApp.IWindowsFunctionAppSiteConfigApplicationStack? ApplicationStackInput
        {
            get => GetInstanceProperty<azurerm.WindowsFunctionApp.IWindowsFunctionAppSiteConfigApplicationStack?>();
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "appServiceLogsInput", typeJson: "{\"fqn\":\"azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigAppServiceLogs\"}", isOptional: true)]
        public virtual azurerm.WindowsFunctionApp.IWindowsFunctionAppSiteConfigAppServiceLogs? AppServiceLogsInput
        {
            get => GetInstanceProperty<azurerm.WindowsFunctionApp.IWindowsFunctionAppSiteConfigAppServiceLogs?>();
        }

        [JsiiOptional]
        [JsiiProperty(name: "corsInput", typeJson: "{\"fqn\":\"azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigCors\"}", isOptional: true)]
        public virtual azurerm.WindowsFunctionApp.IWindowsFunctionAppSiteConfigCors? CorsInput
        {
            get => GetInstanceProperty<azurerm.WindowsFunctionApp.IWindowsFunctionAppSiteConfigCors?>();
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ipRestrictionInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigIpRestriction\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "scmIpRestrictionInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigScmIpRestriction\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfig\"}", isOptional: true)]
        public virtual azurerm.WindowsFunctionApp.IWindowsFunctionAppSiteConfig? InternalValue
        {
