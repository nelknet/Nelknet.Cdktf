...
{
    [JsiiInterface(nativeType: typeof(IWindowsFunctionAppSiteConfigIpRestriction), fullyQualifiedName: "azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigIpRestriction")]
    public interface IWindowsFunctionAppSiteConfigIpRestriction
    {
        ...
        [JsiiProperty(name: "headers", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigIpRestrictionHeaders\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? Headers
        {
            get
        ...
        [JsiiTypeProxy(nativeType: typeof(IWindowsFunctionAppSiteConfigIpRestriction), fullyQualifiedName: "azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigIpRestriction")]
        internal sealed class _Proxy : DeputyBase, azurerm.WindowsFunctionApp.IWindowsFunctionAppSiteConfigIpRestriction
        {
