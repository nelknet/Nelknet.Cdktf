...
namespace azurerm.WindowsFunctionApp
{
    ...
    [JsiiByValue(fqn: "azurerm.windowsFunctionApp.WindowsFunctionAppAuthSettings")]
    public class WindowsFunctionAppAuthSettings : azurerm.WindowsFunctionApp.IWindowsFunctionAppAuthSettings
    {
