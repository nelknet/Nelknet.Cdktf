...
namespace azurerm.RedisLinkedServer
{
    ...
    [JsiiByValue(fqn: "azurerm.redisLinkedServer.RedisLinkedServerConfig")]
    public class RedisLinkedServerConfig : azurerm.RedisLinkedServer.IRedisLinkedServerConfig
    {
