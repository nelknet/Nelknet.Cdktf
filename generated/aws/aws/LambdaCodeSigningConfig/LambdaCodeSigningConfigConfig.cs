...
namespace aws.LambdaCodeSigningConfig
{
    ...
    [JsiiByValue(fqn: "aws.lambdaCodeSigningConfig.LambdaCodeSigningConfigConfig")]
    public class LambdaCodeSigningConfigConfig : aws.LambdaCodeSigningConfig.ILambdaCodeSigningConfigConfig
    {
