...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/opsworks_ganglia_layer aws_opsworks_ganglia_layer}.</summary>
    [JsiiClass(nativeType: typeof(aws.OpsworksGangliaLayer.OpsworksGangliaLayer), fullyQualifiedName: "aws.opsworksGangliaLayer.OpsworksGangliaLayer", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.opsworksGangliaLayer.OpsworksGangliaLayerConfig\"}}]")]
    public class OpsworksGangliaLayer : HashiCorp.Cdktf.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/opsworks_ganglia_layer aws_opsworks_ganglia_layer} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public OpsworksGangliaLayer(Constructs.Construct scope, string id, aws.OpsworksGangliaLayer.IOpsworksGangliaLayerConfig config): base(_MakeDeputyProps(scope, id, config))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, aws.OpsworksGangliaLayer.IOpsworksGangliaLayerConfig config)
        {
        ...
        /// <summary>Generates CDKTF code for importing a OpsworksGangliaLayer resource upon running "cdktf plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="importToId">The construct id used in the generated config for the OpsworksGangliaLayer to import.</param>
        /// <param name="importFromId">The id of the existing OpsworksGangliaLayer that should be imported.</param>
        /// <param name="provider">? Optional instance of the provider where the OpsworksGangliaLayer to import is found.</param>
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktf.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the OpsworksGangliaLayer to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/opsworks_ganglia_layer#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing OpsworksGangliaLayer that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the OpsworksGangliaLayer to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktf.TerraformProvider\"}}]")]
        public static HashiCorp.Cdktf.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, HashiCorp.Cdktf.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<HashiCorp.Cdktf.ImportableResource>(typeof(aws.OpsworksGangliaLayer.OpsworksGangliaLayer), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(HashiCorp.Cdktf.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }

        [JsiiMethod(name: "putCloudwatchConfiguration", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.opsworksGangliaLayer.OpsworksGangliaLayerCloudwatchConfiguration\"}}]")]
        public virtual void PutCloudwatchConfiguration(aws.OpsworksGangliaLayer.IOpsworksGangliaLayerCloudwatchConfiguration @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.OpsworksGangliaLayer.IOpsworksGangliaLayerCloudwatchConfiguration)}, new object[]{@value});
        }

        [JsiiMethod(name: "putEbsVolume", parametersJson: "[{\"name\":\"value\",\"type\":{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworksGangliaLayer.OpsworksGangliaLayerEbsVolume\"},\"kind\":\"array\"}}]}}}]")]
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case HashiCorp.Cdktf.IResolvable cast_2ed7d7:
                        break;
                    case aws.OpsworksGangliaLayer.IOpsworksGangliaLayerEbsVolume[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.OpsworksGangliaLayer.IOpsworksGangliaLayerEbsVolume).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.OpsworksGangliaLayer.IOpsworksGangliaLayerEbsVolume).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }

        [JsiiMethod(name: "putLoadBasedAutoScaling", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.opsworksGangliaLayer.OpsworksGangliaLayerLoadBasedAutoScaling\"}}]")]
        public virtual void PutLoadBasedAutoScaling(aws.OpsworksGangliaLayer.IOpsworksGangliaLayerLoadBasedAutoScaling @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.OpsworksGangliaLayer.IOpsworksGangliaLayerLoadBasedAutoScaling)}, new object[]{@value});
        }
        ...
        = GetStaticProperty<string>(typeof(aws.OpsworksGangliaLayer.OpsworksGangliaLayer))!;
        ...
        [JsiiProperty(name: "cloudwatchConfiguration", typeJson: "{\"fqn\":\"aws.opsworksGangliaLayer.OpsworksGangliaLayerCloudwatchConfigurationOutputReference\"}")]
        public virtual aws.OpsworksGangliaLayer.OpsworksGangliaLayerCloudwatchConfigurationOutputReference CloudwatchConfiguration
        {
            get => GetInstanceProperty<aws.OpsworksGangliaLayer.OpsworksGangliaLayerCloudwatchConfigurationOutputReference>()!;
        }

        [JsiiProperty(name: "ebsVolume", typeJson: "{\"fqn\":\"aws.opsworksGangliaLayer.OpsworksGangliaLayerEbsVolumeList\"}")]
        public virtual aws.OpsworksGangliaLayer.OpsworksGangliaLayerEbsVolumeList EbsVolume
        {
            get => GetInstanceProperty<aws.OpsworksGangliaLayer.OpsworksGangliaLayerEbsVolumeList>()!;
        }

        [JsiiProperty(name: "loadBasedAutoScaling", typeJson: "{\"fqn\":\"aws.opsworksGangliaLayer.OpsworksGangliaLayerLoadBasedAutoScalingOutputReference\"}")]
        public virtual aws.OpsworksGangliaLayer.OpsworksGangliaLayerLoadBasedAutoScalingOutputReference LoadBasedAutoScaling
        {
            get => GetInstanceProperty<aws.OpsworksGangliaLayer.OpsworksGangliaLayerLoadBasedAutoScalingOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "cloudwatchConfigurationInput", typeJson: "{\"fqn\":\"aws.opsworksGangliaLayer.OpsworksGangliaLayerCloudwatchConfiguration\"}", isOptional: true)]
        public virtual aws.OpsworksGangliaLayer.IOpsworksGangliaLayerCloudwatchConfiguration? CloudwatchConfigurationInput
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolumeInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworksGangliaLayer.OpsworksGangliaLayerEbsVolume\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "loadBasedAutoScalingInput", typeJson: "{\"fqn\":\"aws.opsworksGangliaLayer.OpsworksGangliaLayerLoadBasedAutoScaling\"}", isOptional: true)]
        public virtual aws.OpsworksGangliaLayer.IOpsworksGangliaLayerLoadBasedAutoScaling? LoadBasedAutoScalingInput
        {
