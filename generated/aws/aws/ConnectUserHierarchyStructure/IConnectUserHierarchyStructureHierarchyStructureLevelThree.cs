...
namespace aws.ConnectUserHierarchyStructure
{
    ...
    public interface IConnectUserHierarchyStructureHierarchyStructureLevelThree
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IConnectUserHierarchyStructureHierarchyStructureLevelThree), fullyQualifiedName: "aws.connectUserHierarchyStructure.ConnectUserHierarchyStructureHierarchyStructureLevelThree")]
        internal sealed class _Proxy : DeputyBase, aws.ConnectUserHierarchyStructure.IConnectUserHierarchyStructureHierarchyStructureLevelThree
        {
