...
{
    [JsiiInterface(nativeType: typeof(ISsmPatchBaselineApprovalRulePatchFilter), fullyQualifiedName: "aws.ssmPatchBaseline.SsmPatchBaselineApprovalRulePatchFilter")]
    public interface ISsmPatchBaselineApprovalRulePatchFilter
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISsmPatchBaselineApprovalRulePatchFilter), fullyQualifiedName: "aws.ssmPatchBaseline.SsmPatchBaselineApprovalRulePatchFilter")]
        internal sealed class _Proxy : DeputyBase, aws.SsmPatchBaseline.ISsmPatchBaselineApprovalRulePatchFilter
        {
