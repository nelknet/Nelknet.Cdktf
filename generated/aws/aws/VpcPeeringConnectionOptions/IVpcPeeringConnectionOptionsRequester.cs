...
{
    [JsiiInterface(nativeType: typeof(IVpcPeeringConnectionOptionsRequester), fullyQualifiedName: "aws.vpcPeeringConnectionOptions.VpcPeeringConnectionOptionsRequester")]
    public interface IVpcPeeringConnectionOptionsRequester
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IVpcPeeringConnectionOptionsRequester), fullyQualifiedName: "aws.vpcPeeringConnectionOptions.VpcPeeringConnectionOptionsRequester")]
        internal sealed class _Proxy : DeputyBase, aws.VpcPeeringConnectionOptions.IVpcPeeringConnectionOptionsRequester
        {
