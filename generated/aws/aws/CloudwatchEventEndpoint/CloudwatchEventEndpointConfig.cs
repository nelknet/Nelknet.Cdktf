...
namespace aws.CloudwatchEventEndpoint
{
    ...
    [JsiiByValue(fqn: "aws.cloudwatchEventEndpoint.CloudwatchEventEndpointConfig")]
    public class CloudwatchEventEndpointConfig : aws.CloudwatchEventEndpoint.ICloudwatchEventEndpointConfig
    {
        private object _eventBus;
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.CloudwatchEventEndpoint.ICloudwatchEventEndpointEventBus).FullName}[]; received null", nameof(value));
                        default:
