...
namespace aws.LakeformationResourceLfTags
{
    ...
    [JsiiByValue(fqn: "aws.lakeformationResourceLfTags.LakeformationResourceLfTagsConfig")]
    public class LakeformationResourceLfTagsConfig : aws.LakeformationResourceLfTags.ILakeformationResourceLfTagsConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.LakeformationResourceLfTags.ILakeformationResourceLfTagsLfTag).FullName}[]; received null", nameof(value));
                        default:
