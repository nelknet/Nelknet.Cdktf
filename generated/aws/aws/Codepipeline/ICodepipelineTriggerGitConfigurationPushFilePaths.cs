...
{
    [JsiiInterface(nativeType: typeof(ICodepipelineTriggerGitConfigurationPushFilePaths), fullyQualifiedName: "aws.codepipeline.CodepipelineTriggerGitConfigurationPushFilePaths")]
    public interface ICodepipelineTriggerGitConfigurationPushFilePaths
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ICodepipelineTriggerGitConfigurationPushFilePaths), fullyQualifiedName: "aws.codepipeline.CodepipelineTriggerGitConfigurationPushFilePaths")]
        internal sealed class _Proxy : DeputyBase, aws.Codepipeline.ICodepipelineTriggerGitConfigurationPushFilePaths
        {
