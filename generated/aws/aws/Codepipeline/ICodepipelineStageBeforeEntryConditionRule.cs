...
{
    [JsiiInterface(nativeType: typeof(ICodepipelineStageBeforeEntryConditionRule), fullyQualifiedName: "aws.codepipeline.CodepipelineStageBeforeEntryConditionRule")]
    public interface ICodepipelineStageBeforeEntryConditionRule
    {
        ...
        aws.Codepipeline.ICodepipelineStageBeforeEntryConditionRuleRuleTypeId RuleTypeId
        {
            get;
        }
        ...
        [JsiiTypeProxy(nativeType: typeof(ICodepipelineStageBeforeEntryConditionRule), fullyQualifiedName: "aws.codepipeline.CodepipelineStageBeforeEntryConditionRule")]
        internal sealed class _Proxy : DeputyBase, aws.Codepipeline.ICodepipelineStageBeforeEntryConditionRule
        {
