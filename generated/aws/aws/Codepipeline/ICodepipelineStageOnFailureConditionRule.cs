...
{
    [JsiiInterface(nativeType: typeof(ICodepipelineStageOnFailureConditionRule), fullyQualifiedName: "aws.codepipeline.CodepipelineStageOnFailureConditionRule")]
    public interface ICodepipelineStageOnFailureConditionRule
    {
        ...
        aws.Codepipeline.ICodepipelineStageOnFailureConditionRuleRuleTypeId RuleTypeId
        {
            get;
        }
        ...
        [JsiiTypeProxy(nativeType: typeof(ICodepipelineStageOnFailureConditionRule), fullyQualifiedName: "aws.codepipeline.CodepipelineStageOnFailureConditionRule")]
        internal sealed class _Proxy : DeputyBase, aws.Codepipeline.ICodepipelineStageOnFailureConditionRule
        {
