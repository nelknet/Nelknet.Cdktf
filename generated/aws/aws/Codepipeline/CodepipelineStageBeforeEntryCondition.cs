...
namespace aws.Codepipeline
{
    ...
    [JsiiByValue(fqn: "aws.codepipeline.CodepipelineStageBeforeEntryCondition")]
    public class CodepipelineStageBeforeEntryCondition : aws.Codepipeline.ICodepipelineStageBeforeEntryCondition
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.Codepipeline.ICodepipelineStageBeforeEntryConditionRule).FullName}[]; received null", nameof(value));
                        default:
