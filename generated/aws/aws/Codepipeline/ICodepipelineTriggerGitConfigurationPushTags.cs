...
{
    [JsiiInterface(nativeType: typeof(ICodepipelineTriggerGitConfigurationPushTags), fullyQualifiedName: "aws.codepipeline.CodepipelineTriggerGitConfigurationPushTags")]
    public interface ICodepipelineTriggerGitConfigurationPushTags
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ICodepipelineTriggerGitConfigurationPushTags), fullyQualifiedName: "aws.codepipeline.CodepipelineTriggerGitConfigurationPushTags")]
        internal sealed class _Proxy : DeputyBase, aws.Codepipeline.ICodepipelineTriggerGitConfigurationPushTags
        {
