...
{
    [JsiiByValue(fqn: "aws.codepipeline.CodepipelineTriggerGitConfigurationPushFilePaths")]
    public class CodepipelineTriggerGitConfigurationPushFilePaths : aws.Codepipeline.ICodepipelineTriggerGitConfigurationPushFilePaths
    {
