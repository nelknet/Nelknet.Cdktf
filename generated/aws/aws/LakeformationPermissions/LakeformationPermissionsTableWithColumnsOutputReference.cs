...
{
    [JsiiClass(nativeType: typeof(aws.LakeformationPermissions.LakeformationPermissionsTableWithColumnsOutputReference), fullyQualifiedName: "aws.lakeformationPermissions.LakeformationPermissionsTableWithColumnsOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class LakeformationPermissionsTableWithColumnsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public LakeformationPermissionsTableWithColumnsOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.lakeformationPermissions.LakeformationPermissionsTableWithColumns\"}", isOptional: true)]
        public virtual aws.LakeformationPermissions.ILakeformationPermissionsTableWithColumns? InternalValue
        {
