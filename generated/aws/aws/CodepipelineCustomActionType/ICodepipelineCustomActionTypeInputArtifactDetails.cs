...
{
    [JsiiInterface(nativeType: typeof(ICodepipelineCustomActionTypeInputArtifactDetails), fullyQualifiedName: "aws.codepipelineCustomActionType.CodepipelineCustomActionTypeInputArtifactDetails")]
    public interface ICodepipelineCustomActionTypeInputArtifactDetails
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ICodepipelineCustomActionTypeInputArtifactDetails), fullyQualifiedName: "aws.codepipelineCustomActionType.CodepipelineCustomActionTypeInputArtifactDetails")]
        internal sealed class _Proxy : DeputyBase, aws.CodepipelineCustomActionType.ICodepipelineCustomActionTypeInputArtifactDetails
        {
