...
{
    [JsiiInterface(nativeType: typeof(IDataAwsVpcPeeringConnectionsFilter), fullyQualifiedName: "aws.dataAwsVpcPeeringConnections.DataAwsVpcPeeringConnectionsFilter")]
    public interface IDataAwsVpcPeeringConnectionsFilter
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataAwsVpcPeeringConnectionsFilter), fullyQualifiedName: "aws.dataAwsVpcPeeringConnections.DataAwsVpcPeeringConnectionsFilter")]
        internal sealed class _Proxy : DeputyBase, aws.DataAwsVpcPeeringConnections.IDataAwsVpcPeeringConnectionsFilter
        {
