...
{
    [JsiiByValue(fqn: "aws.datazoneAssetType.DatazoneAssetTypeTimeouts")]
    public class DatazoneAssetTypeTimeouts : aws.DatazoneAssetType.IDatazoneAssetTypeTimeouts
    {
