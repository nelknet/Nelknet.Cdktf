...
namespace aws.AppsyncDatasource
{
    ...
    public interface IAppsyncDatasourceLambdaConfig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAppsyncDatasourceLambdaConfig), fullyQualifiedName: "aws.appsyncDatasource.AppsyncDatasourceLambdaConfig")]
        internal sealed class _Proxy : DeputyBase, aws.AppsyncDatasource.IAppsyncDatasourceLambdaConfig
        {
