...
{
    [JsiiInterface(nativeType: typeof(ICustomerprofilesDomainMatchingAutoMergingConflictResolution), fullyQualifiedName: "aws.customerprofilesDomain.CustomerprofilesDomainMatchingAutoMergingConflictResolution")]
    public interface ICustomerprofilesDomainMatchingAutoMergingConflictResolution
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ICustomerprofilesDomainMatchingAutoMergingConflictResolution), fullyQualifiedName: "aws.customerprofilesDomain.CustomerprofilesDomainMatchingAutoMergingConflictResolution")]
        internal sealed class _Proxy : DeputyBase, aws.CustomerprofilesDomain.ICustomerprofilesDomainMatchingAutoMergingConflictResolution
        {
