...
{
    [JsiiInterface(nativeType: typeof(IEc2NetworkInsightsPathFilterAtSource), fullyQualifiedName: "aws.ec2NetworkInsightsPath.Ec2NetworkInsightsPathFilterAtSource")]
    public interface IEc2NetworkInsightsPathFilterAtSource
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Ec2NetworkInsightsPath.IEc2NetworkInsightsPathFilterAtSourceDestinationPortRange? DestinationPortRange
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Ec2NetworkInsightsPath.IEc2NetworkInsightsPathFilterAtSourceSourcePortRange? SourcePortRange
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IEc2NetworkInsightsPathFilterAtSource), fullyQualifiedName: "aws.ec2NetworkInsightsPath.Ec2NetworkInsightsPathFilterAtSource")]
        internal sealed class _Proxy : DeputyBase, aws.Ec2NetworkInsightsPath.IEc2NetworkInsightsPathFilterAtSource
        {
