...
{
    [JsiiInterface(nativeType: typeof(ITransferWorkflowOnExceptionStepsCopyStepDetailsDestinationFileLocation), fullyQualifiedName: "aws.transferWorkflow.TransferWorkflowOnExceptionStepsCopyStepDetailsDestinationFileLocation")]
    public interface ITransferWorkflowOnExceptionStepsCopyStepDetailsDestinationFileLocation
    {
        ...
        aws.TransferWorkflow.ITransferWorkflowOnExceptionStepsCopyStepDetailsDestinationFileLocationEfsFileLocation? EfsFileLocation
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.TransferWorkflow.ITransferWorkflowOnExceptionStepsCopyStepDetailsDestinationFileLocationS3FileLocation? S3FileLocation
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ITransferWorkflowOnExceptionStepsCopyStepDetailsDestinationFileLocation), fullyQualifiedName: "aws.transferWorkflow.TransferWorkflowOnExceptionStepsCopyStepDetailsDestinationFileLocation")]
        internal sealed class _Proxy : DeputyBase, aws.TransferWorkflow.ITransferWorkflowOnExceptionStepsCopyStepDetailsDestinationFileLocation
        {
