...
{
    [JsiiInterface(nativeType: typeof(ITransferWorkflowStepsDecryptStepDetails), fullyQualifiedName: "aws.transferWorkflow.TransferWorkflowStepsDecryptStepDetails")]
    public interface ITransferWorkflowStepsDecryptStepDetails
    {
        ...
        aws.TransferWorkflow.ITransferWorkflowStepsDecryptStepDetailsDestinationFileLocation? DestinationFileLocation
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ITransferWorkflowStepsDecryptStepDetails), fullyQualifiedName: "aws.transferWorkflow.TransferWorkflowStepsDecryptStepDetails")]
        internal sealed class _Proxy : DeputyBase, aws.TransferWorkflow.ITransferWorkflowStepsDecryptStepDetails
        {
