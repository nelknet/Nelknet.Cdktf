...
{
    [JsiiInterface(nativeType: typeof(ITransferWorkflowStepsCopyStepDetails), fullyQualifiedName: "aws.transferWorkflow.TransferWorkflowStepsCopyStepDetails")]
    public interface ITransferWorkflowStepsCopyStepDetails
    {
        ...
        aws.TransferWorkflow.ITransferWorkflowStepsCopyStepDetailsDestinationFileLocation? DestinationFileLocation
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ITransferWorkflowStepsCopyStepDetails), fullyQualifiedName: "aws.transferWorkflow.TransferWorkflowStepsCopyStepDetails")]
        internal sealed class _Proxy : DeputyBase, aws.TransferWorkflow.ITransferWorkflowStepsCopyStepDetails
        {
