...
{
    [JsiiInterface(nativeType: typeof(ITransferWorkflowOnExceptionStepsCopyStepDetails), fullyQualifiedName: "aws.transferWorkflow.TransferWorkflowOnExceptionStepsCopyStepDetails")]
    public interface ITransferWorkflowOnExceptionStepsCopyStepDetails
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "destinationFileLocation", typeJson: "{\"fqn\":\"aws.transferWorkflow.TransferWorkflowOnExceptionStepsCopyStepDetailsDestinationFileLocation\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.TransferWorkflow.ITransferWorkflowOnExceptionStepsCopyStepDetailsDestinationFileLocation? DestinationFileLocation
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ITransferWorkflowOnExceptionStepsCopyStepDetails), fullyQualifiedName: "aws.transferWorkflow.TransferWorkflowOnExceptionStepsCopyStepDetails")]
        internal sealed class _Proxy : DeputyBase, aws.TransferWorkflow.ITransferWorkflowOnExceptionStepsCopyStepDetails
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "destinationFileLocation", typeJson: "{\"fqn\":\"aws.transferWorkflow.TransferWorkflowOnExceptionStepsCopyStepDetailsDestinationFileLocation\"}", isOptional: true)]
            public aws.TransferWorkflow.ITransferWorkflowOnExceptionStepsCopyStepDetailsDestinationFileLocation? DestinationFileLocation
            {
