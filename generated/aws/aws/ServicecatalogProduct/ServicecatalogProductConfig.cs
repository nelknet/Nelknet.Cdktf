...
namespace aws.ServicecatalogProduct
{
    ...
    [JsiiByValue(fqn: "aws.servicecatalogProduct.ServicecatalogProductConfig")]
    public class ServicecatalogProductConfig : aws.ServicecatalogProduct.IServicecatalogProductConfig
    {
