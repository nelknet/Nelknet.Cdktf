...
namespace aws.CeAnomalySubscription
{
    ...
    [JsiiByValue(fqn: "aws.ceAnomalySubscription.CeAnomalySubscriptionConfig")]
    public class CeAnomalySubscriptionConfig : aws.CeAnomalySubscription.ICeAnomalySubscriptionConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.CeAnomalySubscription.ICeAnomalySubscriptionSubscriber).FullName}[]; received null", nameof(value));
                        default:
