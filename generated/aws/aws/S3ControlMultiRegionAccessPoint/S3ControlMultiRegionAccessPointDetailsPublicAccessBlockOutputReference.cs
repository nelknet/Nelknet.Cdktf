...
namespace aws.S3ControlMultiRegionAccessPoint
{
    ...
    public class S3ControlMultiRegionAccessPointDetailsPublicAccessBlockOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public S3ControlMultiRegionAccessPointDetailsPublicAccessBlockOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected S3ControlMultiRegionAccessPointDetailsPublicAccessBlockOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected S3ControlMultiRegionAccessPointDetailsPublicAccessBlockOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.s3ControlMultiRegionAccessPoint.S3ControlMultiRegionAccessPointDetailsPublicAccessBlock\"}", isOptional: true)]
        public virtual aws.S3ControlMultiRegionAccessPoint.IS3ControlMultiRegionAccessPointDetailsPublicAccessBlock? InternalValue
        {
