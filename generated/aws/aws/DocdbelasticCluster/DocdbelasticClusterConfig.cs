...
namespace aws.DocdbelasticCluster
{
    ...
    [JsiiByValue(fqn: "aws.docdbelasticCluster.DocdbelasticClusterConfig")]
    public class DocdbelasticClusterConfig : aws.DocdbelasticCluster.IDocdbelasticClusterConfig
    {
