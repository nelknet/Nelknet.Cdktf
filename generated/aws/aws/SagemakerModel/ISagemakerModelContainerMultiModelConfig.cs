...
namespace aws.SagemakerModel
{
    ...
    public interface ISagemakerModelContainerMultiModelConfig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISagemakerModelContainerMultiModelConfig), fullyQualifiedName: "aws.sagemakerModel.SagemakerModelContainerMultiModelConfig")]
        internal sealed class _Proxy : DeputyBase, aws.SagemakerModel.ISagemakerModelContainerMultiModelConfig
        {
