...
namespace aws.SagemakerModel
{
    ...
    [JsiiByValue(fqn: "aws.sagemakerModel.SagemakerModelContainerModelDataSource")]
    public class SagemakerModelContainerModelDataSource : aws.SagemakerModel.ISagemakerModelContainerModelDataSource
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.SagemakerModel.ISagemakerModelContainerModelDataSourceS3DataSource).FullName}[]; received null", nameof(value));
                        default:
