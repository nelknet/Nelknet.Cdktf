...
{
    [JsiiInterface(nativeType: typeof(ISagemakerModelContainer), fullyQualifiedName: "aws.sagemakerModel.SagemakerModelContainer")]
    public interface ISagemakerModelContainer
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.SagemakerModel.ISagemakerModelContainerImageConfig? ImageConfig
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.SagemakerModel.ISagemakerModelContainerModelDataSource? ModelDataSource
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.SagemakerModel.ISagemakerModelContainerMultiModelConfig? MultiModelConfig
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ISagemakerModelContainer), fullyQualifiedName: "aws.sagemakerModel.SagemakerModelContainer")]
        internal sealed class _Proxy : DeputyBase, aws.SagemakerModel.ISagemakerModelContainer
        {
