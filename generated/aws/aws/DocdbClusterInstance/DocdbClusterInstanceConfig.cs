...
namespace aws.DocdbClusterInstance
{
    ...
    [JsiiByValue(fqn: "aws.docdbClusterInstance.DocdbClusterInstanceConfig")]
    public class DocdbClusterInstanceConfig : aws.DocdbClusterInstance.IDocdbClusterInstanceConfig
    {
        ...
        {
            get => _enablePerformanceInsights;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _enablePerformanceInsights = value;
            }
        }
