...
namespace aws.DynamodbTable
{
    ...
    [JsiiByValue(fqn: "aws.dynamodbTable.DynamodbTableServerSideEncryption")]
    public class DynamodbTableServerSideEncryption : aws.DynamodbTable.IDynamodbTableServerSideEncryption
    {
