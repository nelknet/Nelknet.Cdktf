...
{
    [JsiiInterface(nativeType: typeof(IDataAwsEipFilter), fullyQualifiedName: "aws.dataAwsEip.DataAwsEipFilter")]
    public interface IDataAwsEipFilter
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataAwsEipFilter), fullyQualifiedName: "aws.dataAwsEip.DataAwsEipFilter")]
        internal sealed class _Proxy : DeputyBase, aws.DataAwsEip.IDataAwsEipFilter
        {
