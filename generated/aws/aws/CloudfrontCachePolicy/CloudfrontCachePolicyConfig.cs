...
namespace aws.CloudfrontCachePolicy
{
    ...
    [JsiiByValue(fqn: "aws.cloudfrontCachePolicy.CloudfrontCachePolicyConfig")]
    public class CloudfrontCachePolicyConfig : aws.CloudfrontCachePolicy.ICloudfrontCachePolicyConfig
    {
