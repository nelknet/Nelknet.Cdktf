...
{
    [JsiiInterface(nativeType: typeof(IOpsworksHaproxyLayerConfig), fullyQualifiedName: "aws.opsworksHaproxyLayer.OpsworksHaproxyLayerConfig")]
    public interface IOpsworksHaproxyLayerConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.OpsworksHaproxyLayer.IOpsworksHaproxyLayerCloudwatchConfiguration? CloudwatchConfiguration
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.OpsworksHaproxyLayer.IOpsworksHaproxyLayerLoadBasedAutoScaling? LoadBasedAutoScaling
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IOpsworksHaproxyLayerConfig), fullyQualifiedName: "aws.opsworksHaproxyLayer.OpsworksHaproxyLayerConfig")]
        internal sealed class _Proxy : DeputyBase, aws.OpsworksHaproxyLayer.IOpsworksHaproxyLayerConfig
        {
