...
namespace aws.DataAwsEc2InstanceType
{
    ...
    public class DataAwsEc2InstanceTypeNetworkCardsList : HashiCorp.Cdktf.ComplexList
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        /// <param name="wrapsSet">whether the list is wrapping a set (will add tolist() to be able to access an item via an index).</param>
        public DataAwsEc2InstanceTypeNetworkCardsList(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute, bool wrapsSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, wrapsSet))
        {
        }
        ...
        protected DataAwsEc2InstanceTypeNetworkCardsList(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataAwsEc2InstanceTypeNetworkCardsList(DeputyProps props): base(props)
        {
        }

        /// <param name="index">the index of the item to return.</param>
        [JsiiMethod(name: "get", returnsJson: "{\"type\":{\"fqn\":\"aws.dataAwsEc2InstanceType.DataAwsEc2InstanceTypeNetworkCardsOutputReference\"}}", parametersJson: "[{\"docs\":{\"summary\":\"the index of the item to return.\"},\"name\":\"index\",\"type\":{\"primitive\":\"number\"}}]")]
        public virtual aws.DataAwsEc2InstanceType.DataAwsEc2InstanceTypeNetworkCardsOutputReference Get(double index)
        {
            return InvokeInstanceMethod<aws.DataAwsEc2InstanceType.DataAwsEc2InstanceTypeNetworkCardsOutputReference>(new System.Type[]{typeof(double)}, new object[]{index})!;
        }
