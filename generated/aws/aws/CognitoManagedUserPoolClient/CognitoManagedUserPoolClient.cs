...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/cognito_managed_user_pool_client aws_cognito_managed_user_pool_client}.</summary>
    [JsiiClass(nativeType: typeof(aws.CognitoManagedUserPoolClient.CognitoManagedUserPoolClient), fullyQualifiedName: "aws.cognitoManagedUserPoolClient.CognitoManagedUserPoolClient", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.cognitoManagedUserPoolClient.CognitoManagedUserPoolClientConfig\"}}]")]
    public class CognitoManagedUserPoolClient : HashiCorp.Cdktf.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/cognito_managed_user_pool_client aws_cognito_managed_user_pool_client} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public CognitoManagedUserPoolClient(Constructs.Construct scope, string id, aws.CognitoManagedUserPoolClient.ICognitoManagedUserPoolClientConfig config): base(_MakeDeputyProps(scope, id, config))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, aws.CognitoManagedUserPoolClient.ICognitoManagedUserPoolClientConfig config)
        {
        ...
        protected CognitoManagedUserPoolClient(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected CognitoManagedUserPoolClient(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTF code for importing a CognitoManagedUserPoolClient resource upon running "cdktf plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="importToId">The construct id used in the generated config for the CognitoManagedUserPoolClient to import.</param>
        /// <param name="importFromId">The id of the existing CognitoManagedUserPoolClient that should be imported.</param>
        /// <param name="provider">? Optional instance of the provider where the CognitoManagedUserPoolClient to import is found.</param>
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktf.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the CognitoManagedUserPoolClient to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/cognito_managed_user_pool_client#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing CognitoManagedUserPoolClient that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the CognitoManagedUserPoolClient to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktf.TerraformProvider\"}}]")]
        public static HashiCorp.Cdktf.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, HashiCorp.Cdktf.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<HashiCorp.Cdktf.ImportableResource>(typeof(aws.CognitoManagedUserPoolClient.CognitoManagedUserPoolClient), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(HashiCorp.Cdktf.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }

        [JsiiMethod(name: "putAnalyticsConfiguration", parametersJson: "[{\"name\":\"value\",\"type\":{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.cognitoManagedUserPoolClient.CognitoManagedUserPoolClientAnalyticsConfiguration\"},\"kind\":\"array\"}}]}}}]")]
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case HashiCorp.Cdktf.IResolvable cast_2ed7d7:
                        break;
                    case aws.CognitoManagedUserPoolClient.ICognitoManagedUserPoolClientAnalyticsConfiguration[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.CognitoManagedUserPoolClient.ICognitoManagedUserPoolClientAnalyticsConfiguration).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.CognitoManagedUserPoolClient.ICognitoManagedUserPoolClientAnalyticsConfiguration).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }

        [JsiiMethod(name: "putRefreshTokenRotation", parametersJson: "[{\"name\":\"value\",\"type\":{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.cognitoManagedUserPoolClient.CognitoManagedUserPoolClientRefreshTokenRotation\"},\"kind\":\"array\"}}]}}}]")]
        public virtual void PutRefreshTokenRotation(object @value)
        {
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case HashiCorp.Cdktf.IResolvable cast_2ed7d7:
                        break;
                    case aws.CognitoManagedUserPoolClient.ICognitoManagedUserPoolClientRefreshTokenRotation[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.CognitoManagedUserPoolClient.ICognitoManagedUserPoolClientRefreshTokenRotation).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.CognitoManagedUserPoolClient.ICognitoManagedUserPoolClientRefreshTokenRotation).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }

        [JsiiMethod(name: "putTokenValidityUnits", parametersJson: "[{\"name\":\"value\",\"type\":{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.cognitoManagedUserPoolClient.CognitoManagedUserPoolClientTokenValidityUnits\"},\"kind\":\"array\"}}]}}}]")]
        public virtual void PutTokenValidityUnits(object @value)
        {
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case HashiCorp.Cdktf.IResolvable cast_2ed7d7:
                        break;
                    case aws.CognitoManagedUserPoolClient.ICognitoManagedUserPoolClientTokenValidityUnits[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.CognitoManagedUserPoolClient.ICognitoManagedUserPoolClientTokenValidityUnits).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.CognitoManagedUserPoolClient.ICognitoManagedUserPoolClientTokenValidityUnits).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }
        ...
        = GetStaticProperty<string>(typeof(aws.CognitoManagedUserPoolClient.CognitoManagedUserPoolClient))!;

        [JsiiProperty(name: "analyticsConfiguration", typeJson: "{\"fqn\":\"aws.cognitoManagedUserPoolClient.CognitoManagedUserPoolClientAnalyticsConfigurationList\"}")]
        public virtual aws.CognitoManagedUserPoolClient.CognitoManagedUserPoolClientAnalyticsConfigurationList AnalyticsConfiguration
        {
            get => GetInstanceProperty<aws.CognitoManagedUserPoolClient.CognitoManagedUserPoolClientAnalyticsConfigurationList>()!;
        }
        ...
        [JsiiProperty(name: "refreshTokenRotation", typeJson: "{\"fqn\":\"aws.cognitoManagedUserPoolClient.CognitoManagedUserPoolClientRefreshTokenRotationList\"}")]
        public virtual aws.CognitoManagedUserPoolClient.CognitoManagedUserPoolClientRefreshTokenRotationList RefreshTokenRotation
        {
            get => GetInstanceProperty<aws.CognitoManagedUserPoolClient.CognitoManagedUserPoolClientRefreshTokenRotationList>()!;
        }

        [JsiiProperty(name: "tokenValidityUnits", typeJson: "{\"fqn\":\"aws.cognitoManagedUserPoolClient.CognitoManagedUserPoolClientTokenValidityUnitsList\"}")]
        public virtual aws.CognitoManagedUserPoolClient.CognitoManagedUserPoolClientTokenValidityUnitsList TokenValidityUnits
        {
            get => GetInstanceProperty<aws.CognitoManagedUserPoolClient.CognitoManagedUserPoolClientTokenValidityUnitsList>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "analyticsConfigurationInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.cognitoManagedUserPoolClient.CognitoManagedUserPoolClientAnalyticsConfiguration\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "refreshTokenRotationInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.cognitoManagedUserPoolClient.CognitoManagedUserPoolClientRefreshTokenRotation\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "tokenValidityUnitsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.cognitoManagedUserPoolClient.CognitoManagedUserPoolClientTokenValidityUnits\"},\"kind\":\"array\"}}]}}", isOptional: true)]
