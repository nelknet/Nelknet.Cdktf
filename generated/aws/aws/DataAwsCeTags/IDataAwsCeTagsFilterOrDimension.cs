...
{
    [JsiiInterface(nativeType: typeof(IDataAwsCeTagsFilterOrDimension), fullyQualifiedName: "aws.dataAwsCeTags.DataAwsCeTagsFilterOrDimension")]
    public interface IDataAwsCeTagsFilterOrDimension
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataAwsCeTagsFilterOrDimension), fullyQualifiedName: "aws.dataAwsCeTags.DataAwsCeTagsFilterOrDimension")]
        internal sealed class _Proxy : DeputyBase, aws.DataAwsCeTags.IDataAwsCeTagsFilterOrDimension
        {
