...
{
    [JsiiByValue(fqn: "aws.dataAwsCeTags.DataAwsCeTagsFilterOrCostCategory")]
    public class DataAwsCeTagsFilterOrCostCategory : aws.DataAwsCeTags.IDataAwsCeTagsFilterOrCostCategory
    {
