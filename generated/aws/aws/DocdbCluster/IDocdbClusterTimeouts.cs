...
{
    [JsiiInterface(nativeType: typeof(IDocdbClusterTimeouts), fullyQualifiedName: "aws.docdbCluster.DocdbClusterTimeouts")]
    public interface IDocdbClusterTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDocdbClusterTimeouts), fullyQualifiedName: "aws.docdbCluster.DocdbClusterTimeouts")]
        internal sealed class _Proxy : DeputyBase, aws.DocdbCluster.IDocdbClusterTimeouts
        {
