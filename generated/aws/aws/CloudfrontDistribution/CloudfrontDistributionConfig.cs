...
namespace aws.CloudfrontDistribution
{
    ...
    [JsiiByValue(fqn: "aws.cloudfrontDistribution.CloudfrontDistributionConfig")]
    public class CloudfrontDistributionConfig : aws.CloudfrontDistribution.ICloudfrontDistributionConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.CloudfrontDistribution.ICloudfrontDistributionOrigin).FullName}[]; received null", nameof(value));
                        default:
        ...
        private object? _orderedCacheBehavior;
        ...
        private object? _retainOnDelete;
