...
namespace aws.CloudfrontDistribution
{
    ...
    public class CloudfrontDistributionOrderedCacheBehaviorForwardedValuesCookiesOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public CloudfrontDistributionOrderedCacheBehaviorForwardedValuesCookiesOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
