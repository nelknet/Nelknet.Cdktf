...
{
    [JsiiInterface(nativeType: typeof(ICloudfrontDistributionOrderedCacheBehavior), fullyQualifiedName: "aws.cloudfrontDistribution.CloudfrontDistributionOrderedCacheBehavior")]
    public interface ICloudfrontDistributionOrderedCacheBehavior
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.CloudfrontDistribution.ICloudfrontDistributionOrderedCacheBehaviorForwardedValues? ForwardedValues
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.CloudfrontDistribution.ICloudfrontDistributionOrderedCacheBehaviorGrpcConfig? GrpcConfig
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ICloudfrontDistributionOrderedCacheBehavior), fullyQualifiedName: "aws.cloudfrontDistribution.CloudfrontDistributionOrderedCacheBehavior")]
        internal sealed class _Proxy : DeputyBase, aws.CloudfrontDistribution.ICloudfrontDistributionOrderedCacheBehavior
        {
