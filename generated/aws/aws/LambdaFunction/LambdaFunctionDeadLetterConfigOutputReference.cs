...
namespace aws.LambdaFunction
{
    ...
    public class LambdaFunctionDeadLetterConfigOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public LambdaFunctionDeadLetterConfigOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
