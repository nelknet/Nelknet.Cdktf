...
namespace aws.LambdaFunction
{
    ...
    public class LambdaFunctionTracingConfigOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public LambdaFunctionTracingConfigOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
