...
{
    [JsiiInterface(nativeType: typeof(ISpotInstanceRequestCapacityReservationSpecification), fullyQualifiedName: "aws.spotInstanceRequest.SpotInstanceRequestCapacityReservationSpecification")]
    public interface ISpotInstanceRequestCapacityReservationSpecification
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.SpotInstanceRequest.ISpotInstanceRequestCapacityReservationSpecificationCapacityReservationTarget? CapacityReservationTarget
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ISpotInstanceRequestCapacityReservationSpecification), fullyQualifiedName: "aws.spotInstanceRequest.SpotInstanceRequestCapacityReservationSpecification")]
        internal sealed class _Proxy : DeputyBase, aws.SpotInstanceRequest.ISpotInstanceRequestCapacityReservationSpecification
        {
