...
{
    [JsiiByValue(fqn: "aws.dataAwsEbsVolumes.DataAwsEbsVolumesTimeouts")]
    public class DataAwsEbsVolumesTimeouts : aws.DataAwsEbsVolumes.IDataAwsEbsVolumesTimeouts
    {
