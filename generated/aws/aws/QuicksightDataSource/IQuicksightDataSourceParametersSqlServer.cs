...
{
    [JsiiInterface(nativeType: typeof(IQuicksightDataSourceParametersSqlServer), fullyQualifiedName: "aws.quicksightDataSource.QuicksightDataSourceParametersSqlServer")]
    public interface IQuicksightDataSourceParametersSqlServer
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IQuicksightDataSourceParametersSqlServer), fullyQualifiedName: "aws.quicksightDataSource.QuicksightDataSourceParametersSqlServer")]
        internal sealed class _Proxy : DeputyBase, aws.QuicksightDataSource.IQuicksightDataSourceParametersSqlServer
        {
