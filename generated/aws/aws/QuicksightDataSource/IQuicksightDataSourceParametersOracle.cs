...
{
    [JsiiInterface(nativeType: typeof(IQuicksightDataSourceParametersOracle), fullyQualifiedName: "aws.quicksightDataSource.QuicksightDataSourceParametersOracle")]
    public interface IQuicksightDataSourceParametersOracle
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IQuicksightDataSourceParametersOracle), fullyQualifiedName: "aws.quicksightDataSource.QuicksightDataSourceParametersOracle")]
        internal sealed class _Proxy : DeputyBase, aws.QuicksightDataSource.IQuicksightDataSourceParametersOracle
        {
