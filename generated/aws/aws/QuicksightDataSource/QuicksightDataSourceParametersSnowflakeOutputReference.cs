...
namespace aws.QuicksightDataSource
{
    ...
    public class QuicksightDataSourceParametersSnowflakeOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public QuicksightDataSourceParametersSnowflakeOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
