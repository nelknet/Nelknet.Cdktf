...
namespace aws.CloudwatchMetricAlarm
{
    ...
    public class CloudwatchMetricAlarmMetricQueryMetricOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public CloudwatchMetricAlarmMetricQueryMetricOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.cloudwatchMetricAlarm.CloudwatchMetricAlarmMetricQueryMetric\"}", isOptional: true)]
        public virtual aws.CloudwatchMetricAlarm.ICloudwatchMetricAlarmMetricQueryMetric? InternalValue
        {
