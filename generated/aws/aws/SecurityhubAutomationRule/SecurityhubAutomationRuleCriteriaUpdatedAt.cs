...
{
    [JsiiByValue(fqn: "aws.securityhubAutomationRule.SecurityhubAutomationRuleCriteriaUpdatedAt")]
    public class SecurityhubAutomationRuleCriteriaUpdatedAt : aws.SecurityhubAutomationRule.ISecurityhubAutomationRuleCriteriaUpdatedAt
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "dateRange", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.securityhubAutomationRule.SecurityhubAutomationRuleCriteriaUpdatedAtDateRange\"},\"kind\":\"array\"}}]}}", isOptional: true)]
