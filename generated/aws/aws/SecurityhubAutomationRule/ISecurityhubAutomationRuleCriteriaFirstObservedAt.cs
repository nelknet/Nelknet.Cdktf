...
{
    [JsiiInterface(nativeType: typeof(ISecurityhubAutomationRuleCriteriaFirstObservedAt), fullyQualifiedName: "aws.securityhubAutomationRule.SecurityhubAutomationRuleCriteriaFirstObservedAt")]
    public interface ISecurityhubAutomationRuleCriteriaFirstObservedAt
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISecurityhubAutomationRuleCriteriaFirstObservedAt), fullyQualifiedName: "aws.securityhubAutomationRule.SecurityhubAutomationRuleCriteriaFirstObservedAt")]
        internal sealed class _Proxy : DeputyBase, aws.SecurityhubAutomationRule.ISecurityhubAutomationRuleCriteriaFirstObservedAt
        {
