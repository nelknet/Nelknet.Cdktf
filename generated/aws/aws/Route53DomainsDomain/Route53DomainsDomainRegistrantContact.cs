...
{
    [JsiiByValue(fqn: "aws.route53DomainsDomain.Route53DomainsDomainRegistrantContact")]
    public class Route53DomainsDomainRegistrantContact : aws.Route53DomainsDomain.IRoute53DomainsDomainRegistrantContact
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "extraParam", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.route53DomainsDomain.Route53DomainsDomainRegistrantContactExtraParam\"},\"kind\":\"array\"}}]}}", isOptional: true)]
