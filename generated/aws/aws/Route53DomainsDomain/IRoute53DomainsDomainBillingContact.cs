...
{
    [JsiiInterface(nativeType: typeof(IRoute53DomainsDomainBillingContact), fullyQualifiedName: "aws.route53DomainsDomain.Route53DomainsDomainBillingContact")]
    public interface IRoute53DomainsDomainBillingContact
    {
        ...
        /// <summary>Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/route53domains_domain#extra_param Route53DomainsDomain#extra_param}.</summary>
        [JsiiProperty(name: "extraParam", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.route53DomainsDomain.Route53DomainsDomainBillingContactExtraParam\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? ExtraParam
        {
            get
        ...
        [JsiiTypeProxy(nativeType: typeof(IRoute53DomainsDomainBillingContact), fullyQualifiedName: "aws.route53DomainsDomain.Route53DomainsDomainBillingContact")]
        internal sealed class _Proxy : DeputyBase, aws.Route53DomainsDomain.IRoute53DomainsDomainBillingContact
        {
