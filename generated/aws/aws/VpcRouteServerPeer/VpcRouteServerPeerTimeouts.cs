...
{
    [JsiiByValue(fqn: "aws.vpcRouteServerPeer.VpcRouteServerPeerTimeouts")]
    public class VpcRouteServerPeerTimeouts : aws.VpcRouteServerPeer.IVpcRouteServerPeerTimeouts
    {
