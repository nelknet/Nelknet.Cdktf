...
namespace aws.GlueTrigger
{
    ...
    [JsiiByValue(fqn: "aws.glueTrigger.GlueTriggerConfig")]
    public class GlueTriggerConfig : aws.GlueTrigger.IGlueTriggerConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.GlueTrigger.IGlueTriggerActions).FullName}[]; received null", nameof(value));
                        default:
        ...
        private object? _eventBatchingCondition;
        ...
        private object? _startOnCreation;
