...
{
    [JsiiInterface(nativeType: typeof(IEksAddonTimeouts), fullyQualifiedName: "aws.eksAddon.EksAddonTimeouts")]
    public interface IEksAddonTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IEksAddonTimeouts), fullyQualifiedName: "aws.eksAddon.EksAddonTimeouts")]
        internal sealed class _Proxy : DeputyBase, aws.EksAddon.IEksAddonTimeouts
        {
