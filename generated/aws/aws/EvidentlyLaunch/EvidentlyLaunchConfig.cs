...
namespace aws.EvidentlyLaunch
{
    ...
    [JsiiByValue(fqn: "aws.evidentlyLaunch.EvidentlyLaunchConfig")]
    public class EvidentlyLaunchConfig : aws.EvidentlyLaunch.IEvidentlyLaunchConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.EvidentlyLaunch.IEvidentlyLaunchGroups).FullName}[]; received null", nameof(value));
                        default:
        ...
        private object? _metricMonitors;
