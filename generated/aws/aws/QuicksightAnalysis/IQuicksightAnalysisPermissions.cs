...
namespace aws.QuicksightAnalysis
{
    ...
    public interface IQuicksightAnalysisPermissions
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IQuicksightAnalysisPermissions), fullyQualifiedName: "aws.quicksightAnalysis.QuicksightAnalysisPermissions")]
        internal sealed class _Proxy : DeputyBase, aws.QuicksightAnalysis.IQuicksightAnalysisPermissions
        {
