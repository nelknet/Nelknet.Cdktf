...
namespace aws.LbListener
{
    ...
    public interface ILbListenerDefaultActionAuthenticateCognito
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILbListenerDefaultActionAuthenticateCognito), fullyQualifiedName: "aws.lbListener.LbListenerDefaultActionAuthenticateCognito")]
        internal sealed class _Proxy : DeputyBase, aws.LbListener.ILbListenerDefaultActionAuthenticateCognito
        {
