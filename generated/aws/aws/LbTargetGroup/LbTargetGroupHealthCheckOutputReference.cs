...
namespace aws.LbTargetGroup
{
    ...
    public class LbTargetGroupHealthCheckOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public LbTargetGroupHealthCheckOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
