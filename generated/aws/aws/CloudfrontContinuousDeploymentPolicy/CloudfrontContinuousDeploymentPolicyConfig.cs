...
namespace aws.CloudfrontContinuousDeploymentPolicy
{
    ...
    [JsiiByValue(fqn: "aws.cloudfrontContinuousDeploymentPolicy.CloudfrontContinuousDeploymentPolicyConfig")]
    public class CloudfrontContinuousDeploymentPolicyConfig : aws.CloudfrontContinuousDeploymentPolicy.ICloudfrontContinuousDeploymentPolicyConfig
    {
        ...
        private object? _stagingDistributionDnsNames;
        ...
        {
            get => _stagingDistributionDnsNames;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _stagingDistributionDnsNames = value;
            }
        }

        private object? _trafficConfig;
