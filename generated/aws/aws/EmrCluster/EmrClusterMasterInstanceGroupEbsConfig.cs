...
namespace aws.EmrCluster
{
    ...
    [JsiiByValue(fqn: "aws.emrCluster.EmrClusterMasterInstanceGroupEbsConfig")]
    public class EmrClusterMasterInstanceGroupEbsConfig : aws.EmrCluster.IEmrClusterMasterInstanceGroupEbsConfig
    {
