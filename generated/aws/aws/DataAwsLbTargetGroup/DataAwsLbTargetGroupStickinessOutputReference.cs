...
namespace aws.DataAwsLbTargetGroup
{
    ...
    public class DataAwsLbTargetGroupStickinessOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public DataAwsLbTargetGroupStickinessOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute, double complexObjectIndex, bool complexObjectIsFromSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.dataAwsLbTargetGroup.DataAwsLbTargetGroupStickiness\"}", isOptional: true)]
        public virtual aws.DataAwsLbTargetGroup.IDataAwsLbTargetGroupStickiness? InternalValue
        {
            get => GetInstanceProperty<aws.DataAwsLbTargetGroup.IDataAwsLbTargetGroupStickiness?>();
