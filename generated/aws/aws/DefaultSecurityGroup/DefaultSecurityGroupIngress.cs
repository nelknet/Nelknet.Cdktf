...
{
    [JsiiByValue(fqn: "aws.defaultSecurityGroup.DefaultSecurityGroupIngress")]
    public class DefaultSecurityGroupIngress : aws.DefaultSecurityGroup.IDefaultSecurityGroupIngress
    {
