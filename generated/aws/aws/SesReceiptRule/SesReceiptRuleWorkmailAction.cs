...
namespace aws.SesReceiptRule
{
    ...
    [JsiiByValue(fqn: "aws.sesReceiptRule.SesReceiptRuleWorkmailAction")]
    public class SesReceiptRuleWorkmailAction : aws.SesReceiptRule.ISesReceiptRuleWorkmailAction
    {
