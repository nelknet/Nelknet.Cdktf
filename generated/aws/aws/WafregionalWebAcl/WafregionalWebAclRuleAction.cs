...
namespace aws.WafregionalWebAcl
{
    ...
    [JsiiByValue(fqn: "aws.wafregionalWebAcl.WafregionalWebAclRuleAction")]
    public class WafregionalWebAclRuleAction : aws.WafregionalWebAcl.IWafregionalWebAclRuleAction
    {
