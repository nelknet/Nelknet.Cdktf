...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/default_subnet aws_default_subnet}.</summary>
    [JsiiClass(nativeType: typeof(aws.DefaultSubnet.DefaultSubnet), fullyQualifiedName: "aws.defaultSubnet.DefaultSubnet", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.defaultSubnet.DefaultSubnetConfig\"}}]")]
    public class DefaultSubnet : HashiCorp.Cdktf.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/default_subnet aws_default_subnet} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public DefaultSubnet(Constructs.Construct scope, string id, aws.DefaultSubnet.IDefaultSubnetConfig config): base(_MakeDeputyProps(scope, id, config))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, aws.DefaultSubnet.IDefaultSubnetConfig config)
        {
        ...
        /// <summary>Generates CDKTF code for importing a DefaultSubnet resource upon running "cdktf plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="importToId">The construct id used in the generated config for the DefaultSubnet to import.</param>
        /// <param name="importFromId">The id of the existing DefaultSubnet that should be imported.</param>
        /// <param name="provider">? Optional instance of the provider where the DefaultSubnet to import is found.</param>
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktf.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the DefaultSubnet to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/default_subnet#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing DefaultSubnet that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the DefaultSubnet to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktf.TerraformProvider\"}}]")]
        public static HashiCorp.Cdktf.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, HashiCorp.Cdktf.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<HashiCorp.Cdktf.ImportableResource>(typeof(aws.DefaultSubnet.DefaultSubnet), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(HashiCorp.Cdktf.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }

        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.defaultSubnet.DefaultSubnetTimeouts\"}}]")]
        public virtual void PutTimeouts(aws.DefaultSubnet.IDefaultSubnetTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.DefaultSubnet.IDefaultSubnetTimeouts)}, new object[]{@value});
        }
        ...
        = GetStaticProperty<string>(typeof(aws.DefaultSubnet.DefaultSubnet))!;
        ...
        [JsiiProperty(name: "existingDefaultSubnet", typeJson: "{\"fqn\":\"cdktf.IResolvable\"}")]
        public virtual HashiCorp.Cdktf.IResolvable ExistingDefaultSubnet
        {
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.defaultSubnet.DefaultSubnetTimeoutsOutputReference\"}")]
        public virtual aws.DefaultSubnet.DefaultSubnetTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<aws.DefaultSubnet.DefaultSubnetTimeoutsOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"fqn\":\"aws.defaultSubnet.DefaultSubnetTimeouts\"}]}}", isOptional: true)]
