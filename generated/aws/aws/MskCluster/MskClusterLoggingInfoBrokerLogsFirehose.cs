...
namespace aws.MskCluster
{
    ...
    [JsiiByValue(fqn: "aws.mskCluster.MskClusterLoggingInfoBrokerLogsFirehose")]
    public class MskClusterLoggingInfoBrokerLogsFirehose : aws.MskCluster.IMskClusterLoggingInfoBrokerLogsFirehose
    {
