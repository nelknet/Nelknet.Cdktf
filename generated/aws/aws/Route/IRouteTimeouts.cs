...
namespace aws.Route
{
    [JsiiInterface(nativeType: typeof(IRouteTimeouts), fullyQualifiedName: "aws.route.RouteTimeouts")]
    public interface IRouteTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IRouteTimeouts), fullyQualifiedName: "aws.route.RouteTimeouts")]
        internal sealed class _Proxy : DeputyBase, aws.Route.IRouteTimeouts
        {
