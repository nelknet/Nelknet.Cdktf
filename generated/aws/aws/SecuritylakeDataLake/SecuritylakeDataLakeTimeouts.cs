...
{
    [JsiiByValue(fqn: "aws.securitylakeDataLake.SecuritylakeDataLakeTimeouts")]
    public class SecuritylakeDataLakeTimeouts : aws.SecuritylakeDataLake.ISecuritylakeDataLakeTimeouts
    {
