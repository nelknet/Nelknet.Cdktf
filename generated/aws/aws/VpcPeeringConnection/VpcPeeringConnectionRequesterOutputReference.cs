...
{
    [JsiiClass(nativeType: typeof(aws.VpcPeeringConnection.VpcPeeringConnectionRequesterOutputReference), fullyQualifiedName: "aws.vpcPeeringConnection.VpcPeeringConnectionRequesterOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class VpcPeeringConnectionRequesterOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public VpcPeeringConnectionRequesterOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.vpcPeeringConnection.VpcPeeringConnectionRequester\"}", isOptional: true)]
        public virtual aws.VpcPeeringConnection.IVpcPeeringConnectionRequester? InternalValue
        {
