...
namespace aws.VpcPeeringConnection
{
    ...
    public class VpcPeeringConnectionAccepterOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public VpcPeeringConnectionAccepterOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
