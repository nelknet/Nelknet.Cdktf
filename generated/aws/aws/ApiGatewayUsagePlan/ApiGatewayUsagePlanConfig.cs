...
namespace aws.ApiGatewayUsagePlan
{
    ...
    [JsiiByValue(fqn: "aws.apiGatewayUsagePlan.ApiGatewayUsagePlanConfig")]
    public class ApiGatewayUsagePlanConfig : aws.ApiGatewayUsagePlan.IApiGatewayUsagePlanConfig
    {
