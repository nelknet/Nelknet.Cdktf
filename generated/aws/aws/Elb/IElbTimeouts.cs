...
namespace aws.Elb
{
    [JsiiInterface(nativeType: typeof(IElbTimeouts), fullyQualifiedName: "aws.elb.ElbTimeouts")]
    public interface IElbTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IElbTimeouts), fullyQualifiedName: "aws.elb.ElbTimeouts")]
        internal sealed class _Proxy : DeputyBase, aws.Elb.IElbTimeouts
        {
