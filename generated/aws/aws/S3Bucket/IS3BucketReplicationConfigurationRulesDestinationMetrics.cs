...
{
    [JsiiInterface(nativeType: typeof(IS3BucketReplicationConfigurationRulesDestinationMetrics), fullyQualifiedName: "aws.s3Bucket.S3BucketReplicationConfigurationRulesDestinationMetrics")]
    public interface IS3BucketReplicationConfigurationRulesDestinationMetrics
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IS3BucketReplicationConfigurationRulesDestinationMetrics), fullyQualifiedName: "aws.s3Bucket.S3BucketReplicationConfigurationRulesDestinationMetrics")]
        internal sealed class _Proxy : DeputyBase, aws.S3Bucket.IS3BucketReplicationConfigurationRulesDestinationMetrics
        {
