...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/rds_engine_version aws_rds_engine_version}.</summary>
    [JsiiClass(nativeType: typeof(aws.DataAwsRdsEngineVersion.DataAwsRdsEngineVersion), fullyQualifiedName: "aws.dataAwsRdsEngineVersion.DataAwsRdsEngineVersion", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.dataAwsRdsEngineVersion.DataAwsRdsEngineVersionConfig\"}}]")]
    public class DataAwsRdsEngineVersion : HashiCorp.Cdktf.TerraformDataSource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/rds_engine_version aws_rds_engine_version} Data Source.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public DataAwsRdsEngineVersion(Constructs.Construct scope, string id, aws.DataAwsRdsEngineVersion.IDataAwsRdsEngineVersionConfig config): base(_MakeDeputyProps(scope, id, config))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, aws.DataAwsRdsEngineVersion.IDataAwsRdsEngineVersionConfig config)
        {
        ...
        protected DataAwsRdsEngineVersion(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataAwsRdsEngineVersion(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTF code for importing a DataAwsRdsEngineVersion resource upon running "cdktf plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="importToId">The construct id used in the generated config for the DataAwsRdsEngineVersion to import.</param>
        /// <param name="importFromId">The id of the existing DataAwsRdsEngineVersion that should be imported.</param>
        /// <param name="provider">? Optional instance of the provider where the DataAwsRdsEngineVersion to import is found.</param>
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktf.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the DataAwsRdsEngineVersion to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/rds_engine_version#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing DataAwsRdsEngineVersion that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the DataAwsRdsEngineVersion to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktf.TerraformProvider\"}}]")]
        public static HashiCorp.Cdktf.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, HashiCorp.Cdktf.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<HashiCorp.Cdktf.ImportableResource>(typeof(aws.DataAwsRdsEngineVersion.DataAwsRdsEngineVersion), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(HashiCorp.Cdktf.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }

        [JsiiMethod(name: "putFilter", parametersJson: "[{\"name\":\"value\",\"type\":{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.dataAwsRdsEngineVersion.DataAwsRdsEngineVersionFilter\"},\"kind\":\"array\"}}]}}}]")]
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case HashiCorp.Cdktf.IResolvable cast_2ed7d7:
                        break;
                    case aws.DataAwsRdsEngineVersion.IDataAwsRdsEngineVersionFilter[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.DataAwsRdsEngineVersion.IDataAwsRdsEngineVersionFilter).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.DataAwsRdsEngineVersion.IDataAwsRdsEngineVersionFilter).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
        ...
        = GetStaticProperty<string>(typeof(aws.DataAwsRdsEngineVersion.DataAwsRdsEngineVersion))!;
        ...
        [JsiiProperty(name: "filter", typeJson: "{\"fqn\":\"aws.dataAwsRdsEngineVersion.DataAwsRdsEngineVersionFilterList\"}")]
        public virtual aws.DataAwsRdsEngineVersion.DataAwsRdsEngineVersionFilterList Filter
        {
            get => GetInstanceProperty<aws.DataAwsRdsEngineVersion.DataAwsRdsEngineVersionFilterList>()!;
        }
        ...
        [JsiiProperty(name: "supportedFeatureNames", typeJson: "{\"collection\":{\"elementtype\":{\"primitive\":\"string\"},\"kind\":\"array\"}}")]
        public virtual string[] SupportedFeatureNames
        {
            get => GetInstanceProperty<string[]>()!;
        }
        ...
        [JsiiProperty(name: "supportsCertificateRotationWithoutRestart", typeJson: "{\"fqn\":\"cdktf.IResolvable\"}")]
        public virtual HashiCorp.Cdktf.IResolvable SupportsCertificateRotationWithoutRestart
        {
        ...
        [JsiiProperty(name: "supportsIntegrations", typeJson: "{\"fqn\":\"cdktf.IResolvable\"}")]
        public virtual HashiCorp.Cdktf.IResolvable SupportsIntegrations
        {
            get => GetInstanceProperty<HashiCorp.Cdktf.IResolvable>()!;
        }

        [JsiiProperty(name: "supportsLimitlessDatabase", typeJson: "{\"fqn\":\"cdktf.IResolvable\"}")]
        public virtual HashiCorp.Cdktf.IResolvable SupportsLimitlessDatabase
        {
            get => GetInstanceProperty<HashiCorp.Cdktf.IResolvable>()!;
        }

        [JsiiProperty(name: "supportsLocalWriteForwarding", typeJson: "{\"fqn\":\"cdktf.IResolvable\"}")]
        public virtual HashiCorp.Cdktf.IResolvable SupportsLocalWriteForwarding
        {
            get => GetInstanceProperty<HashiCorp.Cdktf.IResolvable>()!;
        }
        ...
        [JsiiProperty(name: "supportsParallelQuery", typeJson: "{\"fqn\":\"cdktf.IResolvable\"}")]
        public virtual HashiCorp.Cdktf.IResolvable SupportsParallelQuery
        {
            get => GetInstanceProperty<HashiCorp.Cdktf.IResolvable>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "filterInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.dataAwsRdsEngineVersion.DataAwsRdsEngineVersionFilter\"},\"kind\":\"array\"}}]}}", isOptional: true)]
