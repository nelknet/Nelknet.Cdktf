...
namespace aws.ApiGatewayIntegration
{
    ...
    public class ApiGatewayIntegrationTlsConfigOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public ApiGatewayIntegrationTlsConfigOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
