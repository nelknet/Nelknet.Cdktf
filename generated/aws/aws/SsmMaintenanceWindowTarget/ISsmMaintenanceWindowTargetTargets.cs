...
{
    [JsiiInterface(nativeType: typeof(ISsmMaintenanceWindowTargetTargets), fullyQualifiedName: "aws.ssmMaintenanceWindowTarget.SsmMaintenanceWindowTargetTargets")]
    public interface ISsmMaintenanceWindowTargetTargets
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISsmMaintenanceWindowTargetTargets), fullyQualifiedName: "aws.ssmMaintenanceWindowTarget.SsmMaintenanceWindowTargetTargets")]
        internal sealed class _Proxy : DeputyBase, aws.SsmMaintenanceWindowTarget.ISsmMaintenanceWindowTargetTargets
        {
