...
namespace aws.Inspector2Filter
{
    ...
    public class Inspector2FilterFilterCriteriaLastObservedAtOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        protected Inspector2FilterFilterCriteriaLastObservedAtOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected Inspector2FilterFilterCriteriaLastObservedAtOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"fqn\":\"aws.inspector2Filter.Inspector2FilterFilterCriteriaLastObservedAt\"}]}}", isOptional: true)]
