...
namespace aws.Inspector2Filter
{
    ...
    public interface IInspector2FilterFilterCriteriaFirstObservedAt
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IInspector2FilterFilterCriteriaFirstObservedAt), fullyQualifiedName: "aws.inspector2Filter.Inspector2FilterFilterCriteriaFirstObservedAt")]
        internal sealed class _Proxy : DeputyBase, aws.Inspector2Filter.IInspector2FilterFilterCriteriaFirstObservedAt
        {
