...
namespace aws.Inspector2Filter
{
    ...
    [JsiiByValue(fqn: "aws.inspector2Filter.Inspector2FilterFilterCriteriaTitle")]
    public class Inspector2FilterFilterCriteriaTitle : aws.Inspector2Filter.IInspector2FilterFilterCriteriaTitle
    {
