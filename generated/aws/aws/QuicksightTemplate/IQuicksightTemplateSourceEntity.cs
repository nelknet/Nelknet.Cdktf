...
{
    [JsiiInterface(nativeType: typeof(IQuicksightTemplateSourceEntity), fullyQualifiedName: "aws.quicksightTemplate.QuicksightTemplateSourceEntity")]
    public interface IQuicksightTemplateSourceEntity
    {
        ...
        aws.QuicksightTemplate.IQuicksightTemplateSourceEntitySourceAnalysis? SourceAnalysis
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.QuicksightTemplate.IQuicksightTemplateSourceEntitySourceTemplate? SourceTemplate
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IQuicksightTemplateSourceEntity), fullyQualifiedName: "aws.quicksightTemplate.QuicksightTemplateSourceEntity")]
        internal sealed class _Proxy : DeputyBase, aws.QuicksightTemplate.IQuicksightTemplateSourceEntity
        {
