...
namespace aws.GlueJob
{
    ...
    [JsiiByValue(fqn: "aws.glueJob.GlueJobConfig")]
    public class GlueJobConfig : aws.GlueJob.IGlueJobConfig
    {
        ...
        private object? _jobRunQueuingEnabled;
