...
{
    [JsiiByValue(fqn: "aws.schedulerSchedule.SchedulerScheduleTargetRetryPolicy")]
    public class SchedulerScheduleTargetRetryPolicy : aws.SchedulerSchedule.ISchedulerScheduleTargetRetryPolicy
    {
