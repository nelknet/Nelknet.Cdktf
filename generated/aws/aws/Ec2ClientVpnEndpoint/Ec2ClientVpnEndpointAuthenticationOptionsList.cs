...
namespace aws.Ec2ClientVpnEndpoint
{
    ...
    public class Ec2ClientVpnEndpointAuthenticationOptionsList : HashiCorp.Cdktf.ComplexList
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        /// <param name="wrapsSet">whether the list is wrapping a set (will add tolist() to be able to access an item via an index).</param>
        public Ec2ClientVpnEndpointAuthenticationOptionsList(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute, bool wrapsSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, wrapsSet))
        {
        }
        ...
        protected Ec2ClientVpnEndpointAuthenticationOptionsList(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected Ec2ClientVpnEndpointAuthenticationOptionsList(DeputyProps props): base(props)
        {
        }

        /// <param name="index">the index of the item to return.</param>
        [JsiiMethod(name: "get", returnsJson: "{\"type\":{\"fqn\":\"aws.ec2ClientVpnEndpoint.Ec2ClientVpnEndpointAuthenticationOptionsOutputReference\"}}", parametersJson: "[{\"docs\":{\"summary\":\"the index of the item to return.\"},\"name\":\"index\",\"type\":{\"primitive\":\"number\"}}]")]
        public virtual aws.Ec2ClientVpnEndpoint.Ec2ClientVpnEndpointAuthenticationOptionsOutputReference Get(double index)
        {
            return InvokeInstanceMethod<aws.Ec2ClientVpnEndpoint.Ec2ClientVpnEndpointAuthenticationOptionsOutputReference>(new System.Type[]{typeof(double)}, new object[]{index})!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.ec2ClientVpnEndpoint.Ec2ClientVpnEndpointAuthenticationOptions\"},\"kind\":\"array\"}}]}}", isOptional: true)]
