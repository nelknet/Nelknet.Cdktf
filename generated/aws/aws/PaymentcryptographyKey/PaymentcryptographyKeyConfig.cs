...
namespace aws.PaymentcryptographyKey
{
    ...
    [JsiiByValue(fqn: "aws.paymentcryptographyKey.PaymentcryptographyKeyConfig")]
    public class PaymentcryptographyKeyConfig : aws.PaymentcryptographyKey.IPaymentcryptographyKeyConfig
    {
