...
{
    [JsiiClass(nativeType: typeof(aws.GuarddutyDetector.GuarddutyDetectorDatasourcesS3LogsOutputReference), fullyQualifiedName: "aws.guarddutyDetector.GuarddutyDetectorDatasourcesS3LogsOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class GuarddutyDetectorDatasourcesS3LogsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public GuarddutyDetectorDatasourcesS3LogsOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.guarddutyDetector.GuarddutyDetectorDatasourcesS3Logs\"}", isOptional: true)]
        public virtual aws.GuarddutyDetector.IGuarddutyDetectorDatasourcesS3Logs? InternalValue
        {
