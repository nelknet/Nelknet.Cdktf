...
namespace aws.OpsworksCustomLayer
{
    ...
    [JsiiByValue(fqn: "aws.opsworksCustomLayer.OpsworksCustomLayerEbsVolume")]
    public class OpsworksCustomLayerEbsVolume : aws.OpsworksCustomLayer.IOpsworksCustomLayerEbsVolume
    {
