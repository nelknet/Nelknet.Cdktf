...
namespace aws.SagemakerFeatureGroup
{
    ...
    [JsiiByValue(fqn: "aws.sagemakerFeatureGroup.SagemakerFeatureGroupConfig")]
    public class SagemakerFeatureGroupConfig : aws.SagemakerFeatureGroup.ISagemakerFeatureGroupConfig
    {
        ...
        private object _featureDefinition;
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.SagemakerFeatureGroup.ISagemakerFeatureGroupFeatureDefinition).FullName}[]; received null", nameof(value));
                        default:
