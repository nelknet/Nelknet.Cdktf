...
{
    [JsiiClass(nativeType: typeof(aws.CognitoUserPool.CognitoUserPoolUsernameConfigurationOutputReference), fullyQualifiedName: "aws.cognitoUserPool.CognitoUserPoolUsernameConfigurationOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class CognitoUserPoolUsernameConfigurationOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public CognitoUserPoolUsernameConfigurationOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.cognitoUserPool.CognitoUserPoolUsernameConfiguration\"}", isOptional: true)]
        public virtual aws.CognitoUserPool.ICognitoUserPoolUsernameConfiguration? InternalValue
        {
