...
namespace aws.DataAwsLaunchTemplate
{
    ...
    public class DataAwsLaunchTemplateInstanceMarketOptionsSpotOptionsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.dataAwsLaunchTemplate.DataAwsLaunchTemplateInstanceMarketOptionsSpotOptions\"}", isOptional: true)]
        public virtual aws.DataAwsLaunchTemplate.IDataAwsLaunchTemplateInstanceMarketOptionsSpotOptions? InternalValue
        {
            get => GetInstanceProperty<aws.DataAwsLaunchTemplate.IDataAwsLaunchTemplateInstanceMarketOptionsSpotOptions?>();
