...
namespace aws.DataAwsLaunchTemplate
{
    ...
    public class DataAwsLaunchTemplateBlockDeviceMappingsEbsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.dataAwsLaunchTemplate.DataAwsLaunchTemplateBlockDeviceMappingsEbs\"}", isOptional: true)]
        public virtual aws.DataAwsLaunchTemplate.IDataAwsLaunchTemplateBlockDeviceMappingsEbs? InternalValue
        {
            get => GetInstanceProperty<aws.DataAwsLaunchTemplate.IDataAwsLaunchTemplateBlockDeviceMappingsEbs?>();
