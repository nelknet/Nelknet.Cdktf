...
namespace aws.GlobalacceleratorEndpointGroup
{
    ...
    public class GlobalacceleratorEndpointGroupEndpointConfigurationOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        protected GlobalacceleratorEndpointGroupEndpointConfigurationOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected GlobalacceleratorEndpointGroupEndpointConfigurationOutputReference(DeputyProps props): base(props)
        {
        }

        [JsiiMethod(name: "resetAttachmentArn")]
        public virtual void ResetAttachmentArn()
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "attachmentArnInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? AttachmentArnInput
        {
            get => GetInstanceProperty<string?>();
        }

        [JsiiOptional]
        [JsiiProperty(name: "clientIpPreservationEnabledInput", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktf.IResolvable\"}]}}", isOptional: true)]
        ...
        [JsiiProperty(name: "attachmentArn", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string AttachmentArn
        {
            get => GetInstanceProperty<string>()!;
            set => SetInstanceProperty(value);
        }

        [JsiiProperty(name: "clientIpPreservationEnabled", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktf.IResolvable\"}]}}")]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"fqn\":\"aws.globalacceleratorEndpointGroup.GlobalacceleratorEndpointGroupEndpointConfiguration\"}]}}", isOptional: true)]
