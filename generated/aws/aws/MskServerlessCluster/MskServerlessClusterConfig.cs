...
namespace aws.MskServerlessCluster
{
    ...
    [JsiiByValue(fqn: "aws.mskServerlessCluster.MskServerlessClusterConfig")]
    public class MskServerlessClusterConfig : aws.MskServerlessCluster.IMskServerlessClusterConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.MskServerlessCluster.IMskServerlessClusterVpcConfig).FullName}[]; received null", nameof(value));
                        default:
