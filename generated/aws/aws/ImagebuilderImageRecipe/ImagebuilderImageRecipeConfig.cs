...
namespace aws.ImagebuilderImageRecipe
{
    ...
    [JsiiByValue(fqn: "aws.imagebuilderImageRecipe.ImagebuilderImageRecipeConfig")]
    public class ImagebuilderImageRecipeConfig : aws.ImagebuilderImageRecipe.IImagebuilderImageRecipeConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.ImagebuilderImageRecipe.IImagebuilderImageRecipeComponent).FullName}[]; received null", nameof(value));
                        default:
