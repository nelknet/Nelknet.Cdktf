...
namespace aws.AcmCertificate
{
    ...
    public class AcmCertificateDomainValidationOptionsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public AcmCertificateDomainValidationOptionsOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute, double complexObjectIndex, bool complexObjectIsFromSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.acmCertificate.AcmCertificateDomainValidationOptions\"}", isOptional: true)]
        public virtual aws.AcmCertificate.IAcmCertificateDomainValidationOptions? InternalValue
        {
            get => GetInstanceProperty<aws.AcmCertificate.IAcmCertificateDomainValidationOptions?>();
