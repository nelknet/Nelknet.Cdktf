...
namespace aws.AppmeshRoute
{
    ...
    [JsiiByValue(fqn: "aws.appmeshRoute.AppmeshRouteSpecGrpcRouteTimeoutIdle")]
    public class AppmeshRouteSpecGrpcRouteTimeoutIdle : aws.AppmeshRoute.IAppmeshRouteSpecGrpcRouteTimeoutIdle
    {
