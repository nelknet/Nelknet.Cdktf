...
namespace aws.AppmeshRoute
{
    ...
    [JsiiByValue(fqn: "aws.appmeshRoute.AppmeshRouteSpecHttpRouteTimeoutIdle")]
    public class AppmeshRouteSpecHttpRouteTimeoutIdle : aws.AppmeshRoute.IAppmeshRouteSpecHttpRouteTimeoutIdle
    {
