...
namespace aws.AppmeshRoute
{
    ...
    [JsiiByValue(fqn: "aws.appmeshRoute.AppmeshRouteSpecTcpRouteTimeoutIdle")]
    public class AppmeshRouteSpecTcpRouteTimeoutIdle : aws.AppmeshRoute.IAppmeshRouteSpecTcpRouteTimeoutIdle
    {
