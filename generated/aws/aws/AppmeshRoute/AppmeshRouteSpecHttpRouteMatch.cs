...
{
    [JsiiByValue(fqn: "aws.appmeshRoute.AppmeshRouteSpecHttpRouteMatch")]
    public class AppmeshRouteSpecHttpRouteMatch : aws.AppmeshRoute.IAppmeshRouteSpecHttpRouteMatch
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "header", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.appmeshRoute.AppmeshRouteSpecHttpRouteMatchHeader\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "path", typeJson: "{\"fqn\":\"aws.appmeshRoute.AppmeshRouteSpecHttpRouteMatchPath\"}", isOptional: true)]
        public aws.AppmeshRoute.IAppmeshRouteSpecHttpRouteMatchPath? Path
        {
            get;
            set;
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "queryParameter", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.appmeshRoute.AppmeshRouteSpecHttpRouteMatchQueryParameter\"},\"kind\":\"array\"}}]}}", isOptional: true)]
