...
{
    [JsiiInterface(nativeType: typeof(IAppmeshRouteSpecGrpcRouteMatchMetadataMatchRange), fullyQualifiedName: "aws.appmeshRoute.AppmeshRouteSpecGrpcRouteMatchMetadataMatchRange")]
    public interface IAppmeshRouteSpecGrpcRouteMatchMetadataMatchRange
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAppmeshRouteSpecGrpcRouteMatchMetadataMatchRange), fullyQualifiedName: "aws.appmeshRoute.AppmeshRouteSpecGrpcRouteMatchMetadataMatchRange")]
        internal sealed class _Proxy : DeputyBase, aws.AppmeshRoute.IAppmeshRouteSpecGrpcRouteMatchMetadataMatchRange
        {
