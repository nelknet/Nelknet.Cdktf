...
{
    [JsiiByValue(fqn: "aws.appmeshRoute.AppmeshRouteSpecHttp2RouteMatchHeaderMatch")]
    public class AppmeshRouteSpecHttp2RouteMatchHeaderMatch : aws.AppmeshRoute.IAppmeshRouteSpecHttp2RouteMatchHeaderMatch
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "range", typeJson: "{\"fqn\":\"aws.appmeshRoute.AppmeshRouteSpecHttp2RouteMatchHeaderMatchRange\"}", isOptional: true)]
        public aws.AppmeshRoute.IAppmeshRouteSpecHttp2RouteMatchHeaderMatchRange? Range
        {
            get;
            set;
        }
