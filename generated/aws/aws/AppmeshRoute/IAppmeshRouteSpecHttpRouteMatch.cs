...
{
    [JsiiInterface(nativeType: typeof(IAppmeshRouteSpecHttpRouteMatch), fullyQualifiedName: "aws.appmeshRoute.AppmeshRouteSpecHttpRouteMatch")]
    public interface IAppmeshRouteSpecHttpRouteMatch
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.AppmeshRoute.IAppmeshRouteSpecHttpRouteMatchPath? Path
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IAppmeshRouteSpecHttpRouteMatch), fullyQualifiedName: "aws.appmeshRoute.AppmeshRouteSpecHttpRouteMatch")]
        internal sealed class _Proxy : DeputyBase, aws.AppmeshRoute.IAppmeshRouteSpecHttpRouteMatch
        {
