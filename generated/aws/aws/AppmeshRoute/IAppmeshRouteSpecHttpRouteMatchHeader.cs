...
{
    [JsiiInterface(nativeType: typeof(IAppmeshRouteSpecHttpRouteMatchHeader), fullyQualifiedName: "aws.appmeshRoute.AppmeshRouteSpecHttpRouteMatchHeader")]
    public interface IAppmeshRouteSpecHttpRouteMatchHeader
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "match", typeJson: "{\"fqn\":\"aws.appmeshRoute.AppmeshRouteSpecHttpRouteMatchHeaderMatch\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.AppmeshRoute.IAppmeshRouteSpecHttpRouteMatchHeaderMatch? Match
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IAppmeshRouteSpecHttpRouteMatchHeader), fullyQualifiedName: "aws.appmeshRoute.AppmeshRouteSpecHttpRouteMatchHeader")]
        internal sealed class _Proxy : DeputyBase, aws.AppmeshRoute.IAppmeshRouteSpecHttpRouteMatchHeader
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "match", typeJson: "{\"fqn\":\"aws.appmeshRoute.AppmeshRouteSpecHttpRouteMatchHeaderMatch\"}", isOptional: true)]
            public aws.AppmeshRoute.IAppmeshRouteSpecHttpRouteMatchHeaderMatch? Match
            {
