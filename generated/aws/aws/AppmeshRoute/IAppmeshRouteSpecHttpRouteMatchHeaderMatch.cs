...
{
    [JsiiInterface(nativeType: typeof(IAppmeshRouteSpecHttpRouteMatchHeaderMatch), fullyQualifiedName: "aws.appmeshRoute.AppmeshRouteSpecHttpRouteMatchHeaderMatch")]
    public interface IAppmeshRouteSpecHttpRouteMatchHeaderMatch
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.AppmeshRoute.IAppmeshRouteSpecHttpRouteMatchHeaderMatchRange? Range
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IAppmeshRouteSpecHttpRouteMatchHeaderMatch), fullyQualifiedName: "aws.appmeshRoute.AppmeshRouteSpecHttpRouteMatchHeaderMatch")]
        internal sealed class _Proxy : DeputyBase, aws.AppmeshRoute.IAppmeshRouteSpecHttpRouteMatchHeaderMatch
        {
