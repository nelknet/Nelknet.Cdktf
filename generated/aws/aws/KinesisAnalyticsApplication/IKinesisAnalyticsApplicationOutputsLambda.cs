...
{
    [JsiiInterface(nativeType: typeof(IKinesisAnalyticsApplicationOutputsLambda), fullyQualifiedName: "aws.kinesisAnalyticsApplication.KinesisAnalyticsApplicationOutputsLambda")]
    public interface IKinesisAnalyticsApplicationOutputsLambda
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IKinesisAnalyticsApplicationOutputsLambda), fullyQualifiedName: "aws.kinesisAnalyticsApplication.KinesisAnalyticsApplicationOutputsLambda")]
        internal sealed class _Proxy : DeputyBase, aws.KinesisAnalyticsApplication.IKinesisAnalyticsApplicationOutputsLambda
        {
