...
{
    [JsiiByValue(fqn: "aws.ceCostCategory.CeCostCategoryRuleRuleOrOrTags")]
    public class CeCostCategoryRuleRuleOrOrTags : aws.CeCostCategory.ICeCostCategoryRuleRuleOrOrTags
    {
