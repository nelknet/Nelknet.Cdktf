...
{
    [JsiiByValue(fqn: "aws.ceCostCategory.CeCostCategoryRuleRuleOrOrCostCategory")]
    public class CeCostCategoryRuleRuleOrOrCostCategory : aws.CeCostCategory.ICeCostCategoryRuleRuleOrOrCostCategory
    {
