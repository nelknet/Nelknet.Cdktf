...
{
    [JsiiByValue(fqn: "aws.ceCostCategory.CeCostCategoryRuleRuleNotNot")]
    public class CeCostCategoryRuleRuleNotNot : aws.CeCostCategory.ICeCostCategoryRuleRuleNotNot
    {
