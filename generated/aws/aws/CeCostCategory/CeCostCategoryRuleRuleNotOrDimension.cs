...
{
    [JsiiByValue(fqn: "aws.ceCostCategory.CeCostCategoryRuleRuleNotOrDimension")]
    public class CeCostCategoryRuleRuleNotOrDimension : aws.CeCostCategory.ICeCostCategoryRuleRuleNotOrDimension
    {
