...
{
    [JsiiByValue(fqn: "aws.ceCostCategory.CeCostCategoryRuleRuleOrOrDimension")]
    public class CeCostCategoryRuleRuleOrOrDimension : aws.CeCostCategory.ICeCostCategoryRuleRuleOrOrDimension
    {
