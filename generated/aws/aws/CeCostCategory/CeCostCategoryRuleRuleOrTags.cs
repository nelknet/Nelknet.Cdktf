...
{
    [JsiiByValue(fqn: "aws.ceCostCategory.CeCostCategoryRuleRuleOrTags")]
    public class CeCostCategoryRuleRuleOrTags : aws.CeCostCategory.ICeCostCategoryRuleRuleOrTags
    {
