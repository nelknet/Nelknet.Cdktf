...
{
    [JsiiInterface(nativeType: typeof(ICeCostCategoryRuleRuleOrOrDimension), fullyQualifiedName: "aws.ceCostCategory.CeCostCategoryRuleRuleOrOrDimension")]
    public interface ICeCostCategoryRuleRuleOrOrDimension
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ICeCostCategoryRuleRuleOrOrDimension), fullyQualifiedName: "aws.ceCostCategory.CeCostCategoryRuleRuleOrOrDimension")]
        internal sealed class _Proxy : DeputyBase, aws.CeCostCategory.ICeCostCategoryRuleRuleOrOrDimension
        {
