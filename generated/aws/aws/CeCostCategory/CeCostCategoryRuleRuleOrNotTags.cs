...
{
    [JsiiByValue(fqn: "aws.ceCostCategory.CeCostCategoryRuleRuleOrNotTags")]
    public class CeCostCategoryRuleRuleOrNotTags : aws.CeCostCategory.ICeCostCategoryRuleRuleOrNotTags
    {
