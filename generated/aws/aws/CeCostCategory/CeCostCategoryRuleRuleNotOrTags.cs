...
{
    [JsiiByValue(fqn: "aws.ceCostCategory.CeCostCategoryRuleRuleNotOrTags")]
    public class CeCostCategoryRuleRuleNotOrTags : aws.CeCostCategory.ICeCostCategoryRuleRuleNotOrTags
    {
