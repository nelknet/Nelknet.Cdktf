...
namespace aws.BudgetsBudgetAction
{
    ...
    [JsiiByValue(fqn: "aws.budgetsBudgetAction.BudgetsBudgetActionConfig")]
    public class BudgetsBudgetActionConfig : aws.BudgetsBudgetAction.IBudgetsBudgetActionConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.BudgetsBudgetAction.IBudgetsBudgetActionSubscriber).FullName}[]; received null", nameof(value));
                        default:
