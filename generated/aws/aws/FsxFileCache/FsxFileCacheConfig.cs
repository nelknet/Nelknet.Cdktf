...
namespace aws.FsxFileCache
{
    ...
    public class FsxFileCacheConfig : aws.FsxFileCache.IFsxFileCacheConfig
    {
        ...
        {
            get => _copyTagsToDataRepositoryAssociations;
            set
            {
                ...
                _copyTagsToDataRepositoryAssociations = value;
            }
        }

        private object? _dataRepositoryAssociation;
        ...
        {
            get => _dataRepositoryAssociation;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _dataRepositoryAssociation = value;
            }
        }
