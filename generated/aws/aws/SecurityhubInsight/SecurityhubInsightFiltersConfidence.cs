...
{
    [JsiiByValue(fqn: "aws.securityhubInsight.SecurityhubInsightFiltersConfidence")]
    public class SecurityhubInsightFiltersConfidence : aws.SecurityhubInsight.ISecurityhubInsightFiltersConfidence
    {
