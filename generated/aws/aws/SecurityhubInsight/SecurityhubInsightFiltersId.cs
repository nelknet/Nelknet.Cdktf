...
namespace aws.SecurityhubInsight
{
    ...
    [JsiiByValue(fqn: "aws.securityhubInsight.SecurityhubInsightFiltersId")]
    public class SecurityhubInsightFiltersId : aws.SecurityhubInsight.ISecurityhubInsightFiltersId
    {
