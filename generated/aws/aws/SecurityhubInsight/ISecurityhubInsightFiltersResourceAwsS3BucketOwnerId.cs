...
{
    [JsiiInterface(nativeType: typeof(ISecurityhubInsightFiltersResourceAwsS3BucketOwnerId), fullyQualifiedName: "aws.securityhubInsight.SecurityhubInsightFiltersResourceAwsS3BucketOwnerId")]
    public interface ISecurityhubInsightFiltersResourceAwsS3BucketOwnerId
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISecurityhubInsightFiltersResourceAwsS3BucketOwnerId), fullyQualifiedName: "aws.securityhubInsight.SecurityhubInsightFiltersResourceAwsS3BucketOwnerId")]
        internal sealed class _Proxy : DeputyBase, aws.SecurityhubInsight.ISecurityhubInsightFiltersResourceAwsS3BucketOwnerId
        {
