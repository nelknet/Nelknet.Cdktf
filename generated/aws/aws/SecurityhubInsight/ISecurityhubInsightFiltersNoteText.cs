...
{
    [JsiiInterface(nativeType: typeof(ISecurityhubInsightFiltersNoteText), fullyQualifiedName: "aws.securityhubInsight.SecurityhubInsightFiltersNoteText")]
    public interface ISecurityhubInsightFiltersNoteText
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISecurityhubInsightFiltersNoteText), fullyQualifiedName: "aws.securityhubInsight.SecurityhubInsightFiltersNoteText")]
        internal sealed class _Proxy : DeputyBase, aws.SecurityhubInsight.ISecurityhubInsightFiltersNoteText
        {
