...
{
    [JsiiInterface(nativeType: typeof(ISecurityhubInsightFiltersCreatedAtDateRange), fullyQualifiedName: "aws.securityhubInsight.SecurityhubInsightFiltersCreatedAtDateRange")]
    public interface ISecurityhubInsightFiltersCreatedAtDateRange
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISecurityhubInsightFiltersCreatedAtDateRange), fullyQualifiedName: "aws.securityhubInsight.SecurityhubInsightFiltersCreatedAtDateRange")]
        internal sealed class _Proxy : DeputyBase, aws.SecurityhubInsight.ISecurityhubInsightFiltersCreatedAtDateRange
        {
