...
namespace aws.SecurityhubInsight
{
    ...
    [JsiiByValue(fqn: "aws.securityhubInsight.SecurityhubInsightFiltersTitle")]
    public class SecurityhubInsightFiltersTitle : aws.SecurityhubInsight.ISecurityhubInsightFiltersTitle
    {
