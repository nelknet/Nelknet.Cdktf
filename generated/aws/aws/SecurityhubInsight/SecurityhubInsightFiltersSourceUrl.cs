...
namespace aws.SecurityhubInsight
{
    ...
    [JsiiByValue(fqn: "aws.securityhubInsight.SecurityhubInsightFiltersSourceUrl")]
    public class SecurityhubInsightFiltersSourceUrl : aws.SecurityhubInsight.ISecurityhubInsightFiltersSourceUrl
    {
