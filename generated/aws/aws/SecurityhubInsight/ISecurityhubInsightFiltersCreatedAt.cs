...
{
    [JsiiInterface(nativeType: typeof(ISecurityhubInsightFiltersCreatedAt), fullyQualifiedName: "aws.securityhubInsight.SecurityhubInsightFiltersCreatedAt")]
    public interface ISecurityhubInsightFiltersCreatedAt
    {
        ...
        aws.SecurityhubInsight.ISecurityhubInsightFiltersCreatedAtDateRange? DateRange
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ISecurityhubInsightFiltersCreatedAt), fullyQualifiedName: "aws.securityhubInsight.SecurityhubInsightFiltersCreatedAt")]
        internal sealed class _Proxy : DeputyBase, aws.SecurityhubInsight.ISecurityhubInsightFiltersCreatedAt
        {
