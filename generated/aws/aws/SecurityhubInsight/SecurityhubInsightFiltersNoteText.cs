...
namespace aws.SecurityhubInsight
{
    ...
    [JsiiByValue(fqn: "aws.securityhubInsight.SecurityhubInsightFiltersNoteText")]
    public class SecurityhubInsightFiltersNoteText : aws.SecurityhubInsight.ISecurityhubInsightFiltersNoteText
    {
