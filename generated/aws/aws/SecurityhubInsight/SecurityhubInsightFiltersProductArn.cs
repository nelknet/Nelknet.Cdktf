...
namespace aws.SecurityhubInsight
{
    ...
    [JsiiByValue(fqn: "aws.securityhubInsight.SecurityhubInsightFiltersProductArn")]
    public class SecurityhubInsightFiltersProductArn : aws.SecurityhubInsight.ISecurityhubInsightFiltersProductArn
    {
