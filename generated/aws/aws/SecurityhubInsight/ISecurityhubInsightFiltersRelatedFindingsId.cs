...
{
    [JsiiInterface(nativeType: typeof(ISecurityhubInsightFiltersRelatedFindingsId), fullyQualifiedName: "aws.securityhubInsight.SecurityhubInsightFiltersRelatedFindingsId")]
    public interface ISecurityhubInsightFiltersRelatedFindingsId
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISecurityhubInsightFiltersRelatedFindingsId), fullyQualifiedName: "aws.securityhubInsight.SecurityhubInsightFiltersRelatedFindingsId")]
        internal sealed class _Proxy : DeputyBase, aws.SecurityhubInsight.ISecurityhubInsightFiltersRelatedFindingsId
        {
