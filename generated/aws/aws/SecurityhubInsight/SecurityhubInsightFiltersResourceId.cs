...
namespace aws.SecurityhubInsight
{
    ...
    [JsiiByValue(fqn: "aws.securityhubInsight.SecurityhubInsightFiltersResourceId")]
    public class SecurityhubInsightFiltersResourceId : aws.SecurityhubInsight.ISecurityhubInsightFiltersResourceId
    {
