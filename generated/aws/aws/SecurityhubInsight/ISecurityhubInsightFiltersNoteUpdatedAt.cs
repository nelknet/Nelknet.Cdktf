...
{
    [JsiiInterface(nativeType: typeof(ISecurityhubInsightFiltersNoteUpdatedAt), fullyQualifiedName: "aws.securityhubInsight.SecurityhubInsightFiltersNoteUpdatedAt")]
    public interface ISecurityhubInsightFiltersNoteUpdatedAt
    {
        ...
        aws.SecurityhubInsight.ISecurityhubInsightFiltersNoteUpdatedAtDateRange? DateRange
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ISecurityhubInsightFiltersNoteUpdatedAt), fullyQualifiedName: "aws.securityhubInsight.SecurityhubInsightFiltersNoteUpdatedAt")]
        internal sealed class _Proxy : DeputyBase, aws.SecurityhubInsight.ISecurityhubInsightFiltersNoteUpdatedAt
        {
