...
{
    [JsiiInterface(nativeType: typeof(ISecurityhubInsightFiltersResourceContainerName), fullyQualifiedName: "aws.securityhubInsight.SecurityhubInsightFiltersResourceContainerName")]
    public interface ISecurityhubInsightFiltersResourceContainerName
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISecurityhubInsightFiltersResourceContainerName), fullyQualifiedName: "aws.securityhubInsight.SecurityhubInsightFiltersResourceContainerName")]
        internal sealed class _Proxy : DeputyBase, aws.SecurityhubInsight.ISecurityhubInsightFiltersResourceContainerName
        {
