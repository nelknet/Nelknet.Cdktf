...
namespace aws.SecurityhubInsight
{
    ...
    public interface ISecurityhubInsightFiltersResourceContainerLaunchedAtDateRange
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISecurityhubInsightFiltersResourceContainerLaunchedAtDateRange), fullyQualifiedName: "aws.securityhubInsight.SecurityhubInsightFiltersResourceContainerLaunchedAtDateRange")]
        internal sealed class _Proxy : DeputyBase, aws.SecurityhubInsight.ISecurityhubInsightFiltersResourceContainerLaunchedAtDateRange
        {
