...
{
    [JsiiInterface(nativeType: typeof(ISecurityhubInsightFiltersResourceAwsS3BucketOwnerName), fullyQualifiedName: "aws.securityhubInsight.SecurityhubInsightFiltersResourceAwsS3BucketOwnerName")]
    public interface ISecurityhubInsightFiltersResourceAwsS3BucketOwnerName
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISecurityhubInsightFiltersResourceAwsS3BucketOwnerName), fullyQualifiedName: "aws.securityhubInsight.SecurityhubInsightFiltersResourceAwsS3BucketOwnerName")]
        internal sealed class _Proxy : DeputyBase, aws.SecurityhubInsight.ISecurityhubInsightFiltersResourceAwsS3BucketOwnerName
        {
