...
namespace aws.VpcIpamResourceDiscovery
{
    ...
    [JsiiByValue(fqn: "aws.vpcIpamResourceDiscovery.VpcIpamResourceDiscoveryConfig")]
    public class VpcIpamResourceDiscoveryConfig : aws.VpcIpamResourceDiscovery.IVpcIpamResourceDiscoveryConfig
    {
        private object _operatingRegions;
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.VpcIpamResourceDiscovery.IVpcIpamResourceDiscoveryOperatingRegions).FullName}[]; received null", nameof(value));
                        default:
