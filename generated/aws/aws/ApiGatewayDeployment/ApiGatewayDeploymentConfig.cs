...
namespace aws.ApiGatewayDeployment
{
    ...
    [JsiiByValue(fqn: "aws.apiGatewayDeployment.ApiGatewayDeploymentConfig")]
    public class ApiGatewayDeploymentConfig : aws.ApiGatewayDeployment.IApiGatewayDeploymentConfig
    {
