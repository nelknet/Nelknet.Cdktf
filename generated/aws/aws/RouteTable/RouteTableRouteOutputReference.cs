...
namespace aws.RouteTable
{
    ...
    public class RouteTableRouteOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"fqn\":\"aws.routeTable.RouteTableRoute\"}]}}", isOptional: true)]
