...
namespace aws.OpsworksStack
{
    ...
    [JsiiByValue(fqn: "aws.opsworksStack.OpsworksStackConfig")]
    public class OpsworksStackConfig : aws.OpsworksStack.IOpsworksStackConfig
    {
        ...
        {
            get => _useOpsworksSecurityGroups;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _useOpsworksSecurityGroups = value;
            }
        }
