...
namespace aws.SagemakerAppImageConfig
{
    ...
    public interface ISagemakerAppImageConfigKernelGatewayImageConfigFileSystemConfig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISagemakerAppImageConfigKernelGatewayImageConfigFileSystemConfig), fullyQualifiedName: "aws.sagemakerAppImageConfig.SagemakerAppImageConfigKernelGatewayImageConfigFileSystemConfig")]
        internal sealed class _Proxy : DeputyBase, aws.SagemakerAppImageConfig.ISagemakerAppImageConfigKernelGatewayImageConfigFileSystemConfig
        {
