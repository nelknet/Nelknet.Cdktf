...
namespace aws.SagemakerDomain
{
    ...
    public class SagemakerDomainDefaultUserSettingsSharingSettingsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public SagemakerDomainDefaultUserSettingsSharingSettingsOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
