...
{
    [JsiiInterface(nativeType: typeof(ISagemakerDomainDefaultSpaceSettingsJupyterLabAppSettings), fullyQualifiedName: "aws.sagemakerDomain.SagemakerDomainDefaultSpaceSettingsJupyterLabAppSettings")]
    public interface ISagemakerDomainDefaultSpaceSettingsJupyterLabAppSettings
    {
        ...
        aws.SagemakerDomain.ISagemakerDomainDefaultSpaceSettingsJupyterLabAppSettingsAppLifecycleManagement? AppLifecycleManagement
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.SagemakerDomain.ISagemakerDomainDefaultSpaceSettingsJupyterLabAppSettingsDefaultResourceSpec? DefaultResourceSpec
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.SagemakerDomain.ISagemakerDomainDefaultSpaceSettingsJupyterLabAppSettingsEmrSettings? EmrSettings
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ISagemakerDomainDefaultSpaceSettingsJupyterLabAppSettings), fullyQualifiedName: "aws.sagemakerDomain.SagemakerDomainDefaultSpaceSettingsJupyterLabAppSettings")]
        internal sealed class _Proxy : DeputyBase, aws.SagemakerDomain.ISagemakerDomainDefaultSpaceSettingsJupyterLabAppSettings
        {
