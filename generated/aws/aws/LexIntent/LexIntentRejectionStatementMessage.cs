...
namespace aws.LexIntent
{
    ...
    [JsiiByValue(fqn: "aws.lexIntent.LexIntentRejectionStatementMessage")]
    public class LexIntentRejectionStatementMessage : aws.LexIntent.ILexIntentRejectionStatementMessage
    {
