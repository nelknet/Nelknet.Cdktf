...
namespace aws.LexIntent
{
    ...
    public interface ILexIntentDialogCodeHook
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILexIntentDialogCodeHook), fullyQualifiedName: "aws.lexIntent.LexIntentDialogCodeHook")]
        internal sealed class _Proxy : DeputyBase, aws.LexIntent.ILexIntentDialogCodeHook
        {
