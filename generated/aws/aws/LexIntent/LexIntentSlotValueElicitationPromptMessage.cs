...
namespace aws.LexIntent
{
    ...
    [JsiiByValue(fqn: "aws.lexIntent.LexIntentSlotValueElicitationPromptMessage")]
    public class LexIntentSlotValueElicitationPromptMessage : aws.LexIntent.ILexIntentSlotValueElicitationPromptMessage
    {
