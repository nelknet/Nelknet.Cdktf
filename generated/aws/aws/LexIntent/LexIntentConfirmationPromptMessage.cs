...
namespace aws.LexIntent
{
    ...
    [JsiiByValue(fqn: "aws.lexIntent.LexIntentConfirmationPromptMessage")]
    public class LexIntentConfirmationPromptMessage : aws.LexIntent.ILexIntentConfirmationPromptMessage
    {
