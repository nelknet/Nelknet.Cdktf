...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/connect_instance aws_connect_instance}.</summary>
    [JsiiClass(nativeType: typeof(aws.ConnectInstance.ConnectInstance), fullyQualifiedName: "aws.connectInstance.ConnectInstance", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.connectInstance.ConnectInstanceConfig\"}}]")]
    public class ConnectInstance : HashiCorp.Cdktf.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/connect_instance aws_connect_instance} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public ConnectInstance(Constructs.Construct scope, string id, aws.ConnectInstance.IConnectInstanceConfig config): base(_MakeDeputyProps(scope, id, config))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, aws.ConnectInstance.IConnectInstanceConfig config)
        {
        ...
        /// <summary>Generates CDKTF code for importing a ConnectInstance resource upon running "cdktf plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="importToId">The construct id used in the generated config for the ConnectInstance to import.</param>
        /// <param name="importFromId">The id of the existing ConnectInstance that should be imported.</param>
        /// <param name="provider">? Optional instance of the provider where the ConnectInstance to import is found.</param>
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktf.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the ConnectInstance to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/connect_instance#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing ConnectInstance that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the ConnectInstance to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktf.TerraformProvider\"}}]")]
        public static HashiCorp.Cdktf.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, HashiCorp.Cdktf.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<HashiCorp.Cdktf.ImportableResource>(typeof(aws.ConnectInstance.ConnectInstance), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(HashiCorp.Cdktf.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }

        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.connectInstance.ConnectInstanceTimeouts\"}}]")]
        public virtual void PutTimeouts(aws.ConnectInstance.IConnectInstanceTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.ConnectInstance.IConnectInstanceTimeouts)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "resetMultiPartyConferenceEnabled")]
        public virtual void ResetMultiPartyConferenceEnabled()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        = GetStaticProperty<string>(typeof(aws.ConnectInstance.ConnectInstance))!;
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.connectInstance.ConnectInstanceTimeoutsOutputReference\"}")]
        public virtual aws.ConnectInstance.ConnectInstanceTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<aws.ConnectInstance.ConnectInstanceTimeoutsOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "multiPartyConferenceEnabledInput", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktf.IResolvable\"}]}}", isOptional: true)]
        public virtual object? MultiPartyConferenceEnabledInput
        {
            get => GetInstanceProperty<object?>();
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"fqn\":\"aws.connectInstance.ConnectInstanceTimeouts\"}]}}", isOptional: true)]
        ...
        [JsiiProperty(name: "multiPartyConferenceEnabled", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktf.IResolvable\"}]}}")]
        public virtual object MultiPartyConferenceEnabled
        {
            get => GetInstanceProperty<object>()!;
            set
            {
