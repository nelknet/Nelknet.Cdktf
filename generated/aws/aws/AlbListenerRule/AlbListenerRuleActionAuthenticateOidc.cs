...
namespace aws.AlbListenerRule
{
    ...
    [JsiiByValue(fqn: "aws.albListenerRule.AlbListenerRuleActionAuthenticateOidc")]
    public class AlbListenerRuleActionAuthenticateOidc : aws.AlbListenerRule.IAlbListenerRuleActionAuthenticateOidc
    {
