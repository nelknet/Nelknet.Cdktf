...
{
    [JsiiInterface(nativeType: typeof(ILakeformationDataLakeSettingsCreateDatabaseDefaultPermissions), fullyQualifiedName: "aws.lakeformationDataLakeSettings.LakeformationDataLakeSettingsCreateDatabaseDefaultPermissions")]
    public interface ILakeformationDataLakeSettingsCreateDatabaseDefaultPermissions
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILakeformationDataLakeSettingsCreateDatabaseDefaultPermissions), fullyQualifiedName: "aws.lakeformationDataLakeSettings.LakeformationDataLakeSettingsCreateDatabaseDefaultPermissions")]
        internal sealed class _Proxy : DeputyBase, aws.LakeformationDataLakeSettings.ILakeformationDataLakeSettingsCreateDatabaseDefaultPermissions
        {
