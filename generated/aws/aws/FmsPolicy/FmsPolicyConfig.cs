...
namespace aws.FmsPolicy
{
    ...
    [JsiiByValue(fqn: "aws.fmsPolicy.FmsPolicyConfig")]
    public class FmsPolicyConfig : aws.FmsPolicy.IFmsPolicyConfig
    {
        private object _excludeResourceTags;
        ...
        private object? _deleteAllPolicyResources;
        ...
        public object? DeleteAllPolicyResources
        {
            ...
            set
            {
                ...
                _deleteAllPolicyResources = value;
            }
        }

        private object? _deleteUnusedFmManagedResources;
        ...
        {
            get => _deleteUnusedFmManagedResources;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _deleteUnusedFmManagedResources = value;
            }
        }
        ...
        private object? _remediationEnabled;
