...
namespace aws.GluePartition
{
    ...
    public class GluePartitionStorageDescriptorSerDeInfoOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public GluePartitionStorageDescriptorSerDeInfoOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected GluePartitionStorageDescriptorSerDeInfoOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected GluePartitionStorageDescriptorSerDeInfoOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.gluePartition.GluePartitionStorageDescriptorSerDeInfo\"}", isOptional: true)]
        public virtual aws.GluePartition.IGluePartitionStorageDescriptorSerDeInfo? InternalValue
        {
