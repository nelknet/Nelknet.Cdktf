...
namespace aws.MskReplicator
{
    ...
    [JsiiByValue(fqn: "aws.mskReplicator.MskReplicatorConfig")]
    public class MskReplicatorConfig : aws.MskReplicator.IMskReplicatorConfig
    {
        private object _kafkaCluster;
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.MskReplicator.IMskReplicatorKafkaCluster).FullName}[]; received null", nameof(value));
                        default:
