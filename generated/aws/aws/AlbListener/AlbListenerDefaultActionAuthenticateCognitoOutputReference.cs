...
{
    [JsiiClass(nativeType: typeof(aws.AlbListener.AlbListenerDefaultActionAuthenticateCognitoOutputReference), fullyQualifiedName: "aws.albListener.AlbListenerDefaultActionAuthenticateCognitoOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class AlbListenerDefaultActionAuthenticateCognitoOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public AlbListenerDefaultActionAuthenticateCognitoOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.albListener.AlbListenerDefaultActionAuthenticateCognito\"}", isOptional: true)]
        public virtual aws.AlbListener.IAlbListenerDefaultActionAuthenticateCognito? InternalValue
        {
