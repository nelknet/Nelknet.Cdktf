...
namespace aws.SagemakerImageVersion
{
    ...
    [JsiiByValue(fqn: "aws.sagemakerImageVersion.SagemakerImageVersionConfig")]
    public class SagemakerImageVersionConfig : aws.SagemakerImageVersion.ISagemakerImageVersionConfig
    {
