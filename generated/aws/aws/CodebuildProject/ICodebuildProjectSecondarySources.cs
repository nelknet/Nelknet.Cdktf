...
{
    [JsiiInterface(nativeType: typeof(ICodebuildProjectSecondarySources), fullyQualifiedName: "aws.codebuildProject.CodebuildProjectSecondarySources")]
    public interface ICodebuildProjectSecondarySources
    {
        ...
        aws.CodebuildProject.ICodebuildProjectSecondarySourcesAuth? Auth
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.CodebuildProject.ICodebuildProjectSecondarySourcesBuildStatusConfig? BuildStatusConfig
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.CodebuildProject.ICodebuildProjectSecondarySourcesGitSubmodulesConfig? GitSubmodulesConfig
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ICodebuildProjectSecondarySources), fullyQualifiedName: "aws.codebuildProject.CodebuildProjectSecondarySources")]
        internal sealed class _Proxy : DeputyBase, aws.CodebuildProject.ICodebuildProjectSecondarySources
        {
