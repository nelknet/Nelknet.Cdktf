...
{
    [JsiiInterface(nativeType: typeof(ICodedeployDeploymentConfigMinimumHealthyHosts), fullyQualifiedName: "aws.codedeployDeploymentConfig.CodedeployDeploymentConfigMinimumHealthyHosts")]
    public interface ICodedeployDeploymentConfigMinimumHealthyHosts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ICodedeployDeploymentConfigMinimumHealthyHosts), fullyQualifiedName: "aws.codedeployDeploymentConfig.CodedeployDeploymentConfigMinimumHealthyHosts")]
        internal sealed class _Proxy : DeputyBase, aws.CodedeployDeploymentConfig.ICodedeployDeploymentConfigMinimumHealthyHosts
        {
