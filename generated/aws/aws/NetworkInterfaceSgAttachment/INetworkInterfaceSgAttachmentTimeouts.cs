...
{
    [JsiiInterface(nativeType: typeof(INetworkInterfaceSgAttachmentTimeouts), fullyQualifiedName: "aws.networkInterfaceSgAttachment.NetworkInterfaceSgAttachmentTimeouts")]
    public interface INetworkInterfaceSgAttachmentTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(INetworkInterfaceSgAttachmentTimeouts), fullyQualifiedName: "aws.networkInterfaceSgAttachment.NetworkInterfaceSgAttachmentTimeouts")]
        internal sealed class _Proxy : DeputyBase, aws.NetworkInterfaceSgAttachment.INetworkInterfaceSgAttachmentTimeouts
        {
