...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/glue_connection aws_glue_connection}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/glue_connection aws_glue_connection} Resource.</summary>
        ...
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, aws.GlueConnection.IGlueConnectionConfig config)
        {
        ...
        /// <summary>Generates CDKTF code for importing a GlueConnection resource upon running "cdktf plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktf.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the GlueConnection to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/glue_connection#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing GlueConnection that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the GlueConnection to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktf.TerraformProvider\"}}]")]
        public static HashiCorp.Cdktf.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, HashiCorp.Cdktf.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<HashiCorp.Cdktf.ImportableResource>(typeof(aws.GlueConnection.GlueConnection), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(HashiCorp.Cdktf.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }
        ...
        public virtual void PutPhysicalConnectionRequirements(aws.GlueConnection.IGlueConnectionPhysicalConnectionRequirements @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.GlueConnection.IGlueConnectionPhysicalConnectionRequirements)}, new object[]{@value});
        }
        ...
        = GetStaticProperty<string>(typeof(aws.GlueConnection.GlueConnection))!;
        ...
        {
            get => GetInstanceProperty<aws.GlueConnection.GlueConnectionPhysicalConnectionRequirementsOutputReference>()!;
        }

        [JsiiOptional]
        [JsiiProperty(name: "athenaPropertiesInput", typeJson: "{\"collection\":{\"elementtype\":{\"primitive\":\"string\"},\"kind\":\"map\"}}", isOptional: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "physicalConnectionRequirementsInput", typeJson: "{\"fqn\":\"aws.glueConnection.GlueConnectionPhysicalConnectionRequirements\"}", isOptional: true)]
        public virtual aws.GlueConnection.IGlueConnectionPhysicalConnectionRequirements? PhysicalConnectionRequirementsInput
        {
        ...
        [JsiiProperty(name: "athenaProperties", typeJson: "{\"collection\":{\"elementtype\":{\"primitive\":\"string\"},\"kind\":\"map\"}}")]
        public virtual System.Collections.Generic.IDictionary<string, string> AthenaProperties
        {
            get => GetInstanceProperty<System.Collections.Generic.IDictionary<string, string>>()!;
