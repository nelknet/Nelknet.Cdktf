...
namespace aws.CodedeployDeploymentGroup
{
    ...
    public class CodedeployDeploymentGroupAlarmConfigurationOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public CodedeployDeploymentGroupAlarmConfigurationOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.codedeployDeploymentGroup.CodedeployDeploymentGroupAlarmConfiguration\"}", isOptional: true)]
        public virtual aws.CodedeployDeploymentGroup.ICodedeployDeploymentGroupAlarmConfiguration? InternalValue
        {
