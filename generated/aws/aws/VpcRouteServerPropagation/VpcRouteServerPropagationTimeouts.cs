...
{
    [JsiiByValue(fqn: "aws.vpcRouteServerPropagation.VpcRouteServerPropagationTimeouts")]
    public class VpcRouteServerPropagationTimeouts : aws.VpcRouteServerPropagation.IVpcRouteServerPropagationTimeouts
    {
