...
{
    [JsiiInterface(nativeType: typeof(INetworkAclIngress), fullyQualifiedName: "aws.networkAcl.NetworkAclIngress")]
    public interface INetworkAclIngress
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(INetworkAclIngress), fullyQualifiedName: "aws.networkAcl.NetworkAclIngress")]
        internal sealed class _Proxy : DeputyBase, aws.NetworkAcl.INetworkAclIngress
        {
