...
namespace aws.DataAwsBatchJobQueue
{
    ...
    public class DataAwsBatchJobQueueComputeEnvironmentOrderOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.dataAwsBatchJobQueue.DataAwsBatchJobQueueComputeEnvironmentOrder\"}", isOptional: true)]
        public virtual aws.DataAwsBatchJobQueue.IDataAwsBatchJobQueueComputeEnvironmentOrder? InternalValue
        {
            get => GetInstanceProperty<aws.DataAwsBatchJobQueue.IDataAwsBatchJobQueueComputeEnvironmentOrder?>();
