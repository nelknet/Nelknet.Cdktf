...
namespace aws.OpsworksMysqlLayer
{
    ...
    [JsiiByValue(fqn: "aws.opsworksMysqlLayer.OpsworksMysqlLayerEbsVolume")]
    public class OpsworksMysqlLayerEbsVolume : aws.OpsworksMysqlLayer.IOpsworksMysqlLayerEbsVolume
    {
