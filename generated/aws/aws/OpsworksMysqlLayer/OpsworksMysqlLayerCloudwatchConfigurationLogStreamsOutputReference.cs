...
namespace aws.OpsworksMysqlLayer
{
    ...
    public class OpsworksMysqlLayerCloudwatchConfigurationLogStreamsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        protected OpsworksMysqlLayerCloudwatchConfigurationLogStreamsOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected OpsworksMysqlLayerCloudwatchConfigurationLogStreamsOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"fqn\":\"aws.opsworksMysqlLayer.OpsworksMysqlLayerCloudwatchConfigurationLogStreams\"}]}}", isOptional: true)]
