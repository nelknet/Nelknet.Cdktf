...
{
    [JsiiInterface(nativeType: typeof(IDataAwsIamPolicyDocumentStatementPrincipals), fullyQualifiedName: "aws.dataAwsIamPolicyDocument.DataAwsIamPolicyDocumentStatementPrincipals")]
    public interface IDataAwsIamPolicyDocumentStatementPrincipals
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataAwsIamPolicyDocumentStatementPrincipals), fullyQualifiedName: "aws.dataAwsIamPolicyDocument.DataAwsIamPolicyDocumentStatementPrincipals")]
        internal sealed class _Proxy : DeputyBase, aws.DataAwsIamPolicyDocument.IDataAwsIamPolicyDocumentStatementPrincipals
        {
