...
namespace aws.IotTopicRule
{
    ...
    [JsiiByValue(fqn: "aws.iotTopicRule.IotTopicRuleErrorActionHttpHttpHeader")]
    public class IotTopicRuleErrorActionHttpHttpHeader : aws.IotTopicRule.IIotTopicRuleErrorActionHttpHttpHeader
    {
