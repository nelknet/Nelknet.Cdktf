...
namespace aws.IotTopicRule
{
    ...
    [JsiiByValue(fqn: "aws.iotTopicRule.IotTopicRuleErrorActionKafkaHeader")]
    public class IotTopicRuleErrorActionKafkaHeader : aws.IotTopicRule.IIotTopicRuleErrorActionKafkaHeader
    {
