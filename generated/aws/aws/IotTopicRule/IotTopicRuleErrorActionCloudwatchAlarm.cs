...
namespace aws.IotTopicRule
{
    ...
    [JsiiByValue(fqn: "aws.iotTopicRule.IotTopicRuleErrorActionCloudwatchAlarm")]
    public class IotTopicRuleErrorActionCloudwatchAlarm : aws.IotTopicRule.IIotTopicRuleErrorActionCloudwatchAlarm
    {
