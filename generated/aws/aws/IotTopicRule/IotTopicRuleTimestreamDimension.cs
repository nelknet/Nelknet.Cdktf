...
namespace aws.IotTopicRule
{
    ...
    [JsiiByValue(fqn: "aws.iotTopicRule.IotTopicRuleTimestreamDimension")]
    public class IotTopicRuleTimestreamDimension : aws.IotTopicRule.IIotTopicRuleTimestreamDimension
    {
