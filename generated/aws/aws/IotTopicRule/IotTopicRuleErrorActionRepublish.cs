...
namespace aws.IotTopicRule
{
    ...
    [JsiiByValue(fqn: "aws.iotTopicRule.IotTopicRuleErrorActionRepublish")]
    public class IotTopicRuleErrorActionRepublish : aws.IotTopicRule.IIotTopicRuleErrorActionRepublish
    {
