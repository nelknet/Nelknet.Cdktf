...
namespace aws.AuditmanagerAssessment
{
    ...
    [JsiiByValue(fqn: "aws.auditmanagerAssessment.AuditmanagerAssessmentConfig")]
    public class AuditmanagerAssessmentConfig : aws.AuditmanagerAssessment.IAuditmanagerAssessmentConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.AuditmanagerAssessment.IAuditmanagerAssessmentRoles).FullName}[]; received null", nameof(value));
                        default:
        ...
        private object? _assessmentReportsDestination;
        ...
        {
            get => _assessmentReportsDestination;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _assessmentReportsDestination = value;
            }
        }
