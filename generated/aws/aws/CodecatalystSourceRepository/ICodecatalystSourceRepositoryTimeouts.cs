...
{
    [JsiiInterface(nativeType: typeof(ICodecatalystSourceRepositoryTimeouts), fullyQualifiedName: "aws.codecatalystSourceRepository.CodecatalystSourceRepositoryTimeouts")]
    public interface ICodecatalystSourceRepositoryTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ICodecatalystSourceRepositoryTimeouts), fullyQualifiedName: "aws.codecatalystSourceRepository.CodecatalystSourceRepositoryTimeouts")]
        internal sealed class _Proxy : DeputyBase, aws.CodecatalystSourceRepository.ICodecatalystSourceRepositoryTimeouts
        {
