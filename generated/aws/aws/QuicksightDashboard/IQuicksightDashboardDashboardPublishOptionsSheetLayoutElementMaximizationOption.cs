...
namespace aws.QuicksightDashboard
{
    ...
    public interface IQuicksightDashboardDashboardPublishOptionsSheetLayoutElementMaximizationOption
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IQuicksightDashboardDashboardPublishOptionsSheetLayoutElementMaximizationOption), fullyQualifiedName: "aws.quicksightDashboard.QuicksightDashboardDashboardPublishOptionsSheetLayoutElementMaximizationOption")]
        internal sealed class _Proxy : DeputyBase, aws.QuicksightDashboard.IQuicksightDashboardDashboardPublishOptionsSheetLayoutElementMaximizationOption
        {
