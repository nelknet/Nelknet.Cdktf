...
namespace aws.LbListenerRule
{
    ...
    public class LbListenerRuleConditionHttpHeaderOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public LbListenerRuleConditionHttpHeaderOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
