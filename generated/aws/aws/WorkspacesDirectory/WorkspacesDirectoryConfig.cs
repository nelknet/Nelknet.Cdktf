...
{
    [JsiiByValue(fqn: "aws.workspacesDirectory.WorkspacesDirectoryConfig")]
    public class WorkspacesDirectoryConfig : aws.WorkspacesDirectory.IWorkspacesDirectoryConfig
    {
