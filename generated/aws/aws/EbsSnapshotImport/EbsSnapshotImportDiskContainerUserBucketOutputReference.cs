...
{
    [JsiiClass(nativeType: typeof(aws.EbsSnapshotImport.EbsSnapshotImportDiskContainerUserBucketOutputReference), fullyQualifiedName: "aws.ebsSnapshotImport.EbsSnapshotImportDiskContainerUserBucketOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class EbsSnapshotImportDiskContainerUserBucketOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public EbsSnapshotImportDiskContainerUserBucketOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.ebsSnapshotImport.EbsSnapshotImportDiskContainerUserBucket\"}", isOptional: true)]
        public virtual aws.EbsSnapshotImport.IEbsSnapshotImportDiskContainerUserBucket? InternalValue
        {
