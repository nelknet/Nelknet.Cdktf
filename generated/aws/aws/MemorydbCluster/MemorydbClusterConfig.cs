...
namespace aws.MemorydbCluster
{
    ...
    [JsiiByValue(fqn: "aws.memorydbCluster.MemorydbClusterConfig")]
    public class MemorydbClusterConfig : aws.MemorydbCluster.IMemorydbClusterConfig
    {
