...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/opsworks_nodejs_app_layer aws_opsworks_nodejs_app_layer}.</summary>
    [JsiiClass(nativeType: typeof(aws.OpsworksNodejsAppLayer.OpsworksNodejsAppLayer), fullyQualifiedName: "aws.opsworksNodejsAppLayer.OpsworksNodejsAppLayer", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.opsworksNodejsAppLayer.OpsworksNodejsAppLayerConfig\"}}]")]
    public class OpsworksNodejsAppLayer : HashiCorp.Cdktf.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/opsworks_nodejs_app_layer aws_opsworks_nodejs_app_layer} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public OpsworksNodejsAppLayer(Constructs.Construct scope, string id, aws.OpsworksNodejsAppLayer.IOpsworksNodejsAppLayerConfig config): base(_MakeDeputyProps(scope, id, config))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, aws.OpsworksNodejsAppLayer.IOpsworksNodejsAppLayerConfig config)
        {
        ...
        /// <summary>Generates CDKTF code for importing a OpsworksNodejsAppLayer resource upon running "cdktf plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="importToId">The construct id used in the generated config for the OpsworksNodejsAppLayer to import.</param>
        /// <param name="importFromId">The id of the existing OpsworksNodejsAppLayer that should be imported.</param>
        /// <param name="provider">? Optional instance of the provider where the OpsworksNodejsAppLayer to import is found.</param>
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktf.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the OpsworksNodejsAppLayer to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/opsworks_nodejs_app_layer#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing OpsworksNodejsAppLayer that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the OpsworksNodejsAppLayer to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktf.TerraformProvider\"}}]")]
        public static HashiCorp.Cdktf.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, HashiCorp.Cdktf.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<HashiCorp.Cdktf.ImportableResource>(typeof(aws.OpsworksNodejsAppLayer.OpsworksNodejsAppLayer), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(HashiCorp.Cdktf.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }

        [JsiiMethod(name: "putCloudwatchConfiguration", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.opsworksNodejsAppLayer.OpsworksNodejsAppLayerCloudwatchConfiguration\"}}]")]
        public virtual void PutCloudwatchConfiguration(aws.OpsworksNodejsAppLayer.IOpsworksNodejsAppLayerCloudwatchConfiguration @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.OpsworksNodejsAppLayer.IOpsworksNodejsAppLayerCloudwatchConfiguration)}, new object[]{@value});
        }

        [JsiiMethod(name: "putEbsVolume", parametersJson: "[{\"name\":\"value\",\"type\":{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworksNodejsAppLayer.OpsworksNodejsAppLayerEbsVolume\"},\"kind\":\"array\"}}]}}}]")]
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case HashiCorp.Cdktf.IResolvable cast_2ed7d7:
                        break;
                    case aws.OpsworksNodejsAppLayer.IOpsworksNodejsAppLayerEbsVolume[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.OpsworksNodejsAppLayer.IOpsworksNodejsAppLayerEbsVolume).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.OpsworksNodejsAppLayer.IOpsworksNodejsAppLayerEbsVolume).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }

        [JsiiMethod(name: "putLoadBasedAutoScaling", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.opsworksNodejsAppLayer.OpsworksNodejsAppLayerLoadBasedAutoScaling\"}}]")]
        public virtual void PutLoadBasedAutoScaling(aws.OpsworksNodejsAppLayer.IOpsworksNodejsAppLayerLoadBasedAutoScaling @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.OpsworksNodejsAppLayer.IOpsworksNodejsAppLayerLoadBasedAutoScaling)}, new object[]{@value});
        }
        ...
        = GetStaticProperty<string>(typeof(aws.OpsworksNodejsAppLayer.OpsworksNodejsAppLayer))!;
        ...
        [JsiiProperty(name: "cloudwatchConfiguration", typeJson: "{\"fqn\":\"aws.opsworksNodejsAppLayer.OpsworksNodejsAppLayerCloudwatchConfigurationOutputReference\"}")]
        public virtual aws.OpsworksNodejsAppLayer.OpsworksNodejsAppLayerCloudwatchConfigurationOutputReference CloudwatchConfiguration
        {
            get => GetInstanceProperty<aws.OpsworksNodejsAppLayer.OpsworksNodejsAppLayerCloudwatchConfigurationOutputReference>()!;
        }

        [JsiiProperty(name: "ebsVolume", typeJson: "{\"fqn\":\"aws.opsworksNodejsAppLayer.OpsworksNodejsAppLayerEbsVolumeList\"}")]
        public virtual aws.OpsworksNodejsAppLayer.OpsworksNodejsAppLayerEbsVolumeList EbsVolume
        {
            get => GetInstanceProperty<aws.OpsworksNodejsAppLayer.OpsworksNodejsAppLayerEbsVolumeList>()!;
        }

        [JsiiProperty(name: "loadBasedAutoScaling", typeJson: "{\"fqn\":\"aws.opsworksNodejsAppLayer.OpsworksNodejsAppLayerLoadBasedAutoScalingOutputReference\"}")]
        public virtual aws.OpsworksNodejsAppLayer.OpsworksNodejsAppLayerLoadBasedAutoScalingOutputReference LoadBasedAutoScaling
        {
            get => GetInstanceProperty<aws.OpsworksNodejsAppLayer.OpsworksNodejsAppLayerLoadBasedAutoScalingOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "cloudwatchConfigurationInput", typeJson: "{\"fqn\":\"aws.opsworksNodejsAppLayer.OpsworksNodejsAppLayerCloudwatchConfiguration\"}", isOptional: true)]
        public virtual aws.OpsworksNodejsAppLayer.IOpsworksNodejsAppLayerCloudwatchConfiguration? CloudwatchConfigurationInput
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolumeInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworksNodejsAppLayer.OpsworksNodejsAppLayerEbsVolume\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "loadBasedAutoScalingInput", typeJson: "{\"fqn\":\"aws.opsworksNodejsAppLayer.OpsworksNodejsAppLayerLoadBasedAutoScaling\"}", isOptional: true)]
        public virtual aws.OpsworksNodejsAppLayer.IOpsworksNodejsAppLayerLoadBasedAutoScaling? LoadBasedAutoScalingInput
        {
