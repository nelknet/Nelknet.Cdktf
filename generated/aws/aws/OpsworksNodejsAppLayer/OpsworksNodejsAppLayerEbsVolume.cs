...
namespace aws.OpsworksNodejsAppLayer
{
    ...
    [JsiiByValue(fqn: "aws.opsworksNodejsAppLayer.OpsworksNodejsAppLayerEbsVolume")]
    public class OpsworksNodejsAppLayerEbsVolume : aws.OpsworksNodejsAppLayer.IOpsworksNodejsAppLayerEbsVolume
    {
