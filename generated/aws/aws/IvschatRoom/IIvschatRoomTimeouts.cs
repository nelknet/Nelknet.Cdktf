...
{
    [JsiiInterface(nativeType: typeof(IIvschatRoomTimeouts), fullyQualifiedName: "aws.ivschatRoom.IvschatRoomTimeouts")]
    public interface IIvschatRoomTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IIvschatRoomTimeouts), fullyQualifiedName: "aws.ivschatRoom.IvschatRoomTimeouts")]
        internal sealed class _Proxy : DeputyBase, aws.IvschatRoom.IIvschatRoomTimeouts
        {
