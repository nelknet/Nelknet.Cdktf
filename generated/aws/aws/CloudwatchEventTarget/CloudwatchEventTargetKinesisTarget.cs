...
{
    [JsiiByValue(fqn: "aws.cloudwatchEventTarget.CloudwatchEventTargetKinesisTarget")]
    public class CloudwatchEventTargetKinesisTarget : aws.CloudwatchEventTarget.ICloudwatchEventTargetKinesisTarget
    {
