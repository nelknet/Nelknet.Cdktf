...
namespace aws.CloudwatchEventTarget
{
    ...
    public class CloudwatchEventTargetKinesisTargetOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public CloudwatchEventTargetKinesisTargetOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
