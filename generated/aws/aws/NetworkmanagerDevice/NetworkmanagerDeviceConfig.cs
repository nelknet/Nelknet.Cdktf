...
namespace aws.NetworkmanagerDevice
{
    ...
    [JsiiByValue(fqn: "aws.networkmanagerDevice.NetworkmanagerDeviceConfig")]
    public class NetworkmanagerDeviceConfig : aws.NetworkmanagerDevice.INetworkmanagerDeviceConfig
    {
