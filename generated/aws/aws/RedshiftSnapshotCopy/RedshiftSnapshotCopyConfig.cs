...
namespace aws.RedshiftSnapshotCopy
{
    ...
    [JsiiByValue(fqn: "aws.redshiftSnapshotCopy.RedshiftSnapshotCopyConfig")]
    public class RedshiftSnapshotCopyConfig : aws.RedshiftSnapshotCopy.IRedshiftSnapshotCopyConfig
    {
