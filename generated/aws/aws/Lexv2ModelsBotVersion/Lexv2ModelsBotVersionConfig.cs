...
namespace aws.Lexv2ModelsBotVersion
{
    ...
    [JsiiByValue(fqn: "aws.lexv2ModelsBotVersion.Lexv2ModelsBotVersionConfig")]
    public class Lexv2ModelsBotVersionConfig : aws.Lexv2ModelsBotVersion.ILexv2ModelsBotVersionConfig
    {
        ...
        private object _localeSpecification;
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, System.Collections.Generic.IDictionary<string, {typeof(aws.Lexv2ModelsBotVersion.ILexv2ModelsBotVersionLocaleSpecification).FullName}>; received null", nameof(value));
                        default:
