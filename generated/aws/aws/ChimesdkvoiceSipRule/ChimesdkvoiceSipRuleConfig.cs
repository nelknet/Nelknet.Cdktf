...
namespace aws.ChimesdkvoiceSipRule
{
    ...
    [JsiiByValue(fqn: "aws.chimesdkvoiceSipRule.ChimesdkvoiceSipRuleConfig")]
    public class ChimesdkvoiceSipRuleConfig : aws.ChimesdkvoiceSipRule.IChimesdkvoiceSipRuleConfig
    {
        ...
        private object _targetApplications;
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(aws.ChimesdkvoiceSipRule.IChimesdkvoiceSipRuleTargetApplications).FullName}[]; received null", nameof(value));
                        default:
