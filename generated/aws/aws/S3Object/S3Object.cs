...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/s3_object aws_s3_object}.</summary>
    [JsiiClass(nativeType: typeof(aws.S3Object.S3Object), fullyQualifiedName: "aws.s3Object.S3Object", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.s3Object.S3ObjectConfig\"}}]")]
    public class S3Object : HashiCorp.Cdktf.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/s3_object aws_s3_object} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public S3Object(Constructs.Construct scope, string id, aws.S3Object.IS3ObjectConfig config): base(_MakeDeputyProps(scope, id, config))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, aws.S3Object.IS3ObjectConfig config)
        {
        ...
        protected S3Object(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected S3Object(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTF code for importing a S3Object resource upon running "cdktf plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="importToId">The construct id used in the generated config for the S3Object to import.</param>
        /// <param name="importFromId">The id of the existing S3Object that should be imported.</param>
        /// <param name="provider">? Optional instance of the provider where the S3Object to import is found.</param>
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktf.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the S3Object to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/s3_object#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing S3Object that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the S3Object to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktf.TerraformProvider\"}}]")]
        public static HashiCorp.Cdktf.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, HashiCorp.Cdktf.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<HashiCorp.Cdktf.ImportableResource>(typeof(aws.S3Object.S3Object), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(HashiCorp.Cdktf.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }

        [JsiiMethod(name: "putOverrideProvider", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.s3Object.S3ObjectOverrideProvider\"}}]")]
        public virtual void PutOverrideProvider(aws.S3Object.IS3ObjectOverrideProvider @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.S3Object.IS3ObjectOverrideProvider)}, new object[]{@value});
        }
        ...
        = GetStaticProperty<string>(typeof(aws.S3Object.S3Object))!;
        ...
        [JsiiProperty(name: "overrideProvider", typeJson: "{\"fqn\":\"aws.s3Object.S3ObjectOverrideProviderOutputReference\"}")]
        public virtual aws.S3Object.S3ObjectOverrideProviderOutputReference OverrideProvider
        {
            get => GetInstanceProperty<aws.S3Object.S3ObjectOverrideProviderOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "overrideProviderInput", typeJson: "{\"fqn\":\"aws.s3Object.S3ObjectOverrideProvider\"}", isOptional: true)]
        public virtual aws.S3Object.IS3ObjectOverrideProvider? OverrideProviderInput
        {
