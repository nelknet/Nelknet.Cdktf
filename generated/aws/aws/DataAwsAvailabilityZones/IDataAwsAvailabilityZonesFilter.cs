...
{
    [JsiiInterface(nativeType: typeof(IDataAwsAvailabilityZonesFilter), fullyQualifiedName: "aws.dataAwsAvailabilityZones.DataAwsAvailabilityZonesFilter")]
    public interface IDataAwsAvailabilityZonesFilter
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataAwsAvailabilityZonesFilter), fullyQualifiedName: "aws.dataAwsAvailabilityZones.DataAwsAvailabilityZonesFilter")]
        internal sealed class _Proxy : DeputyBase, aws.DataAwsAvailabilityZones.IDataAwsAvailabilityZonesFilter
        {
