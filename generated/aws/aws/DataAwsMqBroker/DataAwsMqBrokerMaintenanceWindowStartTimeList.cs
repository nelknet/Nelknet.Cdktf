...
namespace aws.DataAwsMqBroker
{
    ...
    public class DataAwsMqBrokerMaintenanceWindowStartTimeList : HashiCorp.Cdktf.ComplexList
    {
        ...
        public DataAwsMqBrokerMaintenanceWindowStartTimeList(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute, bool wrapsSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, wrapsSet))
        {
        }
